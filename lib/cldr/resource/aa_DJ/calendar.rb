...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Qun"
    @months[:gregorian][:abbreviated]["10"] = "Dit"
    @months[:gregorian][:abbreviated]["11"] = "Xim"
    @months[:gregorian][:abbreviated]["12"] = "Kax"
    @months[:gregorian][:abbreviated]["2"] = "Nah"
    @months[:gregorian][:abbreviated]["3"] = "Cig"
    @months[:gregorian][:abbreviated]["4"] = "Agd"
    @months[:gregorian][:abbreviated]["5"] = "Cax"
    @months[:gregorian][:abbreviated]["6"] = "Qas"
    @months[:gregorian][:abbreviated]["7"] = "Qad"
    @months[:gregorian][:abbreviated]["8"] = "Leq"
    @months[:gregorian][:abbreviated]["9"] = "Way"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "Q"
    @months[:gregorian][:narrow]["10"] = "D"
    @months[:gregorian][:narrow]["11"] = "X"
    @months[:gregorian][:narrow]["12"] = "K"
    @months[:gregorian][:narrow]["2"] = "N"
    @months[:gregorian][:narrow]["3"] = "C"
    @months[:gregorian][:narrow]["4"] = "A"
    @months[:gregorian][:narrow]["5"] = "C"
    @months[:gregorian][:narrow]["6"] = "Q"
    @months[:gregorian][:narrow]["7"] = "Q"
    @months[:gregorian][:narrow]["8"] = "L"
    @months[:gregorian][:narrow]["9"] = "W"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Qunxa Garablu"
    @months[:gregorian][:wide]["10"] = "Diteli"
    @months[:gregorian][:wide]["11"] = "Ximoli"
    @months[:gregorian][:wide]["12"] = "Kaxxa Garablu"
    @months[:gregorian][:wide]["2"] = "Naharsi Kudo"
    @months[:gregorian][:wide]["3"] = "Ciggilta Kudo"
    @months[:gregorian][:wide]["4"] = "Agda Baxisso"
    @months[:gregorian][:wide]["5"] = "Caxah Alsa"
    @months[:gregorian][:wide]["6"] = "Qasa Dirri"
    @months[:gregorian][:wide]["7"] = "Qado Dirri"
    @months[:gregorian][:wide]["8"] = "Leqeeni"
    @months[:gregorian][:wide]["9"] = "Waysu"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Gum"
    @days[:gregorian][:abbreviated]["mon"] = "Etl"
    @days[:gregorian][:abbreviated]["sat"] = "Sab"
    @days[:gregorian][:abbreviated]["sun"] = "Aca"
    @days[:gregorian][:abbreviated]["thu"] = "Kam"
    @days[:gregorian][:abbreviated]["tue"] = "Tal"
    @days[:gregorian][:abbreviated]["wed"] = "Arb"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "G"
    @days[:gregorian][:narrow]["mon"] = "E"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Gumqata"
    @days[:gregorian][:wide]["mon"] = "Etleeni"
    @days[:gregorian][:wide]["sat"] = "Sabti"
    @days[:gregorian][:wide]["sun"] = "Acaada"
    @days[:gregorian][:wide]["thu"] = "Kamiisi"
    @days[:gregorian][:wide]["tue"] = "Talaata"
    @days[:gregorian][:wide]["wed"] = "Arbaqa"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "Yaasuusuk Duma"
    @era_abbrs[:gregorian]["1"] = "Yaasuusuk Wadir"
    @era_abbrs[:hebrew] = {}
