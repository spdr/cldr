...
# CLDR version: 1.3
#
# Original file name: common/main/aa_ER_SAAHO.xml
...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Jum"
    @days[:gregorian][:abbreviated]["mon"] = "San"
    @days[:gregorian][:abbreviated]["sat"] = "Qun"
    @days[:gregorian][:abbreviated]["sun"] = "Nab"
    @days[:gregorian][:abbreviated]["thu"] = "Cam"
    @days[:gregorian][:abbreviated]["tue"] = "Sal"
    @days[:gregorian][:abbreviated]["wed"] = "Rab"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jumqata"
    @days[:gregorian][:wide]["mon"] = "Sani"
    @days[:gregorian][:wide]["sat"] = "Qunxa Sambat"
    @days[:gregorian][:wide]["sun"] = "Naba Sambat"
    @days[:gregorian][:wide]["thu"] = "Camus"
    @days[:gregorian][:wide]["tue"] = "Salus"
    @days[:gregorian][:wide]["wed"] = "Rabuq"
    @dayformat_defaults = {}
