...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["1"] = "Januarie"
    ...
    @months[:gregorian][:wide]["6"] = "Junie"
    @months[:gregorian][:wide]["7"] = "Julie"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Vrydag"
    @days[:gregorian][:wide]["mon"] = "Maandag"
    @days[:gregorian][:wide]["sat"] = "Saterdag"
    @days[:gregorian][:wide]["sun"] = "Sondag"
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "v.C."
    @era_abbrs[:gregorian]["1"] = "n.C."
    @era_abbrs[:hebrew] = {}
