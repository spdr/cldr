...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ዓርብ"
    @days[:gregorian][:abbreviated]["mon"] = "ሰኞ"
    @days[:gregorian][:abbreviated]["sat"] = "ቅዳሜ"
    @days[:gregorian][:abbreviated]["sun"] = "እሑድ"
    @days[:gregorian][:abbreviated]["thu"] = "ሐሙስ"
    @days[:gregorian][:abbreviated]["tue"] = "ማክሰ"
    @days[:gregorian][:abbreviated]["wed"] = "ረቡዕ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ዓ"
    @days[:gregorian][:narrow]["mon"] = "ሰ"
    @days[:gregorian][:narrow]["sat"] = "ቅ"
    @days[:gregorian][:narrow]["sun"] = "እ"
    @days[:gregorian][:narrow]["thu"] = "ሐ"
    @days[:gregorian][:narrow]["tue"] = "ማ"
    @days[:gregorian][:narrow]["wed"] = "ረ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ዓርብ"
    @days[:gregorian][:wide]["mon"] = "ሰኞ"
    @days[:gregorian][:wide]["sat"] = "ቅዳሜ"
    @days[:gregorian][:wide]["sun"] = "እሑድ"
    @days[:gregorian][:wide]["thu"] = "ሐሙስ"
    @days[:gregorian][:wide]["tue"] = "ማክሰኞ"
    ...
    @dateformats[:gregorian]["full"] = "EEEE፣ dd MMMM ቀን yyyy G"
    ...
    @timeformats[:gregorian]["full"] = "hh:mm:ss a"
    @timeformats[:gregorian]["long"] = "hh:mm:ss a"
