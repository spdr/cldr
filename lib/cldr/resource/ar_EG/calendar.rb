...
# CLDR version: 1.3
#
# Original file name: common/main/ar_EG.xml
...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ج"
    @days[:gregorian][:abbreviated]["mon"] = "ن"
    @days[:gregorian][:abbreviated]["sat"] = "س"
    @days[:gregorian][:abbreviated]["sun"] = "ح"
    @days[:gregorian][:abbreviated]["thu"] = "خ"
    @days[:gregorian][:abbreviated]["tue"] = "ث"
    @days[:gregorian][:abbreviated]["wed"] = "ر"
