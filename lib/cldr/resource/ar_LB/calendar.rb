...
# CLDR version: 1.3
#
# Original file name: common/main/ar_LB.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "كانون الثاني"
    @months[:gregorian][:abbreviated]["10"] = "تشرين الأول"
    @months[:gregorian][:abbreviated]["11"] = "تشرين الثاني"
    @months[:gregorian][:abbreviated]["12"] = "كانون الأول"
    @months[:gregorian][:abbreviated]["2"] = "شباط"
    @months[:gregorian][:abbreviated]["3"] = "آذار"
    @months[:gregorian][:abbreviated]["4"] = "نيسان"
    @months[:gregorian][:abbreviated]["5"] = "نوار"
    @months[:gregorian][:abbreviated]["6"] = "حزيران"
    @months[:gregorian][:abbreviated]["7"] = "تموز"
    @months[:gregorian][:abbreviated]["8"] = "آب"
    @months[:gregorian][:abbreviated]["9"] = "أيلول"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ي"
    @months[:gregorian][:narrow]["10"] = "ك"
    @months[:gregorian][:narrow]["11"] = "ب"
    @months[:gregorian][:narrow]["12"] = "د"
    @months[:gregorian][:narrow]["2"] = "ف"
    @months[:gregorian][:narrow]["3"] = "م"
    @months[:gregorian][:narrow]["4"] = "آ"
    @months[:gregorian][:narrow]["5"] = "و"
    @months[:gregorian][:narrow]["6"] = "ن"
    @months[:gregorian][:narrow]["7"] = "ل"
    @months[:gregorian][:narrow]["8"] = "غ"
    @months[:gregorian][:narrow]["9"] = "س"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "كانون الثاني"
    @months[:gregorian][:wide]["10"] = "تشرين الأول"
    @months[:gregorian][:wide]["11"] = "تشرين الثاني"
    @months[:gregorian][:wide]["12"] = "كانون الأول"
    @months[:gregorian][:wide]["2"] = "شباط"
    @months[:gregorian][:wide]["3"] = "آذار"
    @months[:gregorian][:wide]["4"] = "نيسان"
    @months[:gregorian][:wide]["5"] = "نوار"
    @months[:gregorian][:wide]["6"] = "حزيران"
    @months[:gregorian][:wide]["7"] = "تموز"
    @months[:gregorian][:wide]["8"] = "آب"
    @months[:gregorian][:wide]["9"] = "أيلول"
    @months[:hebrew] = {}
    ...
    @months[:islamic_civil][:abbreviated]["1"] = "محرم"
    @months[:islamic_civil][:abbreviated]["10"] = "شوال"
    @months[:islamic_civil][:abbreviated]["11"] = "ذو القعدة"
    @months[:islamic_civil][:abbreviated]["12"] = "ذو الحجة"
    @months[:islamic_civil][:abbreviated]["2"] = "صفر"
    @months[:islamic_civil][:abbreviated]["3"] = "ربيع الأول"
    @months[:islamic_civil][:abbreviated]["4"] = "ربيع الآخر"
    @months[:islamic_civil][:abbreviated]["5"] = "جمادى الأولى"
    @months[:islamic_civil][:abbreviated]["6"] = "جمادى الآخرة"
    @months[:islamic_civil][:abbreviated]["7"] = "رجب"
    @months[:islamic_civil][:abbreviated]["8"] = "شعبان"
    @months[:islamic_civil][:abbreviated]["9"] = "رمضان"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "محرم"
    @months[:islamic_civil][:wide]["10"] = "شوال"
    @months[:islamic_civil][:wide]["11"] = "ذو القعدة"
    @months[:islamic_civil][:wide]["12"] = "ذو الحجة"
    @months[:islamic_civil][:wide]["2"] = "صفر"
    @months[:islamic_civil][:wide]["3"] = "ربيع الأول"
    @months[:islamic_civil][:wide]["4"] = "ربيع الآخر"
    @months[:islamic_civil][:wide]["5"] = "جمادى الأولى"
    @months[:islamic_civil][:wide]["6"] = "جمادى الآخرة"
    @months[:islamic_civil][:wide]["7"] = "رجب"
    @months[:islamic_civil][:wide]["8"] = "شعبان"
    @months[:islamic_civil][:wide]["9"] = "رمضان"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "محرم"
    @months[:islamic][:abbreviated]["10"] = "شوال"
    @months[:islamic][:abbreviated]["11"] = "ذو القعدة"
    @months[:islamic][:abbreviated]["12"] = "ذو الحجة"
    @months[:islamic][:abbreviated]["2"] = "صفر"
    @months[:islamic][:abbreviated]["3"] = "ربيع الأول"
    @months[:islamic][:abbreviated]["4"] = "ربيع الآخر"
    @months[:islamic][:abbreviated]["5"] = "جمادى الأولى"
    @months[:islamic][:abbreviated]["6"] = "جمادى الآخرة"
    ...
    @months[:islamic][:wide]["11"] = "ذو القعدة"
    @months[:islamic][:wide]["12"] = "ذو الحجة"
    @months[:islamic][:wide]["2"] = "صفر"
    @months[:islamic][:wide]["3"] = "ربيع الأول"
    @months[:islamic][:wide]["4"] = "ربيع الآخر"
    @months[:islamic][:wide]["5"] = "جمادى الأولى"
    @months[:islamic][:wide]["6"] = "جمادى الآخرة"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "الجمعة"
    @days[:gregorian][:abbreviated]["mon"] = "الاثنين"
    @days[:gregorian][:abbreviated]["sat"] = "السبت"
    @days[:gregorian][:abbreviated]["sun"] = "الأحد"
    @days[:gregorian][:abbreviated]["thu"] = "الخميس"
    @days[:gregorian][:abbreviated]["tue"] = "الثلاثاء"
    @days[:gregorian][:abbreviated]["wed"] = "الأربعاء"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ج"
    @days[:gregorian][:narrow]["mon"] = "ن"
    @days[:gregorian][:narrow]["sat"] = "س"
    @days[:gregorian][:narrow]["sun"] = "ح"
    @days[:gregorian][:narrow]["thu"] = "خ"
    @days[:gregorian][:narrow]["tue"] = "ث"
    @days[:gregorian][:narrow]["wed"] = "ر"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "الجمعة"
    @days[:gregorian][:wide]["mon"] = "الاثنين"
    @days[:gregorian][:wide]["sat"] = "السبت"
    @days[:gregorian][:wide]["sun"] = "الأحد"
    @days[:gregorian][:wide]["thu"] = "الخميس"
    @days[:gregorian][:wide]["tue"] = "الثلاثاء"
    @days[:gregorian][:wide]["wed"] = "الأربعاء"
    @dayformat_defaults = {}
    @dayformat_defaults["gregorian"] = "wide"
    @week_firstdays = {}
    @week_firstdays["gregorian"] = "sat"
    @weekend_starts = {}
    @weekend_starts["gregorian"] = "thu"
    @weekend_ends = {}
    @weekend_ends["gregorian"] = "fri"
    @mindays = {}
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ص"
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ق.م"
    @era_names[:gregorian]["1"] = "م"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "التقويم البوذي"
    @era_abbrs[:gregorian] = {}
    ...
    @era_abbrs[:islamic_civil]["0"] = "ه‍"
    @era_abbrs[:islamic] = {}
    @era_abbrs[:islamic]["0"] = "ه‍"
    @era_abbrs[:japanese] = {}
    ...
    @timeformats[:gregorian]["full"] = "z h:mm:ss a"
    @timeformats[:gregorian]["long"] = "h:mm:ss a"
