...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "يناير"
    @months[:gregorian][:abbreviated]["10"] = "أكتوبر"
    @months[:gregorian][:abbreviated]["11"] = "نوفمبر"
    @months[:gregorian][:abbreviated]["12"] = "ديسمبر"
    @months[:gregorian][:abbreviated]["2"] = "فبراير"
    @months[:gregorian][:abbreviated]["3"] = "مارس"
    @months[:gregorian][:abbreviated]["4"] = "أبريل"
    @months[:gregorian][:abbreviated]["5"] = "مايو"
    @months[:gregorian][:abbreviated]["6"] = "يونيو"
    @months[:gregorian][:abbreviated]["7"] = "يوليو"
    @months[:gregorian][:abbreviated]["8"] = "أغسطس"
    @months[:gregorian][:abbreviated]["9"] = "سبتمبر"
    ...
    @months[:gregorian][:wide]["1"] = "يناير"
    @months[:gregorian][:wide]["10"] = "أكتوبر"
    @months[:gregorian][:wide]["11"] = "نوفمبر"
    @months[:gregorian][:wide]["12"] = "ديسمبر"
    @months[:gregorian][:wide]["2"] = "فبراير"
    @months[:gregorian][:wide]["3"] = "مارس"
    @months[:gregorian][:wide]["4"] = "أبريل"
    @months[:gregorian][:wide]["5"] = "مايو"
    @months[:gregorian][:wide]["6"] = "يونيو"
    @months[:gregorian][:wide]["7"] = "يوليو"
    @months[:gregorian][:wide]["8"] = "أغسطس"
    @months[:gregorian][:wide]["9"] = "سبتمبر"
    @months[:hebrew] = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "قبل الميلاد"
    @era_names[:gregorian]["1"] = "ميلادي"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
