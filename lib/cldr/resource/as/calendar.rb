...
# CLDR version: 1.3
#
# Original file name: common/main/as.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "জানু"
    @months[:gregorian][:abbreviated]["10"] = "অক্টো"
    @months[:gregorian][:abbreviated]["11"] = "নভে"
    @months[:gregorian][:abbreviated]["12"] = "ডিসে"
    @months[:gregorian][:abbreviated]["2"] = "ফেব্ৰু"
    @months[:gregorian][:abbreviated]["3"] = "মাৰ্চ"
    @months[:gregorian][:abbreviated]["4"] = "এপ্ৰিল"
    @months[:gregorian][:abbreviated]["5"] = "মে"
    @months[:gregorian][:abbreviated]["6"] = "জুন"
    @months[:gregorian][:abbreviated]["7"] = "জুলাই"
    @months[:gregorian][:abbreviated]["8"] = "আগ"
    @months[:gregorian][:abbreviated]["9"] = "সেপ্ট"
    ...
    @months[:gregorian][:wide]["1"] = "জানুয়াৰী"
    @months[:gregorian][:wide]["10"] = "অক্টোবৰ"
    @months[:gregorian][:wide]["11"] = "নভেম্বৰ"
    @months[:gregorian][:wide]["12"] = "ডিসেম্বৰ"
    @months[:gregorian][:wide]["2"] = "ফেব্ৰুয়াৰী"
    @months[:gregorian][:wide]["3"] = "মাৰ্চ"
    @months[:gregorian][:wide]["4"] = "এপ্ৰিল"
    @months[:gregorian][:wide]["5"] = "মে"
    @months[:gregorian][:wide]["6"] = "জুন"
    @months[:gregorian][:wide]["7"] = "জুলাই"
    @months[:gregorian][:wide]["8"] = "আগষ্ট"
    @months[:gregorian][:wide]["9"] = "সেপ্টেম্বৰ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "শুক্ৰ"
    @days[:gregorian][:abbreviated]["mon"] = "সোম"
    @days[:gregorian][:abbreviated]["sat"] = "শনি"
    @days[:gregorian][:abbreviated]["sun"] = "ৰবি"
    @days[:gregorian][:abbreviated]["thu"] = "বৃহষ্পতি"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "শুক্ৰবাৰ"
    @days[:gregorian][:wide]["mon"] = "সোমবাৰ"
    @days[:gregorian][:wide]["sat"] = "শনিবাৰ"
    @days[:gregorian][:wide]["sun"] = "ৰবিবাৰ"
    @days[:gregorian][:wide]["thu"] = "বৃহষ্পতিবাৰ"
    @days[:gregorian][:wide]["tue"] = "মঙ্গলবাৰ"
    @days[:gregorian][:wide]["wed"] = "বুধবাৰ"
    @dayformat_defaults = {}
