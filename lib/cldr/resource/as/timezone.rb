...
#
  ...
  def init_data
    ...
    @exemplarcities = {}
    @exemplarcities["Asia/Calcutta"] = "এলাহাৱাদ"
    @long_generics = {}
    @long_standards = {}
    @long_standards["Asia/Calcutta"] = "ভাৰতীয় সময়"
    @long_daylights = {}
    @long_daylights["Asia/Calcutta"] = "ভাৰতীয় সময়"
    @short_generics = {}
    @short_standards = {}
    @short_standards["Asia/Calcutta"] = "ভা. স."
    @short_daylights = {}
    @short_daylights["Asia/Calcutta"] = "ভা. স."
  end
