...
# CLDR version: 1.3
#
# Original file name: common/main/az_Cyrl_AZ.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "yan"
    @months[:gregorian][:abbreviated]["10"] = "okt"
    @months[:gregorian][:abbreviated]["11"] = "noy"
    ...
    @months[:gregorian][:abbreviated]["6"] = "iyn"
    @months[:gregorian][:abbreviated]["7"] = "iyl"
    @months[:gregorian][:abbreviated]["8"] = "avq"
    ...
    @months[:gregorian][:wide]["1"] = "јанвар"
    @months[:gregorian][:wide]["10"] = "октјабр"
    @months[:gregorian][:wide]["11"] = "нојабр"
    @months[:gregorian][:wide]["12"] = "декабр"
    @months[:gregorian][:wide]["2"] = "феврал"
    @months[:gregorian][:wide]["3"] = "март"
    @months[:gregorian][:wide]["4"] = "апрел"
    @months[:gregorian][:wide]["5"] = "май"
    @months[:gregorian][:wide]["6"] = "ијун"
    @months[:gregorian][:wide]["7"] = "ијул"
    @months[:gregorian][:wide]["8"] = "август"
    @months[:gregorian][:wide]["9"] = "сентјабр"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "C."
    @days[:gregorian][:abbreviated]["mon"] = "B.e."
    @days[:gregorian][:abbreviated]["sat"] = "Ş."
    @days[:gregorian][:abbreviated]["sun"] = "B."
    @days[:gregorian][:abbreviated]["thu"] = "C.a."
    @days[:gregorian][:abbreviated]["tue"] = "Ç.a."
    @days[:gregorian][:abbreviated]["wed"] = "Ç."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ҹүмә"
    @days[:gregorian][:wide]["mon"] = "базар ертәси"
    @days[:gregorian][:wide]["sat"] = "шәнбә"
    @days[:gregorian][:wide]["sun"] = "базар"
    @days[:gregorian][:wide]["thu"] = "ҹүмә ахшамы"
    @days[:gregorian][:wide]["tue"] = "чәршәнбә ахшамы"
    @days[:gregorian][:wide]["wed"] = "чәршәнбә"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "eramızdan əvvəl"
    @era_names[:gregorian]["1"] = "bizim eramızın"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "e.ə."
    @era_abbrs[:gregorian]["1"] = "b.e."
    @era_abbrs[:hebrew] = {}
