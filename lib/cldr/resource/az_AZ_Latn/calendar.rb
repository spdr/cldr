...
# CLDR version: 1.3
#
# Original file name: common/main/az_Latn_AZ.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["6"] = "İyun"
    @months[:gregorian][:wide]["7"] = "İyul"
    @months[:gregorian][:wide]["8"] = "Avqust"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "cümə"
    @days[:gregorian][:wide]["mon"] = "bazar ertəsi"
    @days[:gregorian][:wide]["sat"] = "şənbə"
    @days[:gregorian][:wide]["sun"] = "bazar"
    @days[:gregorian][:wide]["thu"] = "cümə axşamı"
    @days[:gregorian][:wide]["tue"] = "çərşənbə axşam"
    @days[:gregorian][:wide]["wed"] = "çərşənbə"
    @dayformat_defaults = {}
