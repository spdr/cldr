...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "сту"
    @months[:gregorian][:abbreviated]["10"] = "кас"
    @months[:gregorian][:abbreviated]["11"] = "ліс"
    @months[:gregorian][:abbreviated]["12"] = "сне"
    @months[:gregorian][:abbreviated]["2"] = "лют"
    @months[:gregorian][:abbreviated]["3"] = "сак"
    @months[:gregorian][:abbreviated]["4"] = "кра"
    @months[:gregorian][:abbreviated]["5"] = "май"
    @months[:gregorian][:abbreviated]["6"] = "чэр"
    @months[:gregorian][:abbreviated]["7"] = "ліп"
    @months[:gregorian][:abbreviated]["8"] = "жні"
    @months[:gregorian][:abbreviated]["9"] = "вер"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "с"
    @months[:gregorian][:narrow]["10"] = "к"
    @months[:gregorian][:narrow]["11"] = "л"
    @months[:gregorian][:narrow]["12"] = "с"
    @months[:gregorian][:narrow]["2"] = "л"
    @months[:gregorian][:narrow]["3"] = "с"
    @months[:gregorian][:narrow]["4"] = "к"
    @months[:gregorian][:narrow]["5"] = "м"
    @months[:gregorian][:narrow]["6"] = "ч"
    @months[:gregorian][:narrow]["7"] = "л"
    @months[:gregorian][:narrow]["8"] = "ж"
    @months[:gregorian][:narrow]["9"] = "в"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "студзень"
    @months[:gregorian][:wide]["10"] = "кастрычнік"
    @months[:gregorian][:wide]["11"] = "лістапад"
    @months[:gregorian][:wide]["12"] = "снежань"
    @months[:gregorian][:wide]["2"] = "люты"
    @months[:gregorian][:wide]["3"] = "сакавік"
    @months[:gregorian][:wide]["4"] = "красавік"
    @months[:gregorian][:wide]["5"] = "май"
    @months[:gregorian][:wide]["6"] = "чэрвень"
    @months[:gregorian][:wide]["7"] = "ліпень"
    @months[:gregorian][:wide]["8"] = "жнівень"
    @months[:gregorian][:wide]["9"] = "верасень"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["thu"] = "чц"
    @days[:gregorian][:abbreviated]["tue"] = "аў"
    ...
    @days[:gregorian][:narrow]["tue"] = "а"
    @days[:gregorian][:narrow]["wed"] = "с"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "пятніца"
    @days[:gregorian][:wide]["mon"] = "панядзелак"
    @days[:gregorian][:wide]["sat"] = "субота"
    @days[:gregorian][:wide]["sun"] = "нядзеля"
    @days[:gregorian][:wide]["thu"] = "чацвер"
    @days[:gregorian][:wide]["tue"] = "аўторак"
    @days[:gregorian][:wide]["wed"] = "серада"
    @dayformat_defaults = {}
