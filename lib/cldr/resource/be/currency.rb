...
#
  ...
  def init_data
    ...
    @after_insertbetween = " "
    @currencies = {}
    @currencies["BRL"] = "бразільскі рэал"
    @currencies["BYR"] = "беларускі рубель"
    @currencies["CNY"] = "кітайскі юань Renminbi"
    @currencies["EUR"] = "еўра"
    @currencies["GBP"] = "англійскі фунт"
    @currencies["INR"] = "індыйская рупія"
    @currencies["ITL"] = "ITL"
    @currencies["JPY"] = "японская іена"
    @currencies["RUB"] = "рускі рубель"
    @currencies["USD"] = "долар ЗША"
    @symbols = {}
    @symbols["BYB"] = "Руб"
    @symbols["EUR"] = "€"
    @symbols["GBP"] = "£"
