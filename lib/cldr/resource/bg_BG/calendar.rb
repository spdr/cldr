...
#
  ...
  def init_data
    ...
    @months[:gregorian][:narrow]["6"] = "ю"
    @months[:gregorian][:narrow]["7"] = "ю"
    @months[:gregorian][:narrow]["8"] = "а"
    @months[:gregorian][:narrow]["9"] = "с"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "януари"
    @months[:gregorian][:wide]["10"] = "октомври"
    @months[:gregorian][:wide]["11"] = "ноември"
    @months[:gregorian][:wide]["12"] = "декември"
    @months[:gregorian][:wide]["2"] = "февруари"
    @months[:gregorian][:wide]["3"] = "март"
    @months[:gregorian][:wide]["4"] = "април"
    @months[:gregorian][:wide]["5"] = "май"
    @months[:gregorian][:wide]["6"] = "юни"
    @months[:gregorian][:wide]["7"] = "юли"
    @months[:gregorian][:wide]["8"] = "август"
    @months[:gregorian][:wide]["9"] = "септември"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["sun"] = "нд"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "петък"
    @days[:gregorian][:wide]["mon"] = "понеделник"
    @days[:gregorian][:wide]["sat"] = "събота"
    @days[:gregorian][:wide]["sun"] = "неделя"
    @days[:gregorian][:wide]["thu"] = "четвъртък"
    @days[:gregorian][:wide]["tue"] = "вторник"
    @days[:gregorian][:wide]["wed"] = "сряда"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "преди Христа"
    @era_names[:gregorian]["1"] = "след Христа"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "пр.Хр."
    @era_abbrs[:gregorian]["1"] = "сл.Хр."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "dd MMMM yyyy, EEEE"
    ...
    @timeformats[:gregorian]["long"] = "HH:mm:ss"
