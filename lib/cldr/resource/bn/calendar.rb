...
# CLDR version: 1.3
#
# Original file name: common/main/bn.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "জানুয়ারী"
    @months[:gregorian][:abbreviated]["10"] = "অক্টোবর"
    @months[:gregorian][:abbreviated]["11"] = "নভেম্বর"
    @months[:gregorian][:abbreviated]["12"] = "ডিসেম্বর"
    @months[:gregorian][:abbreviated]["2"] = "ফেব্রুয়ারী"
    @months[:gregorian][:abbreviated]["3"] = "মার্চ"
    @months[:gregorian][:abbreviated]["4"] = "এপ্রিল"
    @months[:gregorian][:abbreviated]["5"] = "মে"
    @months[:gregorian][:abbreviated]["6"] = "জুন"
    @months[:gregorian][:abbreviated]["7"] = "জুলাই"
    @months[:gregorian][:abbreviated]["8"] = "আগস্ট"
    @months[:gregorian][:abbreviated]["9"] = "সেপ্টেম্বর"
    ...
    @months[:gregorian][:wide]["1"] = "জানুয়ারী"
    @months[:gregorian][:wide]["10"] = "অক্টোবর"
    @months[:gregorian][:wide]["11"] = "নভেম্বর"
    @months[:gregorian][:wide]["12"] = "ডিসেম্বর"
    @months[:gregorian][:wide]["2"] = "ফেব্রুয়ারী"
    @months[:gregorian][:wide]["3"] = "মার্চ"
    @months[:gregorian][:wide]["4"] = "এপ্রিল"
    @months[:gregorian][:wide]["5"] = "মে"
    @months[:gregorian][:wide]["6"] = "জুন"
    @months[:gregorian][:wide]["7"] = "জুলাই"
    @months[:gregorian][:wide]["8"] = "আগস্ট"
    @months[:gregorian][:wide]["9"] = "সেপ্টেম্বর"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "শুক্র"
    @days[:gregorian][:abbreviated]["mon"] = "সোম"
    @days[:gregorian][:abbreviated]["sat"] = "শনি"
    @days[:gregorian][:abbreviated]["sun"] = "রবি"
    @days[:gregorian][:abbreviated]["thu"] = "বৃহস্পতি"
    @days[:gregorian][:abbreviated]["tue"] = "মঙ্গল"
    @days[:gregorian][:abbreviated]["wed"] = "বুধ"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "শুক্রবার"
    @days[:gregorian][:wide]["mon"] = "সোমবার"
    @days[:gregorian][:wide]["sat"] = "শনিবার"
    @days[:gregorian][:wide]["sun"] = "রবিবার"
    @days[:gregorian][:wide]["thu"] = "বৃহষ্পতিবার"
    @days[:gregorian][:wide]["tue"] = "মঙ্গলবার"
    @days[:gregorian][:wide]["wed"] = "বুধবার"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "পূর্বাহ্ণ"
    @pm = {}
    @pm["gregorian"] = "অপরাহ্ণ"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
