...
# CLDR version: 1.3
#
# Original file name: common/main/byn_ER.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ልደት"
    @months[:gregorian][:abbreviated]["10"] = "መተሉ"
    @months[:gregorian][:abbreviated]["11"] = "ም/ም"
    @months[:gregorian][:abbreviated]["12"] = "ተሕሳ"
    @months[:gregorian][:abbreviated]["2"] = "ካብኽ"
    @months[:gregorian][:abbreviated]["3"] = "ክብላ"
    @months[:gregorian][:abbreviated]["4"] = "ፋጅኺ"
    @months[:gregorian][:abbreviated]["5"] = "ክቢቅ"
    @months[:gregorian][:abbreviated]["6"] = "ም/ት"
    @months[:gregorian][:abbreviated]["7"] = "ኰር"
    @months[:gregorian][:abbreviated]["8"] = "ማርያ"
    @months[:gregorian][:abbreviated]["9"] = "ያኸኒ"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ል"
    @months[:gregorian][:narrow]["10"] = "መ"
    @months[:gregorian][:narrow]["11"] = "ም"
    @months[:gregorian][:narrow]["12"] = "ተ"
    @months[:gregorian][:narrow]["2"] = "ካ"
    @months[:gregorian][:narrow]["3"] = "ክ"
    @months[:gregorian][:narrow]["4"] = "ፋ"
    @months[:gregorian][:narrow]["5"] = "ክ"
    @months[:gregorian][:narrow]["6"] = "ም"
    @months[:gregorian][:narrow]["7"] = "ኰ"
    @months[:gregorian][:narrow]["8"] = "ማ"
    @months[:gregorian][:narrow]["9"] = "ያ"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "ልደትሪ"
    @months[:gregorian][:wide]["10"] = "መተሉ"
    @months[:gregorian][:wide]["11"] = "ምኪኤል መሽወሪ"
    @months[:gregorian][:wide]["12"] = "ተሕሳስሪ"
    @months[:gregorian][:wide]["2"] = "ካብኽብቲ"
    @months[:gregorian][:wide]["3"] = "ክብላ"
    @months[:gregorian][:wide]["4"] = "ፋጅኺሪ"
    @months[:gregorian][:wide]["5"] = "ክቢቅሪ"
    @months[:gregorian][:wide]["6"] = "ምኪኤል ትጓ̅ኒሪ"
    @months[:gregorian][:wide]["7"] = "ኰርኩ"
    @months[:gregorian][:wide]["8"] = "ማርያም ትሪ"
    @months[:gregorian][:wide]["9"] = "ያኸኒ መሳቅለሪ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ኣርብ"
    @days[:gregorian][:abbreviated]["mon"] = "ሰኑ"
    @days[:gregorian][:abbreviated]["sat"] = "ሰ/ሽ"
    @days[:gregorian][:abbreviated]["sun"] = "ሰ/ቅ"
    @days[:gregorian][:abbreviated]["thu"] = "ኣምድ"
    @days[:gregorian][:abbreviated]["tue"] = "ሰሊጝ"
    @days[:gregorian][:abbreviated]["wed"] = "ለጓ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ኣ"
    @days[:gregorian][:narrow]["mon"] = "ሰ"
    @days[:gregorian][:narrow]["sat"] = "ሰ"
    @days[:gregorian][:narrow]["sun"] = "ሰ"
    @days[:gregorian][:narrow]["thu"] = "ኣ"
    @days[:gregorian][:narrow]["tue"] = "ሰ"
    @days[:gregorian][:narrow]["wed"] = "ለ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ኣርብ"
    @days[:gregorian][:wide]["mon"] = "ሰኑ"
    @days[:gregorian][:wide]["sat"] = "ሰንበር ሽጓዅ"
    @days[:gregorian][:wide]["sun"] = "ሰንበር ቅዳዅ"
    @days[:gregorian][:wide]["thu"] = "ኣምድ"
    @days[:gregorian][:wide]["tue"] = "ሰሊጝ"
    @days[:gregorian][:wide]["wed"] = "ለጓ ወሪ ለብዋ"
    @dayformat_defaults = {}
    ...
    @am["gregorian"] = "ፋዱስ ጃብ"
    @pm = {}
    @pm["gregorian"] = "ፋዱስ ደምቢ"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "ይጅ"
    @era_abbrs[:gregorian]["1"] = "ኣድ"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE፡ dd MMMM ግርጋ yyyy G"
