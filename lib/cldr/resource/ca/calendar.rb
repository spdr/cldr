...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["3"] = "març"
    @months[:gregorian][:abbreviated]["4"] = "abr."
    @months[:gregorian][:abbreviated]["5"] = "maig"
    @months[:gregorian][:abbreviated]["6"] = "juny"
    @months[:gregorian][:abbreviated]["7"] = "jul."
    @months[:gregorian][:abbreviated]["8"] = "ag."
    ...
    @months[:gregorian][:wide]["1"] = "gener"
    @months[:gregorian][:wide]["10"] = "octubre"
    @months[:gregorian][:wide]["11"] = "novembre"
    @months[:gregorian][:wide]["12"] = "desembre"
    @months[:gregorian][:wide]["2"] = "febrer"
    @months[:gregorian][:wide]["3"] = "març"
    @months[:gregorian][:wide]["4"] = "abril"
    @months[:gregorian][:wide]["5"] = "maig"
    @months[:gregorian][:wide]["6"] = "juny"
    @months[:gregorian][:wide]["7"] = "juliol"
    @months[:gregorian][:wide]["8"] = "agost"
    @months[:gregorian][:wide]["9"] = "setembre"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "dv."
    @days[:gregorian][:abbreviated]["mon"] = "dl."
    @days[:gregorian][:abbreviated]["sat"] = "ds."
    @days[:gregorian][:abbreviated]["sun"] = "dg."
    @days[:gregorian][:abbreviated]["thu"] = "dj."
    @days[:gregorian][:abbreviated]["tue"] = "dt."
    @days[:gregorian][:abbreviated]["wed"] = "dc."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "divendres"
    @days[:gregorian][:wide]["mon"] = "dilluns"
    @days[:gregorian][:wide]["sat"] = "dissabte"
    @days[:gregorian][:wide]["sun"] = "diumenge"
    @days[:gregorian][:wide]["thu"] = "dijous"
    @days[:gregorian][:wide]["tue"] = "dimarts"
    @days[:gregorian][:wide]["wed"] = "dimecres"
    @dayformat_defaults = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE d 'd’'MMMM 'de' yyyy"
    @dateformats[:gregorian]["long"] = "d 'd’'MMMM 'de' yyyy"
