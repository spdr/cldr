...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "GuMtkHmsSEDFwWahKzUeygAZ"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    @months[:gregorian][:abbreviated] = {}
    @months[:gregorian][:abbreviated]["1"] = "led"
    @months[:gregorian][:abbreviated]["10"] = "říj"
    @months[:gregorian][:abbreviated]["11"] = "lis"
    @months[:gregorian][:abbreviated]["12"] = "pro"
    @months[:gregorian][:abbreviated]["2"] = "úno"
    @months[:gregorian][:abbreviated]["3"] = "bře"
    @months[:gregorian][:abbreviated]["4"] = "dub"
    @months[:gregorian][:abbreviated]["5"] = "kvě"
    @months[:gregorian][:abbreviated]["6"] = "črn"
    @months[:gregorian][:abbreviated]["7"] = "črc"
    @months[:gregorian][:abbreviated]["8"] = "srp"
    @months[:gregorian][:abbreviated]["9"] = "zář"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "l"
    @months[:gregorian][:narrow]["10"] = "ř"
    @months[:gregorian][:narrow]["11"] = "l"
    @months[:gregorian][:narrow]["12"] = "p"
    @months[:gregorian][:narrow]["2"] = "ú"
    @months[:gregorian][:narrow]["3"] = "b"
    @months[:gregorian][:narrow]["4"] = "d"
    @months[:gregorian][:narrow]["5"] = "k"
    @months[:gregorian][:narrow]["6"] = "č"
    @months[:gregorian][:narrow]["7"] = "č"
    @months[:gregorian][:narrow]["8"] = "s"
    @months[:gregorian][:narrow]["9"] = "z"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "leden"
    @months[:gregorian][:wide]["10"] = "říjen"
    @months[:gregorian][:wide]["11"] = "listopad"
    @months[:gregorian][:wide]["12"] = "prosinec"
    @months[:gregorian][:wide]["2"] = "únor"
    @months[:gregorian][:wide]["3"] = "březen"
    @months[:gregorian][:wide]["4"] = "duben"
    @months[:gregorian][:wide]["5"] = "květen"
    @months[:gregorian][:wide]["6"] = "červen"
    @months[:gregorian][:wide]["7"] = "červenec"
    @months[:gregorian][:wide]["8"] = "srpen"
    @months[:gregorian][:wide]["9"] = "září"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "pá"
    @days[:gregorian][:abbreviated]["mon"] = "po"
    @days[:gregorian][:abbreviated]["sat"] = "so"
    @days[:gregorian][:abbreviated]["sun"] = "ne"
    @days[:gregorian][:abbreviated]["thu"] = "čt"
    @days[:gregorian][:abbreviated]["tue"] = "út"
    @days[:gregorian][:abbreviated]["wed"] = "st"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "P"
    @days[:gregorian][:narrow]["mon"] = "P"
    @days[:gregorian][:narrow]["sat"] = "S"
    @days[:gregorian][:narrow]["sun"] = "N"
    @days[:gregorian][:narrow]["thu"] = "Č"
    @days[:gregorian][:narrow]["tue"] = "Ú"
    @days[:gregorian][:narrow]["wed"] = "S"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "pátek"
    @days[:gregorian][:wide]["mon"] = "pondělí"
    @days[:gregorian][:wide]["sat"] = "sobota"
    @days[:gregorian][:wide]["sun"] = "neděle"
    @days[:gregorian][:wide]["thu"] = "čtvrtek"
    @days[:gregorian][:wide]["tue"] = "úterý"
    @days[:gregorian][:wide]["wed"] = "středa"
    @dayformat_defaults = {}
    ...
    @timeformats[:gregorian]["full"] = "H:mm:ssZZ"
    @timeformats[:gregorian]["long"] = "H:mm:ssZZ"
