...
# CLDR version: 1.3
#
# Original file name: common/main/cy.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Ion"
    @months[:gregorian][:abbreviated]["10"] = "Hyd"
    @months[:gregorian][:abbreviated]["11"] = "Tach"
    @months[:gregorian][:abbreviated]["12"] = "Rhag"
    @months[:gregorian][:abbreviated]["2"] = "Chwef"
    @months[:gregorian][:abbreviated]["3"] = "Mawrth"
    @months[:gregorian][:abbreviated]["4"] = "Ebrill"
    @months[:gregorian][:abbreviated]["5"] = "Mai"
    @months[:gregorian][:abbreviated]["6"] = "Meh"
    @months[:gregorian][:abbreviated]["7"] = "Gorff"
    @months[:gregorian][:abbreviated]["8"] = "Awst"
    @months[:gregorian][:abbreviated]["9"] = "Medi"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "I"
    @months[:gregorian][:narrow]["10"] = "H"
    @months[:gregorian][:narrow]["11"] = "T"
    @months[:gregorian][:narrow]["12"] = "R"
    @months[:gregorian][:narrow]["2"] = "C"
    @months[:gregorian][:narrow]["3"] = "M"
    @months[:gregorian][:narrow]["4"] = "E"
    @months[:gregorian][:narrow]["5"] = "M"
    @months[:gregorian][:narrow]["6"] = "M"
    @months[:gregorian][:narrow]["7"] = "G"
    @months[:gregorian][:narrow]["8"] = "A"
    @months[:gregorian][:narrow]["9"] = "M"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Ionawr"
    @months[:gregorian][:wide]["10"] = "Hydref"
    @months[:gregorian][:wide]["11"] = "Tachwedd"
    @months[:gregorian][:wide]["12"] = "Rhagfyr"
    @months[:gregorian][:wide]["2"] = "Chwefror"
    @months[:gregorian][:wide]["3"] = "Mawrth"
    @months[:gregorian][:wide]["4"] = "Ebrill"
    @months[:gregorian][:wide]["5"] = "Mai"
    @months[:gregorian][:wide]["6"] = "Mehefin"
    @months[:gregorian][:wide]["7"] = "Gorffenaf"
    @months[:gregorian][:wide]["8"] = "Awst"
    @months[:gregorian][:wide]["9"] = "Medi"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Gwen"
    @days[:gregorian][:abbreviated]["mon"] = "Llun"
    @days[:gregorian][:abbreviated]["sat"] = "Sad"
    @days[:gregorian][:abbreviated]["sun"] = "Sul"
    @days[:gregorian][:abbreviated]["thu"] = "Iau"
    @days[:gregorian][:abbreviated]["tue"] = "Maw"
    ...
    @days[:gregorian][:narrow]["thu"] = "I"
    @days[:gregorian][:narrow]["tue"] = "M"
    @days[:gregorian][:narrow]["wed"] = "M"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Dydd Gwener"
    @days[:gregorian][:wide]["mon"] = "Dydd Llun"
    @days[:gregorian][:wide]["sat"] = "Dydd Sadwrn"
    @days[:gregorian][:wide]["sun"] = "Dydd Sul"
    @days[:gregorian][:wide]["thu"] = "Dydd Iau"
    @days[:gregorian][:wide]["tue"] = "Dydd Mawrth"
    @days[:gregorian][:wide]["wed"] = "Dydd Mercher"
    @dayformat_defaults = {}
