...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "fre"
    @days[:gregorian][:abbreviated]["mon"] = "man"
    @days[:gregorian][:abbreviated]["sat"] = "lør"
    @days[:gregorian][:abbreviated]["sun"] = "søn"
    @days[:gregorian][:abbreviated]["thu"] = "tor"
    @days[:gregorian][:abbreviated]["tue"] = "tir"
    @days[:gregorian][:abbreviated]["wed"] = "ons"
    ...
    @days[:gregorian][:narrow]["wed"] = "O"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "fredag"
    @days[:gregorian][:wide]["mon"] = "mandag"
    @days[:gregorian][:wide]["sat"] = "lørdag"
    @days[:gregorian][:wide]["sun"] = "søndag"
    @days[:gregorian][:wide]["thu"] = "torsdag"
    @days[:gregorian][:wide]["tue"] = "tirsdag"
    @days[:gregorian][:wide]["wed"] = "onsdag"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "f.Kr."
    @era_abbrs[:gregorian]["1"] = "e.Kr."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE 'den' dd. MMM yyyy"
