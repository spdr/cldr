...
#
  ...
  def init_data
    ...
    @exemplarcities["America/Godthab"] = "Nuuk"
    ...
    @exemplarcities["Atlantic/Canary"] = "De Kanariske Øer"
    ...
    @exemplarcities["Pacific/Easter"] = "Påskeøen"
    @long_generics = {}
    @long_standards = {}
    @long_standards["Africa/Casablanca"] = "Verdenstid"
    ...
    @long_standards["Asia/Jerusalem"] = "Israelsk normaltid"
    @long_standards["Asia/Shanghai"] = "Kinesisk normaltid"
    @long_standards["Asia/Tokyo"] = "Japansk normaltid"
    @long_standards["Europe/Bucharest"] = "Østeuropæisk normaltid"
    @long_standards["Europe/Paris"] = "Mellemeuropæisk normaltid"
    @long_standards["Pacific/Honolulu"] = "Hawaii-normaltid"
    @long_daylights = {}
    @long_daylights["Africa/Casablanca"] = "Verdenstid"
    @long_daylights["America/Anchorage"] = "Alaska-sommertid"
    @long_daylights["America/Chicago"] = "Central-sommertid"
    @long_daylights["America/Denver"] = "Mountain-sommertid"
    @long_daylights["America/Halifax"] = "Atlantic-sommertid"
    @long_daylights["America/Indianapolis"] = "Eastern-normaltid"
    @long_daylights["America/Los_Angeles"] = "Pacific-sommertid"
    @long_daylights["America/New_York"] = "Eastern-sommertid"
    @long_daylights["America/Phoenix"] = "Mountain-normaltid"
    @long_daylights["America/St_Johns"] = "Newfoundland-sommertid"
    @long_daylights["Asia/Jerusalem"] = "Israelsk sommertid"
    @long_daylights["Asia/Shanghai"] = "Kinesisk normaltid"
    @long_daylights["Asia/Tokyo"] = "Japansk normaltid"
    @long_daylights["Europe/Bucharest"] = "Østeuropæisk sommertid"
    @long_daylights["Europe/Paris"] = "Mellemeuropæisk sommertid"
