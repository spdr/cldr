...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "GjMtkHmsSEDFwWahKzJeugAZ"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    @months[:gregorian][:abbreviated] = {}
    @months[:gregorian][:abbreviated]["1"] = "Jän"
    ...
    @months[:gregorian][:abbreviated]["3"] = "Mär"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Fr"
    @days[:gregorian][:abbreviated]["mon"] = "Mo"
    @days[:gregorian][:abbreviated]["sat"] = "Sa"
    @days[:gregorian][:abbreviated]["sun"] = "So"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Freitag"
    @days[:gregorian][:wide]["mon"] = "Montag"
    @days[:gregorian][:wide]["sat"] = "Samstag"
    @days[:gregorian][:wide]["sun"] = "Sonntag"
    @days[:gregorian][:wide]["thu"] = "Donnerstag"
    @days[:gregorian][:wide]["tue"] = "Dienstag"
    @days[:gregorian][:wide]["wed"] = "Mittwoch"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "v. Chr."
    @era_names[:gregorian]["1"] = "n. Chr."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    ...
    @timeformats[:gregorian]["full"] = "HH:mm' Uhr 'z"
