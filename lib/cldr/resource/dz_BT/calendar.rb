...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ཟླ་ ༡"
    @months[:gregorian][:abbreviated]["10"] = "ཟླ་ ༡༠"
    @months[:gregorian][:abbreviated]["11"] = "ཟླ་ ༡༡"
    @months[:gregorian][:abbreviated]["12"] = "ཟླ་ ༡༢"
    @months[:gregorian][:abbreviated]["2"] = "ཟླ་ ༢"
    @months[:gregorian][:abbreviated]["3"] = "ཟླ་ ༣"
    @months[:gregorian][:abbreviated]["4"] = "ཟླ་ ༤"
    @months[:gregorian][:abbreviated]["5"] = "ཟླ་ ༥"
    @months[:gregorian][:abbreviated]["6"] = "ཟླ་ ༦"
    @months[:gregorian][:abbreviated]["7"] = "ཟླ་ ༧"
    @months[:gregorian][:abbreviated]["8"] = "ཟླ་ ༨"
    @months[:gregorian][:abbreviated]["9"] = "ཟླ་ ༩"
    ...
    @months[:gregorian][:wide]["1"] = "སྤྱི་ཟླཝ་དངཔ་"
    @months[:gregorian][:wide]["10"] = "སྤྱི་ཟླཝ་བཅུ་པ་"
    @months[:gregorian][:wide]["11"] = "སྤྱི་ཟླཝ་བཅུ་གཅིག་པ་"
    @months[:gregorian][:wide]["12"] = "སྤྱི་ཟླཝ་བཅུ་གཉིས་པ་"
    @months[:gregorian][:wide]["2"] = "སྤྱི་ཟླཝ་གཉིས་པ་"
    @months[:gregorian][:wide]["3"] = "སྤྱི་ཟླཝ་གསུམ་པ་"
    @months[:gregorian][:wide]["4"] = "སྤྱི་ཟླཝ་བཞི་པ་"
    @months[:gregorian][:wide]["5"] = "སྤྱི་ཟླཝ་ལྔ་པ་"
    @months[:gregorian][:wide]["6"] = "སྤྱི་ཟླཝ་དྲུག་པ་"
    @months[:gregorian][:wide]["7"] = "སྤྱི་ཟླཝ་བདུན་པ་"
    @months[:gregorian][:wide]["8"] = "སྤྱི་ཟླཝ་བརྒྱད་པ་"
    @months[:gregorian][:wide]["9"] = "སྤྱི་ཟླཝ་དགུ་པ་"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "སྤེན་"
    @days[:gregorian][:abbreviated]["mon"] = "མིར་"
    @days[:gregorian][:abbreviated]["sat"] = "ཉི་"
    @days[:gregorian][:abbreviated]["sun"] = "ཟླ་"
    @days[:gregorian][:abbreviated]["thu"] = "སངས་"
    @days[:gregorian][:abbreviated]["tue"] = "ལྷག་"
    @days[:gregorian][:abbreviated]["wed"] = "ཕུར་"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "གཟའ་སྤེན་པ་"
    @days[:gregorian][:wide]["mon"] = "གཟའ་མིག་དམར་"
    @days[:gregorian][:wide]["sat"] = "གཟའ་ཉི་མ་"
    @days[:gregorian][:wide]["sun"] = "གཟའ་ཟླ་བ་"
    @days[:gregorian][:wide]["thu"] = "གཟའ་པ་སངས་"
    @days[:gregorian][:wide]["tue"] = "གཟའ་ལྷག་པ་"
    @days[:gregorian][:wide]["wed"] = "གཟའ་ཕུར་བུ་"
    @dayformat_defaults = {}
    ...
    @dateformats[:gregorian]["full"] = "སྤྱི་ལོ་yyyy ཟླ་ MMMM ཚེས་ dd"
    @dateformats[:gregorian]["long"] = "སྤྱི་ལོ་yyyy ཟླ་ MMMM ཚེས་ dd"
    @dateformats[:gregorian]["medium"] = "སྤྱི་ལོ་yyyy ཟླ་ MMM ཚེས་ dd"
    @dateformats[:gregorian]["short"] = "སྤྱི་ལོ་ yyyy ཟླ་ MMM ཚེས་ dd"
    ...
    @timeformats[:gregorian]["full"] = "ཆུ་ཚོད་ h སྐར་མ་ mm སྐར་ཆཱ་ ss a zzzz"
    @timeformats[:gregorian]["long"] = "ཆུ་ཚོད་ h སྐར་མ་ mm སྐར་ཆཱ་ ss a zzz"
    @timeformats[:gregorian]["medium"] = "ཆུ་ཚོད་h:mm:ss a"
    @timeformats[:gregorian]["short"] = "ཆུ་ཚོད་ h སྐར་མ་ mm a"
