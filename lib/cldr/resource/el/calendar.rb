...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Ἰαν"
    @months[:gregorian][:abbreviated]["10"] = "Ὀκτ"
    @months[:gregorian][:abbreviated]["11"] = "Νοε"
    @months[:gregorian][:abbreviated]["12"] = "Δεκ"
    @months[:gregorian][:abbreviated]["2"] = "Φεβ"
    @months[:gregorian][:abbreviated]["3"] = "Μαρ"
    @months[:gregorian][:abbreviated]["4"] = "Ἀπρ"
    @months[:gregorian][:abbreviated]["5"] = "Μαϊ"
    @months[:gregorian][:abbreviated]["6"] = "Ἰουν"
    @months[:gregorian][:abbreviated]["7"] = "Ἰουλ"
    @months[:gregorian][:abbreviated]["8"] = "Αὐγ"
    @months[:gregorian][:abbreviated]["9"] = "Σεπ"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "Ι"
    @months[:gregorian][:narrow]["10"] = "Ο"
    @months[:gregorian][:narrow]["11"] = "Ν"
    @months[:gregorian][:narrow]["12"] = "Δ"
    @months[:gregorian][:narrow]["2"] = "Φ"
    @months[:gregorian][:narrow]["3"] = "Μ"
    @months[:gregorian][:narrow]["4"] = "Α"
    @months[:gregorian][:narrow]["5"] = "Μ"
    @months[:gregorian][:narrow]["6"] = "Ι"
    @months[:gregorian][:narrow]["7"] = "Ι"
    @months[:gregorian][:narrow]["8"] = "Α"
    @months[:gregorian][:narrow]["9"] = "Σ"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Ἰανουάριος"
    @months[:gregorian][:wide]["10"] = "Ὀκτώβριος"
    @months[:gregorian][:wide]["11"] = "Νοέμβριος"
    @months[:gregorian][:wide]["12"] = "Δεκέμβριος"
    @months[:gregorian][:wide]["2"] = "Φεβρουάριος"
    @months[:gregorian][:wide]["3"] = "Μάρτιος"
    @months[:gregorian][:wide]["4"] = "Ἀπρίλιος"
    @months[:gregorian][:wide]["5"] = "Μάιος"
    @months[:gregorian][:wide]["6"] = "Ἰούνιος"
    @months[:gregorian][:wide]["7"] = "Ἰούλιος"
    @months[:gregorian][:wide]["8"] = "Αὔγουστος"
    @months[:gregorian][:wide]["9"] = "Σεπτέμβριος"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Παρ"
    @days[:gregorian][:abbreviated]["mon"] = "Δευ"
    @days[:gregorian][:abbreviated]["sat"] = "Σαβ"
    @days[:gregorian][:abbreviated]["sun"] = "Κυρ"
    @days[:gregorian][:abbreviated]["thu"] = "Πεμ"
    @days[:gregorian][:abbreviated]["tue"] = "Τρι"
    @days[:gregorian][:abbreviated]["wed"] = "Τετ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "Π"
    @days[:gregorian][:narrow]["mon"] = "Δ"
    @days[:gregorian][:narrow]["sat"] = "Σ"
    @days[:gregorian][:narrow]["sun"] = "Κ"
    @days[:gregorian][:narrow]["thu"] = "Π"
    @days[:gregorian][:narrow]["tue"] = "Τ"
    @days[:gregorian][:narrow]["wed"] = "Τ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Παρασκευή"
    @days[:gregorian][:wide]["mon"] = "Δευτέρα"
    @days[:gregorian][:wide]["sat"] = "Σάββατο"
    @days[:gregorian][:wide]["sun"] = "Κυριακή"
    @days[:gregorian][:wide]["thu"] = "Πέμπτη"
    @days[:gregorian][:wide]["tue"] = "Τρίτη"
    @days[:gregorian][:wide]["wed"] = "Τετάρτη"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "π.Χ."
    @era_abbrs[:gregorian]["1"] = "μ.Χ."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["short"] = "dd/MM/yyyy"
