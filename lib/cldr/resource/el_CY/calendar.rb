...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Ιαν"
    @months[:gregorian][:abbreviated]["10"] = "Οκτ"
    ...
    @months[:gregorian][:abbreviated]["4"] = "Απρ"
    @months[:gregorian][:abbreviated]["5"] = "Μαϊ"
    @months[:gregorian][:abbreviated]["6"] = "Ιουν"
    @months[:gregorian][:abbreviated]["7"] = "Ιουλ"
    @months[:gregorian][:abbreviated]["8"] = "Αυγ"
    ...
    @months[:gregorian][:wide]["1"] = "Ιανουάριος"
    @months[:gregorian][:wide]["10"] = "Οκτώβριος"
    ...
    @months[:gregorian][:wide]["4"] = "Απρίλιος"
    @months[:gregorian][:wide]["5"] = "Μάιος"
    @months[:gregorian][:wide]["6"] = "Ιούνιος"
    @months[:gregorian][:wide]["7"] = "Ιούλιος"
    @months[:gregorian][:wide]["8"] = "Αύγουστος"
