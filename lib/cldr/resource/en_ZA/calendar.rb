...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["1"] = "January"
    @months[:gregorian][:wide]["10"] = "October"
    @months[:gregorian][:wide]["11"] = "November"
    @months[:gregorian][:wide]["12"] = "December"
    @months[:gregorian][:wide]["2"] = "February"
    @months[:gregorian][:wide]["3"] = "March"
    @months[:gregorian][:wide]["4"] = "April"
    @months[:gregorian][:wide]["5"] = "May"
    @months[:gregorian][:wide]["6"] = "June"
    @months[:gregorian][:wide]["7"] = "July"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Fri"
    @days[:gregorian][:abbreviated]["mon"] = "Mon"
    @days[:gregorian][:abbreviated]["sat"] = "Sat"
    @days[:gregorian][:abbreviated]["sun"] = "Sun"
    @days[:gregorian][:abbreviated]["thu"] = "Thu"
    @days[:gregorian][:abbreviated]["tue"] = "Tue"
    @days[:gregorian][:abbreviated]["wed"] = "Wed"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Friday"
    @days[:gregorian][:wide]["mon"] = "Monday"
    @days[:gregorian][:wide]["sat"] = "Saturday"
    @days[:gregorian][:wide]["sun"] = "Sunday"
    @days[:gregorian][:wide]["thu"] = "Thursday"
    @days[:gregorian][:wide]["tue"] = "Tuesday"
    @days[:gregorian][:wide]["wed"] = "Wednesday"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "Before Christ"
    @era_names[:gregorian]["1"] = "Anno Domini"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "BC"
    @era_abbrs[:gregorian]["1"] = "AD"
    @era_abbrs[:hebrew] = {}
    ...
    @fields[:gregorian]["dayperiod"] = "AM/PM"
    ...
    @field_relatives = {}
    @field_relatives[:gregorian] = {}
    @field_relatives[:gregorian][:day] = {}
    @field_relatives[:gregorian][:day]["-1"] = "Yesterday"
    @field_relatives[:gregorian][:day]["0"] = "Today"
    @field_relatives[:gregorian][:day]["1"] = "Tomorrow"
  end
