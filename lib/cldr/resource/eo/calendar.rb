...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "GjMtkHmslTDUSnahKzJdugAZ"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    ...
    @months[:gregorian][:abbreviated]["8"] = "aŭg"
    ...
    @months[:gregorian][:wide]["1"] = "januaro"
    @months[:gregorian][:wide]["10"] = "oktobro"
    @months[:gregorian][:wide]["11"] = "novembro"
    @months[:gregorian][:wide]["12"] = "decembro"
    @months[:gregorian][:wide]["2"] = "februaro"
    @months[:gregorian][:wide]["3"] = "marto"
    @months[:gregorian][:wide]["4"] = "aprilo"
    @months[:gregorian][:wide]["5"] = "majo"
    @months[:gregorian][:wide]["6"] = "junio"
    @months[:gregorian][:wide]["7"] = "julio"
    @months[:gregorian][:wide]["8"] = "aŭgusto"
    @months[:gregorian][:wide]["9"] = "septembro"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ve"
    @days[:gregorian][:abbreviated]["mon"] = "lu"
    @days[:gregorian][:abbreviated]["sat"] = "sa"
    @days[:gregorian][:abbreviated]["sun"] = "di"
    @days[:gregorian][:abbreviated]["thu"] = "ĵa"
    @days[:gregorian][:abbreviated]["tue"] = "ma"
    @days[:gregorian][:abbreviated]["wed"] = "me"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "vendredo"
    @days[:gregorian][:wide]["mon"] = "lundo"
    @days[:gregorian][:wide]["sat"] = "sabato"
    @days[:gregorian][:wide]["sun"] = "dimanĉo"
    @days[:gregorian][:wide]["thu"] = "ĵaŭdo"
    @days[:gregorian][:wide]["tue"] = "mardo"
    @days[:gregorian][:wide]["wed"] = "merkredo"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "aK"
    @era_abbrs[:gregorian]["1"] = "pK"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, d'-a de 'MMMM yyyy"
    @dateformats[:gregorian]["long"] = "yyyy-MMMM-dd"
    @dateformats[:gregorian]["medium"] = "yyyy-MMM-dd"
    ...
    @timeformats[:gregorian]["full"] = "H'-a horo kaj 'm z"
