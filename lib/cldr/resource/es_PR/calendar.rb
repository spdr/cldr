...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["1"] = "enero"
    @months[:gregorian][:wide]["10"] = "octubre"
    @months[:gregorian][:wide]["11"] = "noviembre"
    @months[:gregorian][:wide]["12"] = "diciembre"
    @months[:gregorian][:wide]["2"] = "febrero"
    @months[:gregorian][:wide]["3"] = "marzo"
    @months[:gregorian][:wide]["4"] = "abril"
    @months[:gregorian][:wide]["5"] = "mayo"
    @months[:gregorian][:wide]["6"] = "junio"
    @months[:gregorian][:wide]["7"] = "julio"
    @months[:gregorian][:wide]["8"] = "agosto"
    @months[:gregorian][:wide]["9"] = "septiembre"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "vie"
    @days[:gregorian][:abbreviated]["mon"] = "lun"
    @days[:gregorian][:abbreviated]["sat"] = "sáb"
    @days[:gregorian][:abbreviated]["sun"] = "dom"
    @days[:gregorian][:abbreviated]["thu"] = "jue"
    @days[:gregorian][:abbreviated]["tue"] = "mar"
    @days[:gregorian][:abbreviated]["wed"] = "mié"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "viernes"
    @days[:gregorian][:wide]["mon"] = "lunes"
    @days[:gregorian][:wide]["sat"] = "sábado"
    @days[:gregorian][:wide]["sun"] = "domingo"
    @days[:gregorian][:wide]["thu"] = "jueves"
    @days[:gregorian][:wide]["tue"] = "martes"
    @days[:gregorian][:wide]["wed"] = "miércoles"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "a.C."
    @era_abbrs[:gregorian]["1"] = "d.C."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE d' de 'MMMM' de 'yyyy"
    @dateformats[:gregorian]["long"] = "d' de 'MMMM' de 'yyyy"
    @dateformats[:gregorian]["medium"] = "MM/dd/yyyy"
    @dateformats[:gregorian]["short"] = "MM/dd/yy"
    ...
    @timeformats[:gregorian]["full"] = "hh:mm:ss a z"
    @timeformats[:gregorian]["long"] = "hh:mm:ss a z"
    @timeformats[:gregorian]["medium"] = "hh:mm:ss a"
    @timeformats[:gregorian]["short"] = "hh:mm a"
