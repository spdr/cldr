...
# CLDR version: 1.3
#
# Original file name: common/main/et_EE.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "jaan"
    @months[:gregorian][:abbreviated]["10"] = "okt"
    @months[:gregorian][:abbreviated]["11"] = "nov"
    @months[:gregorian][:abbreviated]["12"] = "dets"
    @months[:gregorian][:abbreviated]["2"] = "veebr"
    @months[:gregorian][:abbreviated]["3"] = "märts"
    @months[:gregorian][:abbreviated]["4"] = "apr"
    @months[:gregorian][:abbreviated]["5"] = "mai"
    @months[:gregorian][:abbreviated]["6"] = "juuni"
    @months[:gregorian][:abbreviated]["7"] = "juuli"
    ...
    @months[:gregorian][:wide]["1"] = "jaanuar"
    @months[:gregorian][:wide]["10"] = "oktoober"
    @months[:gregorian][:wide]["11"] = "november"
    @months[:gregorian][:wide]["12"] = "detsember"
    @months[:gregorian][:wide]["2"] = "veebruar"
    @months[:gregorian][:wide]["3"] = "märts"
    @months[:gregorian][:wide]["4"] = "aprill"
    @months[:gregorian][:wide]["5"] = "mai"
    @months[:gregorian][:wide]["6"] = "juuni"
    @months[:gregorian][:wide]["7"] = "juuli"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "R"
    @days[:gregorian][:abbreviated]["mon"] = "E"
    @days[:gregorian][:abbreviated]["sat"] = "L"
    @days[:gregorian][:abbreviated]["sun"] = "P"
    @days[:gregorian][:abbreviated]["thu"] = "N"
    @days[:gregorian][:abbreviated]["tue"] = "T"
    @days[:gregorian][:abbreviated]["wed"] = "K"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "reede"
    @days[:gregorian][:wide]["mon"] = "esmaspäev"
    @days[:gregorian][:wide]["sat"] = "laupäev"
    @days[:gregorian][:wide]["sun"] = "pühapäev"
    @days[:gregorian][:wide]["thu"] = "neljapäev"
    @days[:gregorian][:wide]["tue"] = "teisipäev"
    @days[:gregorian][:wide]["wed"] = "kolmapäev"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "enne meie aega"
    @era_names[:gregorian]["1"] = "meie aja järgi"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "e.m.a."
    @era_abbrs[:gregorian]["1"] = "m.a.j."
    @era_abbrs[:hebrew] = {}
