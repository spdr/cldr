...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "urt"
    @months[:gregorian][:abbreviated]["10"] = "urr"
    @months[:gregorian][:abbreviated]["11"] = "aza"
    @months[:gregorian][:abbreviated]["12"] = "abe"
    @months[:gregorian][:abbreviated]["2"] = "ots"
    @months[:gregorian][:abbreviated]["3"] = "mar"
    @months[:gregorian][:abbreviated]["4"] = "api"
    @months[:gregorian][:abbreviated]["5"] = "mai"
    @months[:gregorian][:abbreviated]["6"] = "eka"
    @months[:gregorian][:abbreviated]["7"] = "uzt"
    @months[:gregorian][:abbreviated]["8"] = "abu"
    @months[:gregorian][:abbreviated]["9"] = "ira"
    ...
    @months[:gregorian][:wide]["1"] = "urtarrila"
    @months[:gregorian][:wide]["10"] = "urria"
    @months[:gregorian][:wide]["11"] = "azaroa"
    @months[:gregorian][:wide]["12"] = "abendua"
    @months[:gregorian][:wide]["2"] = "otsaila"
    @months[:gregorian][:wide]["3"] = "martxoa"
    @months[:gregorian][:wide]["4"] = "apirila"
    @months[:gregorian][:wide]["5"] = "maiatza"
    @months[:gregorian][:wide]["6"] = "ekaina"
    @months[:gregorian][:wide]["7"] = "uztaila"
    @months[:gregorian][:wide]["8"] = "abuztua"
    @months[:gregorian][:wide]["9"] = "iraila"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "or"
    @days[:gregorian][:abbreviated]["mon"] = "al"
    @days[:gregorian][:abbreviated]["sat"] = "lr"
    @days[:gregorian][:abbreviated]["sun"] = "ig"
    @days[:gregorian][:abbreviated]["thu"] = "og"
    @days[:gregorian][:abbreviated]["tue"] = "as"
    @days[:gregorian][:abbreviated]["wed"] = "az"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ostirala"
    @days[:gregorian][:wide]["mon"] = "astelehena"
    @days[:gregorian][:wide]["sat"] = "larunbata"
    @days[:gregorian][:wide]["sun"] = "igandea"
    @days[:gregorian][:wide]["thu"] = "osteguna"
    @days[:gregorian][:wide]["tue"] = "asteartea"
    @days[:gregorian][:wide]["wed"] = "asteazkena"
    @dayformat_defaults = {}
