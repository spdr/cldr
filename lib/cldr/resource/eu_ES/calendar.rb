...
# CLDR version: 1.3
#
# Original file name: common/main/eu_ES.xml
...
#
  ...
  def init_data
    ...
    @dateformats[:gregorian]["full"] = "EEEE, yyyy'eko' MMMM'ren' dd'a'"
    @dateformats[:gregorian]["long"] = "EEE, yyyy'eko' MMM'ren' dd'a'"
    @dateformats[:gregorian]["medium"] = "yy'-'MMM'-'dd"
