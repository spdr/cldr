...
# CLDR version: 1.3
#
# Original file name: common/main/fa_AF.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "جنوری"
    @months[:gregorian][:abbreviated]["10"] = "اکتوبر"
    @months[:gregorian][:abbreviated]["11"] = "نومبر"
    @months[:gregorian][:abbreviated]["12"] = "دسمبر"
    @months[:gregorian][:abbreviated]["2"] = "فبروری"
    @months[:gregorian][:abbreviated]["3"] = "مارچ"
    @months[:gregorian][:abbreviated]["4"] = "اپریل"
    @months[:gregorian][:abbreviated]["5"] = "می"
    @months[:gregorian][:abbreviated]["6"] = "جون"
    @months[:gregorian][:abbreviated]["7"] = "جولای"
    @months[:gregorian][:abbreviated]["8"] = "اگست"
    @months[:gregorian][:abbreviated]["9"] = "سپتمبر"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ج"
    ...
    @months[:gregorian][:narrow]["4"] = "ا"
    @months[:gregorian][:narrow]["5"] = "م"
    @months[:gregorian][:narrow]["6"] = "ج"
    @months[:gregorian][:narrow]["7"] = "ج"
    @months[:gregorian][:narrow]["8"] = "ا"
    @months[:gregorian][:narrow]["9"] = "س"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "جنوری"
    @months[:gregorian][:wide]["10"] = "اکتوبر"
    @months[:gregorian][:wide]["11"] = "نومبر"
    @months[:gregorian][:wide]["12"] = "دسمبر"
    @months[:gregorian][:wide]["2"] = "فبروری"
    @months[:gregorian][:wide]["3"] = "مارچ"
    @months[:gregorian][:wide]["4"] = "اپریل"
    @months[:gregorian][:wide]["5"] = "می"
    @months[:gregorian][:wide]["6"] = "جون"
    @months[:gregorian][:wide]["7"] = "جولای"
    @months[:gregorian][:wide]["8"] = "اگست"
    @months[:gregorian][:wide]["9"] = "سپتمبر"
    @months[:hebrew] = {}
    ...
    @months[:persian][:abbreviated]["1"] = "حمل"
    @months[:persian][:abbreviated]["10"] = "جدی"
    @months[:persian][:abbreviated]["11"] = "دلو"
    @months[:persian][:abbreviated]["12"] = "حوت"
    @months[:persian][:abbreviated]["2"] = "ثور"
    @months[:persian][:abbreviated]["3"] = "جوزا"
    @months[:persian][:abbreviated]["4"] = "سرطان"
    @months[:persian][:abbreviated]["5"] = "اسد"
    @months[:persian][:abbreviated]["6"] = "سنبله"
    @months[:persian][:abbreviated]["7"] = "میزان"
    @months[:persian][:abbreviated]["8"] = "عقرب"
    @months[:persian][:abbreviated]["9"] = "قوس"
    @months[:persian][:narrow] = {}
    @months[:persian][:narrow]["1"] = "ح"
    @months[:persian][:narrow]["10"] = "ج"
    @months[:persian][:narrow]["11"] = "د"
    @months[:persian][:narrow]["12"] = "ح"
    @months[:persian][:narrow]["2"] = "ث"
    @months[:persian][:narrow]["3"] = "ج"
    @months[:persian][:narrow]["4"] = "س"
    @months[:persian][:narrow]["5"] = "ا"
    @months[:persian][:narrow]["6"] = "س"
    @months[:persian][:narrow]["7"] = "م"
    @months[:persian][:narrow]["8"] = "ع"
    @months[:persian][:narrow]["9"] = "ق"
    @months[:persian][:wide] = {}
    @months[:persian][:wide]["1"] = "حمل"
    @months[:persian][:wide]["10"] = "جدی"
    @months[:persian][:wide]["11"] = "دلو"
    @months[:persian][:wide]["12"] = "حوت"
    @months[:persian][:wide]["2"] = "ثور"
    @months[:persian][:wide]["3"] = "جوزا"
    @months[:persian][:wide]["4"] = "سرطان"
    @months[:persian][:wide]["5"] = "اسد"
    @months[:persian][:wide]["6"] = "سنبله"
    @months[:persian][:wide]["7"] = "میزان"
    @months[:persian][:wide]["8"] = "عقرب"
    @months[:persian][:wide]["9"] = "قوس"
    ...
    @week_firstdays = {}
    @week_firstdays["gregorian"] = "sat"
    @week_firstdays["islamic"] = "sat"
    @week_firstdays["persian"] = "sat"
    @weekend_starts = {}
