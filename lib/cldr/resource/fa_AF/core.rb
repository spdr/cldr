...
#
  ...
  def init_data
    ...
    @territories["BA"] = "بوسنیا و هرزه‌گوینا"
    ...
    @territories["ER"] = "اریتریا"
    @territories["ES"] = "هسپانیه"
    @territories["ET"] = "ایتوپیا"
    @territories["FI"] = "فنلند"
    @territories["FJ"] = "فیجی"
    @territories["FK"] = "جزایر فالکلند"
    @territories["FM"] = "میکرونزیا"
    ...
    @territories["KP"] = "کوریای شمالی"
    @territories["KR"] = "کوریای جنوبی"
    @territories["KW"] = "کویت"
    ...
    @territories["NG"] = "نیجریا"
    @territories["NI"] = "نیکاراگوا"
    ...
    @territories["RO"] = "رومانیا"
    @territories["RU"] = "روسیه"
    @territories["RW"] = "روآندا"
    @territories["SA"] = "عربستان سعودی"
    @territories["SB"] = "جزایر سلومون"
    @territories["SC"] = "سیشل"
    @territories["SD"] = "سودان"
    @territories["SE"] = "سویدن"
    @territories["SG"] = "سینگاپور"
    @territories["SH"] = "سنت هلن"
    @territories["SI"] = "سلونیا"
    @territories["SJ"] = "اسوالبارد و جان ماین"
    @territories["SK"] = "سلواکیا"
    ...
    @territories["UY"] = "یوروگوای"
    @territories["UZ"] = "ازبکستان"
    @territories["VA"] = "واتیکان"
    @territories["VC"] = "سنت وینسنت و گرینادین"
    @territories["VE"] = "ونزویلا"
    ...
    @character_exemplar_characters["auxiliary"] = "[\u064a\u067c\u0681\u0685\u0689\u0693\u0696\u069a\u06ab\u06bc\u06cd\u06d0\u0656\u0670]"
