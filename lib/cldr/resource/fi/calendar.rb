...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "tammi"
    @months[:gregorian][:abbreviated]["10"] = "loka"
    @months[:gregorian][:abbreviated]["11"] = "marras"
    @months[:gregorian][:abbreviated]["12"] = "joulu"
    @months[:gregorian][:abbreviated]["2"] = "helmi"
    @months[:gregorian][:abbreviated]["3"] = "maalis"
    @months[:gregorian][:abbreviated]["4"] = "huhti"
    @months[:gregorian][:abbreviated]["5"] = "touko"
    @months[:gregorian][:abbreviated]["6"] = "kesä"
    @months[:gregorian][:abbreviated]["7"] = "heinä"
    @months[:gregorian][:abbreviated]["8"] = "elo"
    @months[:gregorian][:abbreviated]["9"] = "syys"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "T"
    @months[:gregorian][:narrow]["10"] = "L"
    @months[:gregorian][:narrow]["11"] = "M"
    @months[:gregorian][:narrow]["12"] = "J"
    @months[:gregorian][:narrow]["2"] = "H"
    @months[:gregorian][:narrow]["3"] = "M"
    @months[:gregorian][:narrow]["4"] = "H"
    @months[:gregorian][:narrow]["5"] = "T"
    @months[:gregorian][:narrow]["6"] = "K"
    @months[:gregorian][:narrow]["7"] = "H"
    @months[:gregorian][:narrow]["8"] = "E"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "tammikuu"
    @months[:gregorian][:wide]["10"] = "lokakuu"
    @months[:gregorian][:wide]["11"] = "marraskuu"
    @months[:gregorian][:wide]["12"] = "joulukuu"
    @months[:gregorian][:wide]["2"] = "helmikuu"
    @months[:gregorian][:wide]["3"] = "maaliskuu"
    @months[:gregorian][:wide]["4"] = "huhtikuu"
    @months[:gregorian][:wide]["5"] = "toukokuu"
    @months[:gregorian][:wide]["6"] = "kesäkuu"
    @months[:gregorian][:wide]["7"] = "heinäkuu"
    @months[:gregorian][:wide]["8"] = "elokuu"
    @months[:gregorian][:wide]["9"] = "syyskuu"
    @months[:hebrew] = {}
    @months[:hebrew][:abbreviated] = {}
    @months[:hebrew][:abbreviated]["1"] = "tišrì"
    @months[:hebrew][:abbreviated]["10"] = "siván"
    @months[:hebrew][:abbreviated]["11"] = "tammúz"
    @months[:hebrew][:abbreviated]["12"] = "ab"
    @months[:hebrew][:abbreviated]["13"] = "elúl"
    @months[:hebrew][:abbreviated]["2"] = "hešván"
    @months[:hebrew][:abbreviated]["3"] = "kislév"
    @months[:hebrew][:abbreviated]["4"] = "tevét"
    @months[:hebrew][:abbreviated]["5"] = "ševát"
    @months[:hebrew][:abbreviated]["6"] = "adár"
    @months[:hebrew][:abbreviated]["7"] = "adár II"
    @months[:hebrew][:abbreviated]["8"] = "nisán"
    @months[:hebrew][:abbreviated]["9"] = "ijjár"
    @months[:hebrew][:wide] = {}
    @months[:hebrew][:wide]["1"] = "tišrìkuu"
    @months[:hebrew][:wide]["10"] = "sivánkuu"
    @months[:hebrew][:wide]["11"] = "tammúzkuu"
    @months[:hebrew][:wide]["12"] = "abkuu"
    @months[:hebrew][:wide]["13"] = "elúlkuu"
    @months[:hebrew][:wide]["2"] = "hešvánkuu"
    @months[:hebrew][:wide]["3"] = "kislévkuu"
    @months[:hebrew][:wide]["4"] = "tevétkuu"
    @months[:hebrew][:wide]["5"] = "ševátkuu"
    @months[:hebrew][:wide]["6"] = "adárkuu"
    @months[:hebrew][:wide]["7"] = "adárkuu II"
    @months[:hebrew][:wide]["8"] = "nisánkuu"
    @months[:hebrew][:wide]["9"] = "ijjárkuu"
    @months[:islamic_civil] = {}
    @months[:islamic_civil][:abbreviated] = {}
    @months[:islamic_civil][:abbreviated]["1"] = "muhárram"
    @months[:islamic_civil][:abbreviated]["10"] = "šawwál"
    @months[:islamic_civil][:abbreviated]["11"] = "dhu-l-qáʻda"
    @months[:islamic_civil][:abbreviated]["12"] = "dhu-l-hiddža"
    @months[:islamic_civil][:abbreviated]["2"] = "sáfar"
    @months[:islamic_civil][:abbreviated]["3"] = "rabíʻ al-áwwal"
    @months[:islamic_civil][:abbreviated]["4"] = "rabíʻ al-ákhir"
    @months[:islamic_civil][:abbreviated]["5"] = "džumada-l-úla"
    @months[:islamic_civil][:abbreviated]["6"] = "džumada-l-ákhira"
    @months[:islamic_civil][:abbreviated]["7"] = "radžab"
    @months[:islamic_civil][:abbreviated]["8"] = "šaʻbán"
    @months[:islamic_civil][:abbreviated]["9"] = "ramadán"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "muhárram"
    @months[:islamic_civil][:wide]["10"] = "šawwál"
    @months[:islamic_civil][:wide]["11"] = "dhu-l-qáʻda"
    @months[:islamic_civil][:wide]["12"] = "dhu-l-hiddža"
    @months[:islamic_civil][:wide]["2"] = "sáfar"
    @months[:islamic_civil][:wide]["3"] = "rabíʻ al-áwwal"
    @months[:islamic_civil][:wide]["4"] = "rabíʻ al-ákhir"
    @months[:islamic_civil][:wide]["5"] = "džumada-l-úla"
    @months[:islamic_civil][:wide]["6"] = "džumada-l-ákhira"
    @months[:islamic_civil][:wide]["7"] = "radžab"
    @months[:islamic_civil][:wide]["8"] = "šaʻbán"
    @months[:islamic_civil][:wide]["9"] = "ramadán"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "muhárram"
    @months[:islamic][:abbreviated]["10"] = "šawwál"
    @months[:islamic][:abbreviated]["11"] = "dhu-l-qáʻda"
    @months[:islamic][:abbreviated]["12"] = "dhu-l-hiddža"
    @months[:islamic][:abbreviated]["2"] = "sáfar"
    @months[:islamic][:abbreviated]["3"] = "rabíʻ al-áwwal"
    @months[:islamic][:abbreviated]["4"] = "rabíʻ al-ákhir"
    @months[:islamic][:abbreviated]["5"] = "džumada-l-úla"
    @months[:islamic][:abbreviated]["6"] = "džumada-l-ákhira"
    @months[:islamic][:abbreviated]["7"] = "radžab"
    @months[:islamic][:abbreviated]["8"] = "šaʻbán"
    @months[:islamic][:abbreviated]["9"] = "ramadán"
    @months[:islamic][:wide] = {}
    @months[:islamic][:wide]["1"] = "muhárram"
    @months[:islamic][:wide]["10"] = "šawwál"
    @months[:islamic][:wide]["11"] = "dhu-l-qáʻda"
    @months[:islamic][:wide]["12"] = "dhu-l-hiddža"
    @months[:islamic][:wide]["2"] = "sáfar"
    @months[:islamic][:wide]["3"] = "rabíʻ al-áwwal"
    @months[:islamic][:wide]["4"] = "rabíʻ al-ákhir"
    @months[:islamic][:wide]["5"] = "džumada-l-úla"
    @months[:islamic][:wide]["6"] = "džumada-l-ákhira"
    @months[:islamic][:wide]["7"] = "radžab"
    @months[:islamic][:wide]["8"] = "šaʻbán"
    @months[:islamic][:wide]["9"] = "ramadán"
    @months[:persian] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "pe"
    @days[:gregorian][:abbreviated]["mon"] = "ma"
    @days[:gregorian][:abbreviated]["sat"] = "la"
    @days[:gregorian][:abbreviated]["sun"] = "su"
    @days[:gregorian][:abbreviated]["thu"] = "to"
    @days[:gregorian][:abbreviated]["tue"] = "ti"
    @days[:gregorian][:abbreviated]["wed"] = "ke"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "P"
    @days[:gregorian][:narrow]["mon"] = "M"
    @days[:gregorian][:narrow]["sat"] = "L"
    @days[:gregorian][:narrow]["sun"] = "S"
    @days[:gregorian][:narrow]["thu"] = "T"
    @days[:gregorian][:narrow]["tue"] = "T"
    @days[:gregorian][:narrow]["wed"] = "K"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "perjantai"
    @days[:gregorian][:wide]["mon"] = "maanantai"
    @days[:gregorian][:wide]["sat"] = "lauantai"
    @days[:gregorian][:wide]["sun"] = "sunnuntai"
    @days[:gregorian][:wide]["thu"] = "torstai"
    @days[:gregorian][:wide]["tue"] = "tiistai"
    @days[:gregorian][:wide]["wed"] = "keskiviikko"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ennen Kristusta"
    @era_names[:gregorian]["1"] = "jälkeen Kristuksen"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "eKr."
    @era_abbrs[:gregorian]["1"] = "jKr."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE'na 'd. MMMM'ta 'yyyy"
    @dateformats[:gregorian]["long"] = "d. MMMM'ta 'yyyy"
    @dateformats[:gregorian]["medium"] = "d.M.yyyy"
    @dateformats[:gregorian]["short"] = "d.M.yyyy"
    ...
    @timeformats[:gregorian]["full"] = "H.mm.ss z"
    @timeformats[:gregorian]["long"] = "'klo 'H.mm.ss"
