...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "GaMjkHmsSEDFwWxhKzAeugXZ"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    @months[:gregorian][:abbreviated] = {}
    @months[:gregorian][:abbreviated]["1"] = "janv."
    @months[:gregorian][:abbreviated]["10"] = "oct."
    @months[:gregorian][:abbreviated]["11"] = "nov."
    @months[:gregorian][:abbreviated]["12"] = "déc."
    @months[:gregorian][:abbreviated]["2"] = "févr."
    @months[:gregorian][:abbreviated]["3"] = "mars"
    @months[:gregorian][:abbreviated]["4"] = "avr."
    @months[:gregorian][:abbreviated]["5"] = "mai"
    @months[:gregorian][:abbreviated]["6"] = "juin"
    @months[:gregorian][:abbreviated]["7"] = "juil."
    @months[:gregorian][:abbreviated]["8"] = "août"
    @months[:gregorian][:abbreviated]["9"] = "sept."
    ...
    @months[:gregorian][:wide]["1"] = "janvier"
    @months[:gregorian][:wide]["10"] = "octobre"
    @months[:gregorian][:wide]["11"] = "novembre"
    @months[:gregorian][:wide]["12"] = "décembre"
    @months[:gregorian][:wide]["2"] = "février"
    @months[:gregorian][:wide]["3"] = "mars"
    @months[:gregorian][:wide]["4"] = "avril"
    @months[:gregorian][:wide]["5"] = "mai"
    @months[:gregorian][:wide]["6"] = "juin"
    @months[:gregorian][:wide]["7"] = "juillet"
    @months[:gregorian][:wide]["8"] = "août"
    @months[:gregorian][:wide]["9"] = "septembre"
    @months[:hebrew] = {}
    @months[:hebrew][:abbreviated] = {}
    @months[:hebrew][:abbreviated]["1"] = "Tisseri"
    @months[:hebrew][:abbreviated]["10"] = "Sivan"
    @months[:hebrew][:abbreviated]["11"] = "Tamouz"
    @months[:hebrew][:abbreviated]["12"] = "Ab"
    @months[:hebrew][:abbreviated]["13"] = "Elloul"
    @months[:hebrew][:abbreviated]["2"] = "Hesvan"
    @months[:hebrew][:abbreviated]["3"] = "Kislev"
    @months[:hebrew][:abbreviated]["4"] = "Tébeth"
    @months[:hebrew][:abbreviated]["5"] = "Schébat"
    @months[:hebrew][:abbreviated]["6"] = "Adar"
    @months[:hebrew][:abbreviated]["7"] = "Adar II"
    @months[:hebrew][:abbreviated]["8"] = "Nissan"
    @months[:hebrew][:abbreviated]["9"] = "Iyar"
    @months[:hebrew][:wide] = {}
    @months[:hebrew][:wide]["1"] = "Tisseri"
    @months[:hebrew][:wide]["10"] = "Sivan"
    @months[:hebrew][:wide]["11"] = "Tamouz"
    @months[:hebrew][:wide]["12"] = "Ab"
    @months[:hebrew][:wide]["13"] = "Elloul"
    @months[:hebrew][:wide]["2"] = "Hesvan"
    @months[:hebrew][:wide]["3"] = "Kislev"
    @months[:hebrew][:wide]["4"] = "Tébeth"
    @months[:hebrew][:wide]["5"] = "Schébat"
    @months[:hebrew][:wide]["6"] = "Adar"
    @months[:hebrew][:wide]["7"] = "Adar II"
    @months[:hebrew][:wide]["8"] = "Nissan"
    @months[:hebrew][:wide]["9"] = "Iyar"
    @months[:islamic_civil] = {}
    @months[:islamic_civil][:abbreviated] = {}
    @months[:islamic_civil][:abbreviated]["1"] = "Mouharram"
    @months[:islamic_civil][:abbreviated]["10"] = "Chaououal"
    @months[:islamic_civil][:abbreviated]["11"] = "Dou-l-Qaʻda"
    @months[:islamic_civil][:abbreviated]["12"] = "Dou-l-Hidjja"
    @months[:islamic_civil][:abbreviated]["2"] = "Safar"
    @months[:islamic_civil][:abbreviated]["3"] = "Rabiʻ-oul-Aououal"
    @months[:islamic_civil][:abbreviated]["4"] = "Rabiʻ-out-Tani"
    @months[:islamic_civil][:abbreviated]["5"] = "Djoumada-l-Oula"
    @months[:islamic_civil][:abbreviated]["6"] = "Djoumada-t-Tania"
    @months[:islamic_civil][:abbreviated]["7"] = "Radjab"
    @months[:islamic_civil][:abbreviated]["8"] = "Chaʻban"
    @months[:islamic_civil][:abbreviated]["9"] = "Ramadan"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "Mouharram"
    @months[:islamic_civil][:wide]["10"] = "Chaououal"
    @months[:islamic_civil][:wide]["11"] = "Dou-l-Qaʻda"
    @months[:islamic_civil][:wide]["12"] = "Dou-l-Hidjja"
    @months[:islamic_civil][:wide]["2"] = "Safar"
    @months[:islamic_civil][:wide]["3"] = "Rabiʻ-oul-Aououal"
    @months[:islamic_civil][:wide]["4"] = "Rabiʻ-out-Tani"
    @months[:islamic_civil][:wide]["5"] = "Djoumada-l-Oula"
    @months[:islamic_civil][:wide]["6"] = "Djoumada-t-Tania"
    @months[:islamic_civil][:wide]["7"] = "Radjab"
    @months[:islamic_civil][:wide]["8"] = "Chaʻban"
    @months[:islamic_civil][:wide]["9"] = "Ramadan"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "Mouharram"
    @months[:islamic][:abbreviated]["10"] = "Chaououal"
    @months[:islamic][:abbreviated]["11"] = "Dou-l-Qaʻda"
    @months[:islamic][:abbreviated]["12"] = "Dou-l-Hidjja"
    @months[:islamic][:abbreviated]["2"] = "Safar"
    @months[:islamic][:abbreviated]["3"] = "Rabiʻ-oul-Aououal"
    @months[:islamic][:abbreviated]["4"] = "Rabiʻ-out-Tani"
    @months[:islamic][:abbreviated]["5"] = "Djoumada-l-Oula"
    @months[:islamic][:abbreviated]["6"] = "Djoumada-t-Tania"
    @months[:islamic][:abbreviated]["7"] = "Radjab"
    @months[:islamic][:abbreviated]["8"] = "Chaʻban"
    @months[:islamic][:abbreviated]["9"] = "Ramadan"
    @months[:islamic][:wide] = {}
    @months[:islamic][:wide]["1"] = "Mouharram"
    @months[:islamic][:wide]["10"] = "Chaououal"
    @months[:islamic][:wide]["11"] = "Dou-l-Qaʻda"
    @months[:islamic][:wide]["12"] = "Dou-l-Hidjja"
    @months[:islamic][:wide]["2"] = "Safar"
    @months[:islamic][:wide]["3"] = "Rabiʻ-oul-Aououal"
    @months[:islamic][:wide]["4"] = "Rabiʻ-out-Tani"
    @months[:islamic][:wide]["5"] = "Djoumada-l-Oula"
    @months[:islamic][:wide]["6"] = "Djoumada-t-Tania"
    @months[:islamic][:wide]["7"] = "Radjab"
    @months[:islamic][:wide]["8"] = "Chaʻban"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ven."
    @days[:gregorian][:abbreviated]["mon"] = "lun."
    @days[:gregorian][:abbreviated]["sat"] = "sam."
    @days[:gregorian][:abbreviated]["sun"] = "dim."
    @days[:gregorian][:abbreviated]["thu"] = "jeu."
    @days[:gregorian][:abbreviated]["tue"] = "mar."
    @days[:gregorian][:abbreviated]["wed"] = "mer."
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "V"
    @days[:gregorian][:narrow]["mon"] = "L"
    @days[:gregorian][:narrow]["sat"] = "S"
    @days[:gregorian][:narrow]["sun"] = "D"
    @days[:gregorian][:narrow]["thu"] = "J"
    @days[:gregorian][:narrow]["tue"] = "M"
    @days[:gregorian][:narrow]["wed"] = "M"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "vendredi"
    @days[:gregorian][:wide]["mon"] = "lundi"
    @days[:gregorian][:wide]["sat"] = "samedi"
    @days[:gregorian][:wide]["sun"] = "dimanche"
    @days[:gregorian][:wide]["thu"] = "jeudi"
    @days[:gregorian][:wide]["tue"] = "mardi"
    @days[:gregorian][:wide]["wed"] = "mercredi"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "av. J.-C."
    @era_names[:gregorian]["1"] = "ap. J.-C."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "av. J.-C."
    @era_abbrs[:gregorian]["1"] = "apr. J.-C."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["medium"] = "yy-MM-dd"
    ...
    @timeformats[:gregorian]["full"] = "HH' h 'mm' min 'ss' s 'z"
