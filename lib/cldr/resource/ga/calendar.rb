...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "RbMLkUnsSElFtTauKcBeyrAC"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    @months[:gregorian][:abbreviated] = {}
    @months[:gregorian][:abbreviated]["1"] = "Ean"
    @months[:gregorian][:abbreviated]["10"] = "DFómh"
    @months[:gregorian][:abbreviated]["11"] = "Samh"
    @months[:gregorian][:abbreviated]["12"] = "Noll"
    @months[:gregorian][:abbreviated]["2"] = "Feabh"
    @months[:gregorian][:abbreviated]["3"] = "Márta"
    @months[:gregorian][:abbreviated]["4"] = "Aib"
    @months[:gregorian][:abbreviated]["5"] = "Beal"
    @months[:gregorian][:abbreviated]["6"] = "Meith"
    @months[:gregorian][:abbreviated]["7"] = "Iúil"
    @months[:gregorian][:abbreviated]["8"] = "Lún"
    @months[:gregorian][:abbreviated]["9"] = "MFómh"
    ...
    @months[:gregorian][:wide]["1"] = "Eanáir"
    @months[:gregorian][:wide]["10"] = "Deireadh Fómhair"
    @months[:gregorian][:wide]["11"] = "Samhain"
    @months[:gregorian][:wide]["12"] = "Nollaig"
    @months[:gregorian][:wide]["2"] = "Feabhra"
    @months[:gregorian][:wide]["3"] = "Márta"
    @months[:gregorian][:wide]["4"] = "Aibreán"
    @months[:gregorian][:wide]["5"] = "Bealtaine"
    @months[:gregorian][:wide]["6"] = "Meitheamh"
    @months[:gregorian][:wide]["7"] = "Iúil"
    @months[:gregorian][:wide]["8"] = "Lúnasa"
    @months[:gregorian][:wide]["9"] = "Meán Fómhair"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Aoine"
    @days[:gregorian][:abbreviated]["mon"] = "Luan"
    @days[:gregorian][:abbreviated]["sat"] = "Sath"
    @days[:gregorian][:abbreviated]["sun"] = "Domh"
    @days[:gregorian][:abbreviated]["thu"] = "Déar"
    @days[:gregorian][:abbreviated]["tue"] = "Máirt"
    @days[:gregorian][:abbreviated]["wed"] = "Céad"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Dé hAoine"
    @days[:gregorian][:wide]["mon"] = "Dé Luain"
    @days[:gregorian][:wide]["sat"] = "Dé Sathairn"
    @days[:gregorian][:wide]["sun"] = "Dé Domhnaigh"
    @days[:gregorian][:wide]["thu"] = "Déardaoin"
    @days[:gregorian][:wide]["tue"] = "Dé Máirt"
    @days[:gregorian][:wide]["wed"] = "Dé Céadaoin"
    @dayformat_defaults = {}
