...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ጠሐረ"
    @months[:gregorian][:abbreviated]["10"] = "ጠቀመ"
    @months[:gregorian][:abbreviated]["11"] = "ኀደረ"
    @months[:gregorian][:abbreviated]["12"] = "ኀሠሠ"
    @months[:gregorian][:abbreviated]["2"] = "ከተተ"
    @months[:gregorian][:abbreviated]["3"] = "መገበ"
    @months[:gregorian][:abbreviated]["4"] = "አኀዘ"
    @months[:gregorian][:abbreviated]["5"] = "ግንባ"
    @months[:gregorian][:abbreviated]["6"] = "ሠንየ"
    @months[:gregorian][:abbreviated]["7"] = "ሐመለ"
    @months[:gregorian][:abbreviated]["8"] = "ነሐሰ"
    @months[:gregorian][:abbreviated]["9"] = "ከረመ"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ጠ"
    @months[:gregorian][:narrow]["10"] = "ጠ"
    @months[:gregorian][:narrow]["11"] = "ኀ"
    @months[:gregorian][:narrow]["12"] = "ኀ"
    @months[:gregorian][:narrow]["2"] = "ከ"
    @months[:gregorian][:narrow]["3"] = "መ"
    @months[:gregorian][:narrow]["4"] = "አ"
    @months[:gregorian][:narrow]["5"] = "ግ"
    @months[:gregorian][:narrow]["6"] = "ሠ"
    @months[:gregorian][:narrow]["7"] = "ሐ"
    @months[:gregorian][:narrow]["8"] = "ነ"
    @months[:gregorian][:narrow]["9"] = "ከ"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "ጠሐረ"
    @months[:gregorian][:wide]["10"] = "ጠቀመ"
    @months[:gregorian][:wide]["11"] = "ኀደረ"
    @months[:gregorian][:wide]["12"] = "ኀሠሠ"
    @months[:gregorian][:wide]["2"] = "ከተተ"
    @months[:gregorian][:wide]["3"] = "መገበ"
    @months[:gregorian][:wide]["4"] = "አኀዘ"
    @months[:gregorian][:wide]["5"] = "ግንባት"
    @months[:gregorian][:wide]["6"] = "ሠንየ"
    @months[:gregorian][:wide]["7"] = "ሐመለ"
    @months[:gregorian][:wide]["8"] = "ነሐሰ"
    @months[:gregorian][:wide]["9"] = "ከረመ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ዓርበ"
    @days[:gregorian][:abbreviated]["mon"] = "ሰኑይ"
    @days[:gregorian][:abbreviated]["sat"] = "ቀዳሚ"
    @days[:gregorian][:abbreviated]["sun"] = "እኁድ"
    @days[:gregorian][:abbreviated]["thu"] = "ሐሙስ"
    @days[:gregorian][:abbreviated]["tue"] = "ሠሉስ"
    @days[:gregorian][:abbreviated]["wed"] = "ራብዕ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ዓ"
    @days[:gregorian][:narrow]["mon"] = "ሰ"
    @days[:gregorian][:narrow]["sat"] = "ቀ"
    @days[:gregorian][:narrow]["sun"] = "እ"
    @days[:gregorian][:narrow]["thu"] = "ሐ"
    @days[:gregorian][:narrow]["tue"] = "ሠ"
    @days[:gregorian][:narrow]["wed"] = "ራ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ዓርበ"
    @days[:gregorian][:wide]["mon"] = "ሰኑይ"
    @days[:gregorian][:wide]["sat"] = "ቀዳሚት"
    @days[:gregorian][:wide]["sun"] = "እኁድ"
    @days[:gregorian][:wide]["thu"] = "ሐሙስ"
    @days[:gregorian][:wide]["tue"] = "ሠሉስ"
    @days[:gregorian][:wide]["wed"] = "ራብዕ"
    @dayformat_defaults = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE፥ dd MMMM መዓልት yyyy G"
