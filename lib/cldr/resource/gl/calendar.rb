...
# CLDR version: 1.3
#
# Original file name: common/main/gl.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Xan"
    ...
    @months[:gregorian][:abbreviated]["6"] = "Xuñ"
    @months[:gregorian][:abbreviated]["7"] = "Xul"
    ...
    @days[:gregorian][:abbreviated]["thu"] = "Xov"
    @days[:gregorian][:abbreviated]["tue"] = "Mar"
    @days[:gregorian][:abbreviated]["wed"] = "Mér"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Venres"
    @days[:gregorian][:wide]["mon"] = "Luns"
    @days[:gregorian][:wide]["sat"] = "Sábado"
    @days[:gregorian][:wide]["sun"] = "Domingo"
    @days[:gregorian][:wide]["thu"] = "Xoves"
    @days[:gregorian][:wide]["tue"] = "Martes"
    @days[:gregorian][:wide]["wed"] = "Mércores"
    @dayformat_defaults = {}
