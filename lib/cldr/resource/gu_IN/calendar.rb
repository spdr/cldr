...
# CLDR version: 1.3
#
# Original file name: common/main/gu_IN.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "જાન્યુ"
    @months[:gregorian][:abbreviated]["10"] = "ઑક્ટો"
    @months[:gregorian][:abbreviated]["11"] = "નવે"
    @months[:gregorian][:abbreviated]["12"] = "ડિસે"
    @months[:gregorian][:abbreviated]["2"] = "ફેબ્રુ"
    @months[:gregorian][:abbreviated]["3"] = "માર્ચ"
    @months[:gregorian][:abbreviated]["4"] = "એપ્રિલ"
    @months[:gregorian][:abbreviated]["5"] = "મે"
    @months[:gregorian][:abbreviated]["6"] = "જૂન"
    @months[:gregorian][:abbreviated]["7"] = "જુલાઈ"
    @months[:gregorian][:abbreviated]["8"] = "ઑગસ્ટ"
    @months[:gregorian][:abbreviated]["9"] = "સપ્ટે"
    ...
    @months[:gregorian][:wide]["1"] = "જાન્યુઆરી"
    @months[:gregorian][:wide]["10"] = "ઑક્ટ્બર"
    @months[:gregorian][:wide]["11"] = "નવેમ્બર"
    @months[:gregorian][:wide]["12"] = "ડિસેમ્બર"
    @months[:gregorian][:wide]["2"] = "ફેબ્રુઆરી"
    @months[:gregorian][:wide]["3"] = "માર્ચ"
    @months[:gregorian][:wide]["4"] = "એપ્રિલ"
    @months[:gregorian][:wide]["5"] = "મે"
    @months[:gregorian][:wide]["6"] = "જૂન"
    @months[:gregorian][:wide]["7"] = "જુલાઈ"
    @months[:gregorian][:wide]["8"] = "ઑગસ્ટ"
    @months[:gregorian][:wide]["9"] = "સપ્ટેમ્બર"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "શુક્ર"
    @days[:gregorian][:abbreviated]["mon"] = "સોમ"
    @days[:gregorian][:abbreviated]["sat"] = "શનિ"
    @days[:gregorian][:abbreviated]["sun"] = "રવિ"
    @days[:gregorian][:abbreviated]["thu"] = "ગુરુ"
    @days[:gregorian][:abbreviated]["tue"] = "મંગળ"
    @days[:gregorian][:abbreviated]["wed"] = "બુધ"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "શુક્રવાર"
    @days[:gregorian][:wide]["mon"] = "સોમવાર"
    @days[:gregorian][:wide]["sat"] = "શનિવાર"
    @days[:gregorian][:wide]["sun"] = "રવિવાર"
    @days[:gregorian][:wide]["thu"] = "ગુરુવાર"
    @days[:gregorian][:wide]["tue"] = "મંગળવાર"
    @days[:gregorian][:wide]["wed"] = "બુધવાર"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "પૂર્વ મધ્યાહ્ન"
    @pm = {}
    @pm["gregorian"] = "ઉત્તર મધ્યાહ્ન"
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ઈસાપૂઋ્વ."
    @era_names[:gregorian]["1"] = "સન."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
