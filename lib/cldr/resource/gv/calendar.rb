...
# CLDR version: 1.3
#
# Original file name: common/main/gv.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "J-guer"
    @months[:gregorian][:abbreviated]["10"] = "J-fouyir"
    @months[:gregorian][:abbreviated]["11"] = "M.Houney"
    @months[:gregorian][:abbreviated]["12"] = "M.Nollick"
    @months[:gregorian][:abbreviated]["2"] = "T-arree"
    @months[:gregorian][:abbreviated]["3"] = "Mayrnt"
    @months[:gregorian][:abbreviated]["4"] = "Avrril"
    @months[:gregorian][:abbreviated]["5"] = "Boaldyn"
    @months[:gregorian][:abbreviated]["6"] = "M-souree"
    @months[:gregorian][:abbreviated]["7"] = "J-souree"
    @months[:gregorian][:abbreviated]["8"] = "Luanistyn"
    @months[:gregorian][:abbreviated]["9"] = "M-fouyir"
    ...
    @months[:gregorian][:wide]["1"] = "Jerrey-geuree"
    @months[:gregorian][:wide]["10"] = "Jerrey-fouyir"
    @months[:gregorian][:wide]["11"] = "Mee Houney"
    @months[:gregorian][:wide]["12"] = "Mee ny Nollick"
    @months[:gregorian][:wide]["2"] = "Toshiaght-arree"
    @months[:gregorian][:wide]["3"] = "Mayrnt"
    @months[:gregorian][:wide]["4"] = "Averil"
    @months[:gregorian][:wide]["5"] = "Boaldyn"
    @months[:gregorian][:wide]["6"] = "Mean-souree"
    @months[:gregorian][:wide]["7"] = "Jerrey-souree"
    @months[:gregorian][:wide]["8"] = "Luanistyn"
    @months[:gregorian][:wide]["9"] = "Mean-fouyir"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Jeh"
    @days[:gregorian][:abbreviated]["mon"] = "Jel"
    @days[:gregorian][:abbreviated]["sat"] = "Jes"
    @days[:gregorian][:abbreviated]["sun"] = "Jed"
    @days[:gregorian][:abbreviated]["thu"] = "Jerd"
    @days[:gregorian][:abbreviated]["tue"] = "Jem"
    @days[:gregorian][:abbreviated]["wed"] = "Jerc"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jeheiney"
    @days[:gregorian][:wide]["mon"] = "Jelhein"
    @days[:gregorian][:wide]["sat"] = "Jesarn"
    @days[:gregorian][:wide]["sun"] = "Jedoonee"
    @days[:gregorian][:wide]["thu"] = "Jerdein"
    @days[:gregorian][:wide]["tue"] = "Jemayrt"
    @days[:gregorian][:wide]["wed"] = "Jercean"
    @dayformat_defaults = {}
