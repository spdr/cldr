...
# CLDR version: 1.3
#
# Original file name: common/main/haw.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["10"] = "ʻOk."
    @months[:gregorian][:abbreviated]["11"] = "Now."
    @months[:gregorian][:abbreviated]["12"] = "Kek."
    @months[:gregorian][:abbreviated]["2"] = "Pep."
    @months[:gregorian][:abbreviated]["3"] = "Mal."
    @months[:gregorian][:abbreviated]["4"] = "ʻAp."
    @months[:gregorian][:abbreviated]["5"] = "Mei"
    @months[:gregorian][:abbreviated]["6"] = "Iun."
    @months[:gregorian][:abbreviated]["7"] = "Iul."
    @months[:gregorian][:abbreviated]["8"] = "ʻAu."
    @months[:gregorian][:abbreviated]["9"] = "Kep."
    ...
    @months[:gregorian][:wide]["1"] = "Ianuali"
    @months[:gregorian][:wide]["10"] = "ʻOkakopa"
    @months[:gregorian][:wide]["11"] = "Nowemapa"
    @months[:gregorian][:wide]["12"] = "Kekemapa"
    @months[:gregorian][:wide]["2"] = "Pepeluali"
    @months[:gregorian][:wide]["3"] = "Malaki"
    @months[:gregorian][:wide]["4"] = "ʻApelila"
    @months[:gregorian][:wide]["5"] = "Mei"
    @months[:gregorian][:wide]["6"] = "Iune"
    @months[:gregorian][:wide]["7"] = "Iulai"
    @months[:gregorian][:wide]["8"] = "ʻAukake"
    @months[:gregorian][:wide]["9"] = "Kepakemapa"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "P5"
    @days[:gregorian][:abbreviated]["mon"] = "P1"
    @days[:gregorian][:abbreviated]["sat"] = "P6"
    @days[:gregorian][:abbreviated]["sun"] = "LP"
    @days[:gregorian][:abbreviated]["thu"] = "P4"
    @days[:gregorian][:abbreviated]["tue"] = "P2"
    @days[:gregorian][:abbreviated]["wed"] = "P3"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Poʻalima"
    @days[:gregorian][:wide]["mon"] = "Poʻakahi"
    @days[:gregorian][:wide]["sat"] = "Poʻaono"
    @days[:gregorian][:wide]["sun"] = "Lāpule"
    @days[:gregorian][:wide]["thu"] = "Poʻahā"
    @days[:gregorian][:wide]["tue"] = "Poʻalua"
    @days[:gregorian][:wide]["wed"] = "Poʻakolu"
    @dayformat_defaults = {}
