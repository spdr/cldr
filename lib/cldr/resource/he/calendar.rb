...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ינו"
    @months[:gregorian][:abbreviated]["10"] = "אוק"
    @months[:gregorian][:abbreviated]["11"] = "נוב"
    @months[:gregorian][:abbreviated]["12"] = "דצמ"
    @months[:gregorian][:abbreviated]["2"] = "פבר"
    @months[:gregorian][:abbreviated]["3"] = "מרץ"
    @months[:gregorian][:abbreviated]["4"] = "אפר"
    @months[:gregorian][:abbreviated]["5"] = "מאי"
    @months[:gregorian][:abbreviated]["6"] = "יונ"
    @months[:gregorian][:abbreviated]["7"] = "יול"
    @months[:gregorian][:abbreviated]["8"] = "אוג"
    @months[:gregorian][:abbreviated]["9"] = "ספט"
    ...
    @months[:gregorian][:wide]["1"] = "ינואר"
    @months[:gregorian][:wide]["10"] = "אוקטובר"
    @months[:gregorian][:wide]["11"] = "נובמבר"
    @months[:gregorian][:wide]["12"] = "דצמבר"
    @months[:gregorian][:wide]["2"] = "פברואר"
    @months[:gregorian][:wide]["3"] = "מרץ"
    @months[:gregorian][:wide]["4"] = "אפריל"
    @months[:gregorian][:wide]["5"] = "מאי"
    @months[:gregorian][:wide]["6"] = "יוני"
    @months[:gregorian][:wide]["7"] = "יולי"
    @months[:gregorian][:wide]["8"] = "אוגוסט"
    @months[:gregorian][:wide]["9"] = "ספטמבר"
    @months[:hebrew] = {}
    @months[:hebrew][:abbreviated] = {}
    @months[:hebrew][:abbreviated]["1"] = "תשרי"
    @months[:hebrew][:abbreviated]["10"] = "סיון"
    @months[:hebrew][:abbreviated]["11"] = "תמוז"
    @months[:hebrew][:abbreviated]["12"] = "אב"
    @months[:hebrew][:abbreviated]["13"] = "אלול"
    @months[:hebrew][:abbreviated]["2"] = "חשון"
    @months[:hebrew][:abbreviated]["3"] = "כסלו"
    @months[:hebrew][:abbreviated]["4"] = "טבת"
    @months[:hebrew][:abbreviated]["5"] = "שבט"
    @months[:hebrew][:abbreviated]["6"] = "אדר ראשון"
    @months[:hebrew][:abbreviated]["7"] = "אדר שני"
    @months[:hebrew][:abbreviated]["8"] = "ניסן"
    @months[:hebrew][:abbreviated]["9"] = "אייר"
    @months[:hebrew][:wide] = {}
    @months[:hebrew][:wide]["1"] = "תשרי"
    @months[:hebrew][:wide]["10"] = "סיון"
    @months[:hebrew][:wide]["11"] = "תמוז"
    @months[:hebrew][:wide]["12"] = "אב"
    @months[:hebrew][:wide]["13"] = "אלול"
    @months[:hebrew][:wide]["2"] = "חשון"
    @months[:hebrew][:wide]["3"] = "כסלו"
    @months[:hebrew][:wide]["4"] = "טבת"
    @months[:hebrew][:wide]["5"] = "שבט"
    @months[:hebrew][:wide]["6"] = "אדר ראשון"
    @months[:hebrew][:wide]["7"] = "אדר שני"
    @months[:hebrew][:wide]["8"] = "ניסן"
    @months[:hebrew][:wide]["9"] = "אייר"
    @months[:islamic_civil] = {}
    @months[:islamic_civil][:abbreviated] = {}
    @months[:islamic_civil][:abbreviated]["1"] = "מוחרם"
    @months[:islamic_civil][:abbreviated]["10"] = "שוואל"
    @months[:islamic_civil][:abbreviated]["11"] = "זו אל-QI'DAH"
    @months[:islamic_civil][:abbreviated]["12"] = "זו אל-חיג׳ה"
    @months[:islamic_civil][:abbreviated]["2"] = "ספר"
    @months[:islamic_civil][:abbreviated]["3"] = "רביע אל-אוואל"
    @months[:islamic_civil][:abbreviated]["4"] = "רביע אל-תני"
    @months[:islamic_civil][:abbreviated]["5"] = "ג׳ומדה אל-אוואל"
    @months[:islamic_civil][:abbreviated]["6"] = "ג׳ומדה אל-תני"
    @months[:islamic_civil][:abbreviated]["7"] = "רג׳אב"
    @months[:islamic_civil][:abbreviated]["8"] = "שעבאן"
    @months[:islamic_civil][:abbreviated]["9"] = "ראמדן"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "מוחרם"
    @months[:islamic_civil][:wide]["10"] = "שוואל"
    @months[:islamic_civil][:wide]["11"] = "זו אל-QI'DAH"
    @months[:islamic_civil][:wide]["12"] = "זו אל-חיג׳ה"
    @months[:islamic_civil][:wide]["2"] = "ספר"
    @months[:islamic_civil][:wide]["3"] = "רביע אל-אוואל"
    @months[:islamic_civil][:wide]["4"] = "רביע אל-תני"
    @months[:islamic_civil][:wide]["5"] = "ג׳ומדה אל-אוואל"
    @months[:islamic_civil][:wide]["6"] = "ג׳ומדה אל-תני"
    @months[:islamic_civil][:wide]["7"] = "רג׳אב"
    @months[:islamic_civil][:wide]["8"] = "שעבאן"
    @months[:islamic_civil][:wide]["9"] = "ראמדן"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "מוחרם"
    @months[:islamic][:abbreviated]["10"] = "שוואל"
    @months[:islamic][:abbreviated]["11"] = "זו אל-QI'DAH"
    @months[:islamic][:abbreviated]["12"] = "זו אל-חיג׳ה"
    @months[:islamic][:abbreviated]["2"] = "ספר"
    @months[:islamic][:abbreviated]["3"] = "רביע אל-אוואל"
    @months[:islamic][:abbreviated]["4"] = "רביע אל-תני"
    @months[:islamic][:abbreviated]["5"] = "ג׳ומדה אל-אוואל"
    @months[:islamic][:abbreviated]["6"] = "ג׳ומדה אל-תני"
    @months[:islamic][:abbreviated]["7"] = "רג׳אב"
    @months[:islamic][:abbreviated]["8"] = "שעבאן"
    @months[:islamic][:abbreviated]["9"] = "ראמדן"
    @months[:islamic][:wide] = {}
    @months[:islamic][:wide]["1"] = "מוחרם"
    @months[:islamic][:wide]["10"] = "שוואל"
    @months[:islamic][:wide]["11"] = "זו אל-QI'DAH"
    @months[:islamic][:wide]["12"] = "זו אל-חיג׳ה"
    @months[:islamic][:wide]["2"] = "ספר"
    @months[:islamic][:wide]["3"] = "רביע אל-אוואל"
    @months[:islamic][:wide]["4"] = "רביע אל-תני"
    @months[:islamic][:wide]["5"] = "ג׳ומדה אל-אוואל"
    @months[:islamic][:wide]["6"] = "ג׳ומדה אל-תני"
    @months[:islamic][:wide]["7"] = "רג׳אב"
    @months[:islamic][:wide]["8"] = "שעבאן"
    @months[:islamic][:wide]["9"] = "ראמדן"
    @months[:persian] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ו"
    @days[:gregorian][:abbreviated]["mon"] = "ב"
    @days[:gregorian][:abbreviated]["sat"] = "ש"
    @days[:gregorian][:abbreviated]["sun"] = "א"
    @days[:gregorian][:abbreviated]["thu"] = "ה"
    @days[:gregorian][:abbreviated]["tue"] = "ג"
    @days[:gregorian][:abbreviated]["wed"] = "ד"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ו"
    @days[:gregorian][:narrow]["mon"] = "ב"
    @days[:gregorian][:narrow]["sat"] = "ש"
    @days[:gregorian][:narrow]["sun"] = "א"
    @days[:gregorian][:narrow]["thu"] = "ה"
    @days[:gregorian][:narrow]["tue"] = "ג"
    @days[:gregorian][:narrow]["wed"] = "ד"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "יום שישי"
    @days[:gregorian][:wide]["mon"] = "יום שני"
    @days[:gregorian][:wide]["sat"] = "שבת"
    @days[:gregorian][:wide]["sun"] = "יום ראשון"
    @days[:gregorian][:wide]["thu"] = "יום חמישי"
    @days[:gregorian][:wide]["tue"] = "יום שלישי"
    @days[:gregorian][:wide]["wed"] = "יום רביעי"
    @dayformat_defaults = {}
    @dayformat_defaults["gregorian"] = "wide"
    @week_firstdays = {}
    @week_firstdays["gregorian"] = "sun"
    @weekend_starts = {}
    @weekend_starts["gregorian"] = "fri"
    @weekend_ends = {}
    @weekend_ends["gregorian"] = "sat"
    @mindays = {}
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "AM"
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "לפנה״ס"
    @era_abbrs[:gregorian]["1"] = "לסה״נ"
    @era_abbrs[:hebrew] = {}
    @era_abbrs[:hebrew]["0"] = "לבה"ע"
    @era_abbrs[:islamic_civil] = {}
    @era_abbrs[:islamic_civil]["0"] = "שנת היג׳רה"
    @era_abbrs[:islamic] = {}
    @era_abbrs[:islamic]["0"] = "שנת היג׳רה"
    @era_abbrs[:japanese] = {}
