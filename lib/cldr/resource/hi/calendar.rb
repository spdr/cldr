...
# CLDR version: 1.3
#
# Original file name: common/main/hi.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "जनवरी"
    @months[:gregorian][:abbreviated]["10"] = "अक्तूबर"
    @months[:gregorian][:abbreviated]["11"] = "नवम्बर"
    @months[:gregorian][:abbreviated]["12"] = "दिसम्बर"
    @months[:gregorian][:abbreviated]["2"] = "फरवरी"
    @months[:gregorian][:abbreviated]["3"] = "मार्च"
    @months[:gregorian][:abbreviated]["4"] = "अप्रैल"
    @months[:gregorian][:abbreviated]["5"] = "मई"
    @months[:gregorian][:abbreviated]["6"] = "जून"
    @months[:gregorian][:abbreviated]["7"] = "जुलाई"
    @months[:gregorian][:abbreviated]["8"] = "अगस्त"
    @months[:gregorian][:abbreviated]["9"] = "सितम्बर"
    ...
    @months[:gregorian][:wide]["1"] = "जनवरी"
    @months[:gregorian][:wide]["10"] = "अक्तूबर"
    @months[:gregorian][:wide]["11"] = "नवम्बर"
    @months[:gregorian][:wide]["12"] = "दिसम्बर"
    @months[:gregorian][:wide]["2"] = "फरवरी"
    @months[:gregorian][:wide]["3"] = "मार्च"
    @months[:gregorian][:wide]["4"] = "अप्रैल"
    @months[:gregorian][:wide]["5"] = "मई"
    @months[:gregorian][:wide]["6"] = "जून"
    @months[:gregorian][:wide]["7"] = "जुलाई"
    @months[:gregorian][:wide]["8"] = "अगस्त"
    @months[:gregorian][:wide]["9"] = "सितम्बर"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["tue"] = "मंगल"
    ...
    @days[:gregorian][:wide]["sun"] = "रविवार"
    @days[:gregorian][:wide]["thu"] = "गुरुवार"
    @days[:gregorian][:wide]["tue"] = "मंगलवार"
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "पूर्वाह्न"
    @pm = {}
    @pm["gregorian"] = "अपराह्न"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "ईसापूर्व"
    @era_abbrs[:gregorian]["1"] = "सन"
    @era_abbrs[:hebrew] = {}
