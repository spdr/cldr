...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "sij"
    @months[:gregorian][:abbreviated]["10"] = "lis"
    @months[:gregorian][:abbreviated]["11"] = "stu"
    @months[:gregorian][:abbreviated]["12"] = "pro"
    @months[:gregorian][:abbreviated]["2"] = "vel"
    @months[:gregorian][:abbreviated]["3"] = "ožu"
    @months[:gregorian][:abbreviated]["4"] = "tra"
    @months[:gregorian][:abbreviated]["5"] = "svi"
    @months[:gregorian][:abbreviated]["6"] = "lip"
    @months[:gregorian][:abbreviated]["7"] = "srp"
    @months[:gregorian][:abbreviated]["8"] = "kol"
    @months[:gregorian][:abbreviated]["9"] = "ruj"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "s"
    @months[:gregorian][:narrow]["10"] = "l"
    @months[:gregorian][:narrow]["11"] = "s"
    @months[:gregorian][:narrow]["12"] = "p"
    @months[:gregorian][:narrow]["2"] = "v"
    @months[:gregorian][:narrow]["3"] = "o"
    @months[:gregorian][:narrow]["4"] = "t"
    @months[:gregorian][:narrow]["5"] = "s"
    @months[:gregorian][:narrow]["6"] = "l"
    @months[:gregorian][:narrow]["7"] = "s"
    @months[:gregorian][:narrow]["8"] = "k"
    @months[:gregorian][:narrow]["9"] = "r"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "siječanj"
    @months[:gregorian][:wide]["10"] = "listopad"
    @months[:gregorian][:wide]["11"] = "studeni"
    @months[:gregorian][:wide]["12"] = "prosinac"
    @months[:gregorian][:wide]["2"] = "veljača"
    @months[:gregorian][:wide]["3"] = "ožujak"
    @months[:gregorian][:wide]["4"] = "travanj"
    @months[:gregorian][:wide]["5"] = "svibanj"
    @months[:gregorian][:wide]["6"] = "lipanj"
    @months[:gregorian][:wide]["7"] = "srpanj"
    @months[:gregorian][:wide]["8"] = "kolovoz"
    @months[:gregorian][:wide]["9"] = "rujan"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "pet"
    @days[:gregorian][:abbreviated]["mon"] = "pon"
    @days[:gregorian][:abbreviated]["sat"] = "sub"
    @days[:gregorian][:abbreviated]["sun"] = "ned"
    @days[:gregorian][:abbreviated]["thu"] = "čet"
    @days[:gregorian][:abbreviated]["tue"] = "uto"
    @days[:gregorian][:abbreviated]["wed"] = "sri"
    ...
    @days[:gregorian][:narrow]["tue"] = "u"
    @days[:gregorian][:narrow]["wed"] = "s"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "petak"
    @days[:gregorian][:wide]["mon"] = "ponedjeljak"
    @days[:gregorian][:wide]["sat"] = "subota"
    @days[:gregorian][:wide]["sun"] = "nedjelja"
    @days[:gregorian][:wide]["thu"] = "četvrtak"
    @days[:gregorian][:wide]["tue"] = "utorak"
    @days[:gregorian][:wide]["wed"] = "srijeda"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "Prije Krista"
    @era_names[:gregorian]["1"] = "Poslije Krista"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    ...
    @dateformats[:gregorian]["full"] = "yyyy. MMMM dd"
    @dateformats[:gregorian]["long"] = "yyyy. MMMM dd"
