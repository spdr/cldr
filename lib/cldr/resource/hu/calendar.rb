...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["12"] = "dec."
    @months[:gregorian][:abbreviated]["2"] = "febr."
    @months[:gregorian][:abbreviated]["3"] = "márc."
    @months[:gregorian][:abbreviated]["4"] = "ápr."
    @months[:gregorian][:abbreviated]["5"] = "máj."
    @months[:gregorian][:abbreviated]["6"] = "jún."
    @months[:gregorian][:abbreviated]["7"] = "júl."
    @months[:gregorian][:abbreviated]["8"] = "aug."
    @months[:gregorian][:abbreviated]["9"] = "szept."
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "J"
    @months[:gregorian][:narrow]["10"] = "O"
    @months[:gregorian][:narrow]["11"] = "N"
    @months[:gregorian][:narrow]["12"] = "D"
    @months[:gregorian][:narrow]["2"] = "F"
    @months[:gregorian][:narrow]["3"] = "M"
    @months[:gregorian][:narrow]["4"] = "Á"
    @months[:gregorian][:narrow]["5"] = "M"
    @months[:gregorian][:narrow]["6"] = "J"
    @months[:gregorian][:narrow]["7"] = "J"
    @months[:gregorian][:narrow]["8"] = "A"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "január"
    @months[:gregorian][:wide]["10"] = "október"
    @months[:gregorian][:wide]["11"] = "november"
    @months[:gregorian][:wide]["12"] = "december"
    @months[:gregorian][:wide]["2"] = "február"
    @months[:gregorian][:wide]["3"] = "március"
    @months[:gregorian][:wide]["4"] = "április"
    @months[:gregorian][:wide]["5"] = "május"
    @months[:gregorian][:wide]["6"] = "június"
    @months[:gregorian][:wide]["7"] = "július"
    @months[:gregorian][:wide]["8"] = "augusztus"
    @months[:gregorian][:wide]["9"] = "szeptember"
    @months[:hebrew] = {}
    @months[:hebrew][:abbreviated] = {}
    @months[:hebrew][:abbreviated]["1"] = "Tisri"
    @months[:hebrew][:abbreviated]["10"] = "Sziván"
    @months[:hebrew][:abbreviated]["11"] = "Tamuz"
    @months[:hebrew][:abbreviated]["12"] = "Áv"
    @months[:hebrew][:abbreviated]["13"] = "Elul"
    @months[:hebrew][:abbreviated]["2"] = "Hesván"
    @months[:hebrew][:abbreviated]["3"] = "Kiszlév"
    @months[:hebrew][:abbreviated]["4"] = "Tévész"
    @months[:hebrew][:abbreviated]["5"] = "Svát"
    @months[:hebrew][:abbreviated]["6"] = "Ádár risón"
    @months[:hebrew][:abbreviated]["7"] = "Ádár séni"
    @months[:hebrew][:abbreviated]["8"] = "Niszán"
    @months[:hebrew][:abbreviated]["9"] = "Ijár"
    @months[:hebrew][:wide] = {}
    @months[:hebrew][:wide]["1"] = "Tisri"
    @months[:hebrew][:wide]["10"] = "Sziván"
    @months[:hebrew][:wide]["11"] = "Tamuz"
    @months[:hebrew][:wide]["12"] = "Áv"
    @months[:hebrew][:wide]["13"] = "Elul"
    @months[:hebrew][:wide]["2"] = "Hesván"
    @months[:hebrew][:wide]["3"] = "Kiszlév"
    @months[:hebrew][:wide]["4"] = "Tévész"
    @months[:hebrew][:wide]["5"] = "Svát"
    @months[:hebrew][:wide]["6"] = "Ádár risón"
    @months[:hebrew][:wide]["7"] = "Ádár séni"
    @months[:hebrew][:wide]["8"] = "Niszán"
    @months[:hebrew][:wide]["9"] = "Ijár"
    @months[:islamic_civil] = {}
    @months[:islamic_civil][:abbreviated] = {}
    @months[:islamic_civil][:abbreviated]["1"] = "Moharrem"
    @months[:islamic_civil][:abbreviated]["10"] = "Sevvál"
    @months[:islamic_civil][:abbreviated]["11"] = "Dsül kade"
    @months[:islamic_civil][:abbreviated]["12"] = "Dsül hedse"
    @months[:islamic_civil][:abbreviated]["2"] = "Safar"
    @months[:islamic_civil][:abbreviated]["3"] = "Rébi el avvel"
    @months[:islamic_civil][:abbreviated]["4"] = "Rébi el accher"
    @months[:islamic_civil][:abbreviated]["5"] = "Dsemádi el avvel"
    @months[:islamic_civil][:abbreviated]["6"] = "Dsemádi el accher"
    @months[:islamic_civil][:abbreviated]["7"] = "Redseb"
    @months[:islamic_civil][:abbreviated]["8"] = "Sabán"
    @months[:islamic_civil][:abbreviated]["9"] = "Ramadán"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "Moharrem"
    @months[:islamic_civil][:wide]["10"] = "Sevvál"
    @months[:islamic_civil][:wide]["11"] = "Dsül kade"
    @months[:islamic_civil][:wide]["12"] = "Dsül hedse"
    @months[:islamic_civil][:wide]["2"] = "Safar"
    @months[:islamic_civil][:wide]["3"] = "Rébi el avvel"
    @months[:islamic_civil][:wide]["4"] = "Rébi el accher"
    @months[:islamic_civil][:wide]["5"] = "Dsemádi el avvel"
    @months[:islamic_civil][:wide]["6"] = "Dsemádi el accher"
    @months[:islamic_civil][:wide]["7"] = "Redseb"
    @months[:islamic_civil][:wide]["8"] = "Sabán"
    @months[:islamic_civil][:wide]["9"] = "Ramadán"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "Moharrem"
    @months[:islamic][:abbreviated]["10"] = "Sevvál"
    @months[:islamic][:abbreviated]["11"] = "Dsül kade"
    @months[:islamic][:abbreviated]["12"] = "Dsül hedse"
    @months[:islamic][:abbreviated]["2"] = "Safar"
    @months[:islamic][:abbreviated]["3"] = "Rébi el avvel"
    @months[:islamic][:abbreviated]["4"] = "Rébi el accher"
    @months[:islamic][:abbreviated]["5"] = "Dsemádi el avvel"
    @months[:islamic][:abbreviated]["6"] = "Dsemádi el accher"
    @months[:islamic][:abbreviated]["7"] = "Redseb"
    @months[:islamic][:abbreviated]["8"] = "Sabán"
    @months[:islamic][:abbreviated]["9"] = "Ramadán"
    @months[:islamic][:wide] = {}
    @months[:islamic][:wide]["1"] = "Moharrem"
    @months[:islamic][:wide]["10"] = "Sevvál"
    @months[:islamic][:wide]["11"] = "Dsül kade"
    @months[:islamic][:wide]["12"] = "Dsül hedse"
    @months[:islamic][:wide]["2"] = "Safar"
    @months[:islamic][:wide]["3"] = "Rébi el avvel"
    @months[:islamic][:wide]["4"] = "Rébi el accher"
    @months[:islamic][:wide]["5"] = "Dsemádi el avvel"
    @months[:islamic][:wide]["6"] = "Dsemádi el accher"
    @months[:islamic][:wide]["7"] = "Redseb"
    @months[:islamic][:wide]["8"] = "Sabán"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "P"
    @days[:gregorian][:abbreviated]["mon"] = "H"
    @days[:gregorian][:abbreviated]["sat"] = "Szo"
    @days[:gregorian][:abbreviated]["sun"] = "V"
    @days[:gregorian][:abbreviated]["thu"] = "Cs"
    @days[:gregorian][:abbreviated]["tue"] = "K"
    @days[:gregorian][:abbreviated]["wed"] = "Sze"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "P"
    @days[:gregorian][:narrow]["mon"] = "H"
    @days[:gregorian][:narrow]["sat"] = "S"
    @days[:gregorian][:narrow]["sun"] = "V"
    @days[:gregorian][:narrow]["thu"] = "C"
    @days[:gregorian][:narrow]["tue"] = "K"
    @days[:gregorian][:narrow]["wed"] = "S"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "péntek"
    @days[:gregorian][:wide]["mon"] = "hétfő"
    @days[:gregorian][:wide]["sat"] = "szombat"
    @days[:gregorian][:wide]["sun"] = "vasárnap"
    @days[:gregorian][:wide]["thu"] = "csütörtök"
    @days[:gregorian][:wide]["tue"] = "kedd"
    @days[:gregorian][:wide]["wed"] = "szerda"
    @dayformat_defaults = {}
    ...
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BK"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "i. e."
    @era_abbrs[:gregorian]["1"] = "i. sz."
    @era_abbrs[:hebrew] = {}
    @era_abbrs[:hebrew]["0"] = "TÉ"
    @era_abbrs[:islamic_civil] = {}
    @era_abbrs[:islamic_civil]["0"] = "MF"
    @era_abbrs[:islamic] = {}
    @era_abbrs[:islamic]["0"] = "MF"
    @era_abbrs[:japanese] = {}
