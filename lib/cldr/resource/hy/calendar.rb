...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Յնր"
    @months[:gregorian][:abbreviated]["10"] = "Հոկ"
    @months[:gregorian][:abbreviated]["11"] = "Նոյ"
    @months[:gregorian][:abbreviated]["12"] = "Դեկ"
    @months[:gregorian][:abbreviated]["2"] = "Փտր"
    @months[:gregorian][:abbreviated]["3"] = "Մրտ"
    @months[:gregorian][:abbreviated]["4"] = "Ապր"
    @months[:gregorian][:abbreviated]["5"] = "Մյս"
    @months[:gregorian][:abbreviated]["6"] = "Յնս"
    @months[:gregorian][:abbreviated]["7"] = "Յլս"
    @months[:gregorian][:abbreviated]["8"] = "Օգս"
    @months[:gregorian][:abbreviated]["9"] = "Սեպ"
    ...
    @months[:gregorian][:wide]["1"] = "Յունուար"
    @months[:gregorian][:wide]["10"] = "Հոկտեմբեր"
    @months[:gregorian][:wide]["11"] = "Նոյեմբեր"
    @months[:gregorian][:wide]["12"] = "Դեկտեմբեր"
    @months[:gregorian][:wide]["2"] = "Փետրուար"
    @months[:gregorian][:wide]["3"] = "Մարտ"
    @months[:gregorian][:wide]["4"] = "Ապրիլ"
    @months[:gregorian][:wide]["5"] = "Մայիս"
    @months[:gregorian][:wide]["6"] = "Յունիս"
    @months[:gregorian][:wide]["7"] = "Յուլիս"
    @months[:gregorian][:wide]["8"] = "Օգոստոս"
    @months[:gregorian][:wide]["9"] = "Սեպտեմբեր"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Ուր"
    @days[:gregorian][:abbreviated]["mon"] = "Երկ"
    @days[:gregorian][:abbreviated]["sat"] = "Շաբ"
    @days[:gregorian][:abbreviated]["sun"] = "Կիր"
    @days[:gregorian][:abbreviated]["thu"] = "Հնգ"
    @days[:gregorian][:abbreviated]["tue"] = "Երք"
    @days[:gregorian][:abbreviated]["wed"] = "Չոր"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Ուրբաթ"
    @days[:gregorian][:wide]["mon"] = "Երկուշաբթի"
    @days[:gregorian][:wide]["sat"] = "Շաբաթ"
    @days[:gregorian][:wide]["sun"] = "Կիրակի"
    @days[:gregorian][:wide]["thu"] = "Հինգշաբթի"
    @days[:gregorian][:wide]["tue"] = "Երեքշաբթի"
    @days[:gregorian][:wide]["wed"] = "Չորեքշաբթի"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "Յ․Տ․"
    @era_abbrs[:gregorian]["1"] = "Ն․Ք․"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["long"] = "MMMM dd, yyyy"
