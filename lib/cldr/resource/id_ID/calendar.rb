...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["8"] = "Agu"
    ...
    @days[:gregorian][:abbreviated]["mon"] = "Sen"
    @days[:gregorian][:abbreviated]["sat"] = "Sab"
    @days[:gregorian][:abbreviated]["sun"] = "Min"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jumat"
    @days[:gregorian][:wide]["mon"] = "Senin"
    @days[:gregorian][:wide]["sat"] = "Sabtu"
    @days[:gregorian][:wide]["sun"] = "Minggu"
    @days[:gregorian][:wide]["thu"] = "Kamis"
    ...
    @timeformats[:gregorian]["full"] = "H:mm:ss"
