...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["11"] = "nóv"
    ...
    @months[:gregorian][:abbreviated]["5"] = "maí"
    @months[:gregorian][:abbreviated]["6"] = "jún"
    @months[:gregorian][:abbreviated]["7"] = "júl"
    @months[:gregorian][:abbreviated]["8"] = "ágú"
    ...
    @months[:gregorian][:narrow]["8"] = "á"
    @months[:gregorian][:narrow]["9"] = "s"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "janúar"
    @months[:gregorian][:wide]["10"] = "október"
    @months[:gregorian][:wide]["11"] = "nóvember"
    @months[:gregorian][:wide]["12"] = "desember"
    @months[:gregorian][:wide]["2"] = "febrúar"
    @months[:gregorian][:wide]["3"] = "mars"
    @months[:gregorian][:wide]["4"] = "apríl"
    @months[:gregorian][:wide]["5"] = "maí"
    @months[:gregorian][:wide]["6"] = "júní"
    @months[:gregorian][:wide]["7"] = "júlí"
    @months[:gregorian][:wide]["8"] = "ágúst"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "fös"
    @days[:gregorian][:abbreviated]["mon"] = "mán"
    @days[:gregorian][:abbreviated]["sat"] = "lau"
    @days[:gregorian][:abbreviated]["sun"] = "sun"
    @days[:gregorian][:abbreviated]["thu"] = "fim"
    @days[:gregorian][:abbreviated]["tue"] = "þri"
    @days[:gregorian][:abbreviated]["wed"] = "mið"
    ...
    @days[:gregorian][:narrow]["thu"] = "f"
    @days[:gregorian][:narrow]["tue"] = "þ"
    @days[:gregorian][:narrow]["wed"] = "m"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "föstudagur"
    @days[:gregorian][:wide]["mon"] = "mánudagur"
    @days[:gregorian][:wide]["sat"] = "laugardagur"
    @days[:gregorian][:wide]["sun"] = "sunnudagur"
    @days[:gregorian][:wide]["thu"] = "fimmtudagur"
    @days[:gregorian][:wide]["tue"] = "þriðjudagur"
    @days[:gregorian][:wide]["wed"] = "miðvikudagur"
    @dayformat_defaults = {}
