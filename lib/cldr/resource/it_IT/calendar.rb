...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "gen"
    @months[:gregorian][:abbreviated]["10"] = "ott"
    ...
    @months[:gregorian][:abbreviated]["5"] = "mag"
    @months[:gregorian][:abbreviated]["6"] = "giu"
    @months[:gregorian][:abbreviated]["7"] = "lug"
    @months[:gregorian][:abbreviated]["8"] = "ago"
    @months[:gregorian][:abbreviated]["9"] = "set"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "G"
    ...
    @months[:gregorian][:narrow]["6"] = "G"
    @months[:gregorian][:narrow]["7"] = "L"
    @months[:gregorian][:narrow]["8"] = "A"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "gennaio"
    @months[:gregorian][:wide]["10"] = "ottobre"
    @months[:gregorian][:wide]["11"] = "novembre"
    @months[:gregorian][:wide]["12"] = "dicembre"
    @months[:gregorian][:wide]["2"] = "febbraio"
    @months[:gregorian][:wide]["3"] = "marzo"
    @months[:gregorian][:wide]["4"] = "aprile"
    @months[:gregorian][:wide]["5"] = "maggio"
    @months[:gregorian][:wide]["6"] = "giugno"
    @months[:gregorian][:wide]["7"] = "luglio"
    @months[:gregorian][:wide]["8"] = "agosto"
    @months[:gregorian][:wide]["9"] = "settembre"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["thu"] = "gio"
    ...
    @days[:gregorian][:narrow]["thu"] = "G"
    @days[:gregorian][:narrow]["tue"] = "M"
    @days[:gregorian][:narrow]["wed"] = "M"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "venerdì"
    @days[:gregorian][:wide]["mon"] = "lunedì"
    @days[:gregorian][:wide]["sat"] = "sabato"
    @days[:gregorian][:wide]["sun"] = "domenica"
    @days[:gregorian][:wide]["thu"] = "giovedì"
    @days[:gregorian][:wide]["tue"] = "martedì"
    @days[:gregorian][:wide]["wed"] = "mercoledì"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "aC"
    @era_abbrs[:gregorian]["1"] = "dC"
    @era_abbrs[:hebrew] = {}
