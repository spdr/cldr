...
# CLDR version: 1.3
#
# Original file name: common/main/iu.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ᔭᓐᓄᐊᓕ"
    @months[:gregorian][:abbreviated]["10"] = "ᐆᑦᑑᕝᕙ"
    @months[:gregorian][:abbreviated]["11"] = "ᓅᕙᐃᕝᕙ"
    @months[:gregorian][:abbreviated]["12"] = "ᑏᓰᕝᕙ"
    @months[:gregorian][:abbreviated]["2"] = "ᕕᕝᕗᐊᓕ"
    @months[:gregorian][:abbreviated]["3"] = "ᒫᑦᓯ"
    @months[:gregorian][:abbreviated]["4"] = "ᐊᐃᑉᐳᓗ"
    @months[:gregorian][:abbreviated]["5"] = "ᒪᐃ"
    @months[:gregorian][:abbreviated]["6"] = "ᔫᓂ"
    @months[:gregorian][:abbreviated]["7"] = "ᔪᓚᐃ"
    @months[:gregorian][:abbreviated]["8"] = "ᐊᐅᒡᒍᓯ"
    @months[:gregorian][:abbreviated]["9"] = "ᓰᑦᑏᕝᕙ"
    ...
    @months[:gregorian][:wide]["1"] = "ᔭᓐᓄᐊᓕ"
    @months[:gregorian][:wide]["10"] = "ᐆᑦᑑᕝᕙ"
    @months[:gregorian][:wide]["11"] = "ᓅᕙᐃᕝᕙ"
    @months[:gregorian][:wide]["12"] = "ᑏᓰᕝᕙ"
    @months[:gregorian][:wide]["2"] = "ᕕᕝᕗᐊᓕ"
    @months[:gregorian][:wide]["3"] = "ᒫᑦᓯ"
    @months[:gregorian][:wide]["4"] = "ᐊᐃᑉᐳᓗ"
    @months[:gregorian][:wide]["5"] = "ᒪᐃ"
    @months[:gregorian][:wide]["6"] = "ᔫᓂ"
    @months[:gregorian][:wide]["7"] = "ᔪᓚᐃ"
    @months[:gregorian][:wide]["8"] = "ᐊᐅᒡᒍᓯ"
    @months[:gregorian][:wide]["9"] = "ᓰᑦᑏᕝᕙ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ᑕᓪᓕᕐᒥᖅ"
    @days[:gregorian][:abbreviated]["mon"] = "ᓇᒡᒐᔾᔭᐅ"
    @days[:gregorian][:abbreviated]["sat"] = "ᓈᑦᓰᖑᔭᓕᖅᕿ"
    @days[:gregorian][:abbreviated]["sun"] = "ᓈᑦᓰᖑᔭ"
    @days[:gregorian][:abbreviated]["thu"] = "ᓯᑕᒻᒥᖅ"
    @days[:gregorian][:abbreviated]["tue"] = "ᓇᒡᒐᔾᔭᐅᓕᖅᑭ"
    @days[:gregorian][:abbreviated]["wed"] = "ᐱᖓᑦᓯᖅ"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ᑕᓪᓕᕐᒥᖅ"
    @days[:gregorian][:wide]["mon"] = "ᓇᒡᒐᔾᔭᐅ"
    @days[:gregorian][:wide]["sat"] = "ᓈᑦᓰᖑᔭᓕᖅᕿ"
    @days[:gregorian][:wide]["sun"] = "ᓈᑦᓰᖑᔭ"
    @days[:gregorian][:wide]["thu"] = "ᓯᑕᒻᒥᖅ"
    @days[:gregorian][:wide]["tue"] = "ᓇᒡᒐᔾᔭᐅᓕᖅᑭ"
    @days[:gregorian][:wide]["wed"] = "ᐱᖓᑦᓯᖅ"
    @dayformat_defaults = {}
