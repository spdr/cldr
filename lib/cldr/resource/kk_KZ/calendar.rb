...
# CLDR version: 1.3
#
# Original file name: common/main/kk_KZ.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "қаң."
    @months[:gregorian][:abbreviated]["10"] = "қаз."
    @months[:gregorian][:abbreviated]["11"] = "қар."
    @months[:gregorian][:abbreviated]["12"] = "желт."
    @months[:gregorian][:abbreviated]["2"] = "ақп."
    @months[:gregorian][:abbreviated]["3"] = "нау."
    @months[:gregorian][:abbreviated]["4"] = "сәу."
    @months[:gregorian][:abbreviated]["5"] = "мам."
    @months[:gregorian][:abbreviated]["6"] = "мау."
    @months[:gregorian][:abbreviated]["7"] = "шіл."
    @months[:gregorian][:abbreviated]["8"] = "там."
    @months[:gregorian][:abbreviated]["9"] = "қыр."
    ...
    @months[:gregorian][:wide]["1"] = "қаңтар"
    @months[:gregorian][:wide]["10"] = "қазан"
    @months[:gregorian][:wide]["11"] = "қараша"
    @months[:gregorian][:wide]["12"] = "желтоқсан"
    @months[:gregorian][:wide]["2"] = "ақпан"
    @months[:gregorian][:wide]["3"] = "наурыз"
    @months[:gregorian][:wide]["4"] = "сәуір"
    @months[:gregorian][:wide]["5"] = "мамыр"
    @months[:gregorian][:wide]["6"] = "маусым"
    @months[:gregorian][:wide]["7"] = "шілде"
    @months[:gregorian][:wide]["8"] = "тамыз"
    @months[:gregorian][:wide]["9"] = "қыркүйек"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "жм."
    @days[:gregorian][:abbreviated]["mon"] = "дс."
    @days[:gregorian][:abbreviated]["sat"] = "сһ."
    @days[:gregorian][:abbreviated]["sun"] = "жс."
    @days[:gregorian][:abbreviated]["thu"] = "бс."
    @days[:gregorian][:abbreviated]["tue"] = "сс."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "жұма"
    @days[:gregorian][:wide]["mon"] = "дуйсенбі"
    @days[:gregorian][:wide]["sat"] = "сенбі"
    @days[:gregorian][:wide]["sun"] = "жексені"
    @days[:gregorian][:wide]["thu"] = "бейсенбі"
    @days[:gregorian][:wide]["tue"] = "сейсенбі"
    @days[:gregorian][:wide]["wed"] = "сәренбі"
    @dayformat_defaults = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, d MMMM yyyy 'ж.'"
    @dateformats[:gregorian]["long"] = "d MMMM yyyy 'ж.'"
