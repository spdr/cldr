...
# CLDR version: 1.3
#
# Original file name: common/main/kl.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["10"] = "oktoberi"
    @months[:gregorian][:wide]["11"] = "novemberi"
    @months[:gregorian][:wide]["12"] = "decemberi"
    @months[:gregorian][:wide]["2"] = "februari"
    @months[:gregorian][:wide]["3"] = "martsi"
    @months[:gregorian][:wide]["4"] = "aprili"
    @months[:gregorian][:wide]["5"] = "maji"
    @months[:gregorian][:wide]["6"] = "juni"
    @months[:gregorian][:wide]["7"] = "juli"
    @months[:gregorian][:wide]["8"] = "augustusi"
    @months[:gregorian][:wide]["9"] = "septemberi"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "tal"
    @days[:gregorian][:abbreviated]["mon"] = "ata"
    @days[:gregorian][:abbreviated]["sat"] = "arf"
    @days[:gregorian][:abbreviated]["sun"] = "sab"
    @days[:gregorian][:abbreviated]["thu"] = "sis"
    @days[:gregorian][:abbreviated]["tue"] = "mar"
    @days[:gregorian][:abbreviated]["wed"] = "pin"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "tallimanngorneq"
    @days[:gregorian][:wide]["mon"] = "ataasinngorneq"
    @days[:gregorian][:wide]["sat"] = "arfininngorneq"
    @days[:gregorian][:wide]["sun"] = "sabaat"
    @days[:gregorian][:wide]["thu"] = "sisamanngorneq"
    @days[:gregorian][:wide]["tue"] = "marlunngorneq"
    @days[:gregorian][:wide]["wed"] = "pingasunngorneq"
    @dayformat_defaults = {}
