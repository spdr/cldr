...
#
  ...
  private
  def init_data
    @localized_pattern_characters = "GyMdkHmsSEDFwWahKzYeugXZ"
    @default = "gregorian"
    @months = {}
    @months[:gregorian] = {}
    @months[:gregorian][:abbreviated] = {}
    @months[:gregorian][:abbreviated]["1"] = "១"
    @months[:gregorian][:abbreviated]["10"] = "១០"
    @months[:gregorian][:abbreviated]["11"] = "១១"
    @months[:gregorian][:abbreviated]["12"] = "១២"
    @months[:gregorian][:abbreviated]["2"] = "២"
    @months[:gregorian][:abbreviated]["3"] = "៣"
    @months[:gregorian][:abbreviated]["4"] = "៤"
    @months[:gregorian][:abbreviated]["5"] = "៥"
    @months[:gregorian][:abbreviated]["6"] = "៦"
    @months[:gregorian][:abbreviated]["7"] = "៧"
    @months[:gregorian][:abbreviated]["8"] = "៨"
    @months[:gregorian][:abbreviated]["9"] = "៩"
    ...
    @months[:gregorian][:wide]["1"] = "មករា"
    @months[:gregorian][:wide]["10"] = "តុលា"
    @months[:gregorian][:wide]["11"] = "វិច្ឆិកា"
    @months[:gregorian][:wide]["12"] = "ធ្នូ"
    @months[:gregorian][:wide]["2"] = "កុម្ភៈ"
    @months[:gregorian][:wide]["3"] = "មិនា"
    @months[:gregorian][:wide]["4"] = "មេសា"
    @months[:gregorian][:wide]["5"] = "ឧសភា"
    @months[:gregorian][:wide]["6"] = "មិថុនា"
    @months[:gregorian][:wide]["7"] = "កក្កដា"
    @months[:gregorian][:wide]["8"] = "សីហា"
    @months[:gregorian][:wide]["9"] = "កញ្ញា"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "សុ"
    @days[:gregorian][:abbreviated]["mon"] = "ច"
    @days[:gregorian][:abbreviated]["sat"] = "ស"
    @days[:gregorian][:abbreviated]["sun"] = "អា"
    @days[:gregorian][:abbreviated]["thu"] = "ព្រ"
    @days[:gregorian][:abbreviated]["tue"] = "អ"
    @days[:gregorian][:abbreviated]["wed"] = "ពុ"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ថ្ងៃសុក្រ"
    @days[:gregorian][:wide]["mon"] = "​ថ្ងៃច័ន្ទ"
    @days[:gregorian][:wide]["sat"] = "ថ្ងៃសៅរ៍"
    @days[:gregorian][:wide]["sun"] = "ថ្ងៃអាទិត្យ"
    @days[:gregorian][:wide]["thu"] = "ថ្ងៃព្រហស្បតិ៍"
    @days[:gregorian][:wide]["tue"] = "ថ្ងៃអង្គារ"
    @days[:gregorian][:wide]["wed"] = "ថ្ងៃពុធ"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "មុន​គ្រិស្តសករាជ"
    @era_names[:gregorian]["1"] = "គ្រិស្តសករាជ"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "ព.ស."
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "មុន​គ.ស."
    @era_abbrs[:gregorian]["1"] = "គ.ស."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:buddhist]["full"] = "EEEE' ថ្ងៃ 'd' ខែ 'MMMM' ឆ្នាំ ' yyyy"
    @dateformats[:buddhist]["long"] = "EEEE' ថ្ងៃ 'd' ខែ 'MMMM' ឆ្នាំ ' yyyy"
    @dateformats[:buddhist]["medium"] = "d MMMM yyyy"
    ...
    @dateformats[:gregorian]["full"] = "EEEE' ថ្ងៃ 'd' ខែ 'MMMM' ឆ្នាំ ' yyyy"
    @dateformats[:gregorian]["long"] = "EEEE' ថ្ងៃ 'd' ខែ 'MMMM' ឆ្នាំ ' yyyy"
    @dateformats[:gregorian]["medium"] = "d MMMM yyyy"
    ...
    @dateformat_defaults = {}
    @dateformat_defaults["buddhist"] = "long"
    ...
    @timeformats[:buddhist]["full"] = "H' ម៉ោង 'm' នាទី 'ss' វិនាទី​'"
    @timeformats[:buddhist]["long"] = "H' ម៉ោង 'm' នាទី'"
    @timeformats[:buddhist]["medium"] = "H:mm:ss"
    @timeformats[:buddhist]["short"] = "H:mm"
    @timeformats[:chinese] = {}
    ...
    @timeformats[:gregorian]["full"] = "H' ម៉ោង 'm' នាទី 'ss' វិនាទី​' z"
    @timeformats[:gregorian]["long"] = "H' ម៉ោង 'm' នាទី 'ss' វិនាទី​'"
