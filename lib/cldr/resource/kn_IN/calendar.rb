...
# CLDR version: 1.3
#
# Original file name: common/main/kn_IN.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ಜನವರೀ"
    @months[:gregorian][:abbreviated]["10"] = "ಅಕ್ಟೋಬರ್"
    @months[:gregorian][:abbreviated]["11"] = "ನವೆಂಬರ್"
    @months[:gregorian][:abbreviated]["12"] = "ಡಿಸೆಂಬರ್"
    @months[:gregorian][:abbreviated]["2"] = "ಫೆಬ್ರವರೀ"
    @months[:gregorian][:abbreviated]["3"] = "ಮಾರ್ಚ್"
    @months[:gregorian][:abbreviated]["4"] = "ಎಪ್ರಿಲ್"
    @months[:gregorian][:abbreviated]["5"] = "ಮೆ"
    @months[:gregorian][:abbreviated]["6"] = "ಜೂನ್"
    @months[:gregorian][:abbreviated]["7"] = "ಜುಲೈ"
    @months[:gregorian][:abbreviated]["8"] = "ಆಗಸ್ಟ್"
    @months[:gregorian][:abbreviated]["9"] = "ಸಪ್ಟೆಂಬರ್"
    ...
    @months[:gregorian][:wide]["1"] = "ಜನವರೀ"
    @months[:gregorian][:wide]["10"] = "ಅಕ್ಟೋಬರ್"
    @months[:gregorian][:wide]["11"] = "ನವೆಂಬರ್"
    @months[:gregorian][:wide]["12"] = "ಡಿಸೆಂಬರ್"
    @months[:gregorian][:wide]["2"] = "ಫೆಬ್ರವರೀ"
    @months[:gregorian][:wide]["3"] = "ಮಾರ್ಚ್"
    @months[:gregorian][:wide]["4"] = "ಎಪ್ರಿಲ್"
    @months[:gregorian][:wide]["5"] = "ಮೆ"
    @months[:gregorian][:wide]["6"] = "ಜೂನ್"
    @months[:gregorian][:wide]["7"] = "ಜುಲೈ"
    @months[:gregorian][:wide]["8"] = "ಆಗಸ್ಟ್"
    @months[:gregorian][:wide]["9"] = "ಸಪ್ಟೆಂಬರ್"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ಶು."
    @days[:gregorian][:abbreviated]["mon"] = "ಸೋ."
    @days[:gregorian][:abbreviated]["sat"] = "ಶನಿ."
    @days[:gregorian][:abbreviated]["sun"] = "ರ."
    @days[:gregorian][:abbreviated]["thu"] = "ಗು."
    @days[:gregorian][:abbreviated]["tue"] = "ಮಂ."
    @days[:gregorian][:abbreviated]["wed"] = "ಬು."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ಶುಕ್ರವಾರ"
    @days[:gregorian][:wide]["mon"] = "ಸೋಮವಾರ"
    @days[:gregorian][:wide]["sat"] = "ಶನಿವಾರ"
    @days[:gregorian][:wide]["sun"] = "ರವಿವಾರ"
    @days[:gregorian][:wide]["thu"] = "ಗುರುವಾರ"
    @days[:gregorian][:wide]["tue"] = "ಮಂಗಳವಾರ"
    @days[:gregorian][:wide]["wed"] = "ಬುಧವಾರ"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ಪೂರ್ವಾಹ್ನ"
    @pm = {}
    @pm["gregorian"] = "ಅಪರಾಹ್ನ"
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ಈಸಪೂವ೯."
    @era_names[:gregorian]["1"] = "ಸನ್."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
