...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "1월"
    @months[:gregorian][:abbreviated]["10"] = "10월"
    @months[:gregorian][:abbreviated]["11"] = "11월"
    @months[:gregorian][:abbreviated]["12"] = "12월"
    @months[:gregorian][:abbreviated]["2"] = "2월"
    @months[:gregorian][:abbreviated]["3"] = "3월"
    @months[:gregorian][:abbreviated]["4"] = "4월"
    @months[:gregorian][:abbreviated]["5"] = "5월"
    @months[:gregorian][:abbreviated]["6"] = "6월"
    @months[:gregorian][:abbreviated]["7"] = "7월"
    @months[:gregorian][:abbreviated]["8"] = "8월"
    @months[:gregorian][:abbreviated]["9"] = "9월"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "1월"
    @months[:gregorian][:narrow]["10"] = "10월"
    @months[:gregorian][:narrow]["11"] = "11월"
    @months[:gregorian][:narrow]["12"] = "12월"
    @months[:gregorian][:narrow]["2"] = "2월"
    @months[:gregorian][:narrow]["3"] = "3월"
    @months[:gregorian][:narrow]["4"] = "4월"
    @months[:gregorian][:narrow]["5"] = "5월"
    @months[:gregorian][:narrow]["6"] = "6월"
    @months[:gregorian][:narrow]["7"] = "7월"
    @months[:gregorian][:narrow]["8"] = "8월"
    @months[:gregorian][:narrow]["9"] = "9월"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "1월"
    @months[:gregorian][:wide]["10"] = "10월"
    @months[:gregorian][:wide]["11"] = "11월"
    @months[:gregorian][:wide]["12"] = "12월"
    @months[:gregorian][:wide]["2"] = "2월"
    @months[:gregorian][:wide]["3"] = "3월"
    @months[:gregorian][:wide]["4"] = "4월"
    @months[:gregorian][:wide]["5"] = "5월"
    @months[:gregorian][:wide]["6"] = "6월"
    @months[:gregorian][:wide]["7"] = "7월"
    @months[:gregorian][:wide]["8"] = "8월"
    @months[:gregorian][:wide]["9"] = "9월"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "금"
    @days[:gregorian][:abbreviated]["mon"] = "월"
    @days[:gregorian][:abbreviated]["sat"] = "토"
    @days[:gregorian][:abbreviated]["sun"] = "일"
    @days[:gregorian][:abbreviated]["thu"] = "목"
    @days[:gregorian][:abbreviated]["tue"] = "화"
    @days[:gregorian][:abbreviated]["wed"] = "수"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "금"
    @days[:gregorian][:narrow]["mon"] = "월"
    @days[:gregorian][:narrow]["sat"] = "토"
    @days[:gregorian][:narrow]["sun"] = "일"
    @days[:gregorian][:narrow]["thu"] = "목"
    @days[:gregorian][:narrow]["tue"] = "화"
    @days[:gregorian][:narrow]["wed"] = "수"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "금요일"
    @days[:gregorian][:wide]["mon"] = "월요일"
    @days[:gregorian][:wide]["sat"] = "토요일"
    @days[:gregorian][:wide]["sun"] = "일요일"
    @days[:gregorian][:wide]["thu"] = "목요일"
    @days[:gregorian][:wide]["tue"] = "화요일"
    @days[:gregorian][:wide]["wed"] = "수요일"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "서력기원전"
    @era_names[:gregorian]["1"] = "서력기원"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "기원전"
    @era_abbrs[:gregorian]["1"] = "서기"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "yyyy'년' M'월' d'일' EEEE"
    @dateformats[:gregorian]["long"] = "yyyy'년' M'월' d'일' EE"
    ...
    @timeformats[:gregorian]["full"] = "a hh'시' mm'분' ss'초' z"
    @timeformats[:gregorian]["long"] = "a hh'시' mm'분' ss'초'"
    @timeformats[:gregorian]["medium"] = "a hh'시' mm'분'"
    @timeformats[:gregorian]["short"] = "a hh'시' mm'분'"
