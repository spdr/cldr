...
# CLDR version: 1.3
#
# Original file name: common/main/kw.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["10"] = "Hed"
    @months[:gregorian][:abbreviated]["11"] = "Du"
    @months[:gregorian][:abbreviated]["12"] = "Kev"
    @months[:gregorian][:abbreviated]["2"] = "Whe"
    @months[:gregorian][:abbreviated]["3"] = "Mer"
    @months[:gregorian][:abbreviated]["4"] = "Ebr"
    @months[:gregorian][:abbreviated]["5"] = "Me"
    @months[:gregorian][:abbreviated]["6"] = "Efn"
    @months[:gregorian][:abbreviated]["7"] = "Gor"
    @months[:gregorian][:abbreviated]["8"] = "Est"
    @months[:gregorian][:abbreviated]["9"] = "Gwn"
    ...
    @months[:gregorian][:wide]["1"] = "Mys Genver"
    @months[:gregorian][:wide]["10"] = "Mys Hedra"
    @months[:gregorian][:wide]["11"] = "Mys Du"
    @months[:gregorian][:wide]["12"] = "Mys Kevardhu"
    @months[:gregorian][:wide]["2"] = "Mys Whevrel"
    @months[:gregorian][:wide]["3"] = "Mys Merth"
    @months[:gregorian][:wide]["4"] = "Mys Ebrel"
    @months[:gregorian][:wide]["5"] = "Mys Me"
    @months[:gregorian][:wide]["6"] = "Mys Efan"
    @months[:gregorian][:wide]["7"] = "Mys Gortheren"
    @months[:gregorian][:wide]["8"] = "Mye Est"
    @months[:gregorian][:wide]["9"] = "Mys Gwyngala"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Gwe"
    @days[:gregorian][:abbreviated]["mon"] = "Lun"
    @days[:gregorian][:abbreviated]["sat"] = "Sad"
    @days[:gregorian][:abbreviated]["sun"] = "Sul"
    @days[:gregorian][:abbreviated]["thu"] = "Yow"
    @days[:gregorian][:abbreviated]["tue"] = "Mth"
    @days[:gregorian][:abbreviated]["wed"] = "Mhr"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "De Gwener"
    @days[:gregorian][:wide]["mon"] = "De Lun"
    @days[:gregorian][:wide]["sat"] = "De Sadorn"
    @days[:gregorian][:wide]["sun"] = "De Sul"
    @days[:gregorian][:wide]["thu"] = "De Yow"
    @days[:gregorian][:wide]["tue"] = "De Merth"
    @days[:gregorian][:wide]["wed"] = "De Merher"
    @dayformat_defaults = {}
