...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ມ.ກ."
    @months[:gregorian][:abbreviated]["10"] = "ຕ.ລ."
    @months[:gregorian][:abbreviated]["11"] = "ພ.ຈ."
    @months[:gregorian][:abbreviated]["12"] = "ທ.ວ."
    @months[:gregorian][:abbreviated]["2"] = "ກ.ພ."
    @months[:gregorian][:abbreviated]["3"] = "ມີ.ນ."
    @months[:gregorian][:abbreviated]["4"] = "ມ.ສ.."
    @months[:gregorian][:abbreviated]["5"] = "ພ.ພ."
    @months[:gregorian][:abbreviated]["6"] = "ມິ.ຖ."
    @months[:gregorian][:abbreviated]["7"] = "ກ.ລ."
    @months[:gregorian][:abbreviated]["8"] = "ສ.ຫ."
    @months[:gregorian][:abbreviated]["9"] = "ກ.ຍ."
    ...
    @months[:gregorian][:wide]["1"] = "ມັງກອນ"
    @months[:gregorian][:wide]["10"] = "ຕຸລາ"
    @months[:gregorian][:wide]["11"] = "ພະຈິກ"
    @months[:gregorian][:wide]["12"] = "ທັນວາ"
    @months[:gregorian][:wide]["2"] = "ກຸມພາ"
    @months[:gregorian][:wide]["3"] = "ມີນາ"
    @months[:gregorian][:wide]["4"] = "ເມສາ"
    @months[:gregorian][:wide]["5"] = "ພຶດສະພາ"
    @months[:gregorian][:wide]["6"] = "ມິຖຸນາ"
    @months[:gregorian][:wide]["7"] = "ກໍລະກົດ"
    @months[:gregorian][:wide]["8"] = "ສິງຫາ"
    @months[:gregorian][:wide]["9"] = "ກັນຍາ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ສກ."
    @days[:gregorian][:abbreviated]["mon"] = "ຈ."
    @days[:gregorian][:abbreviated]["sat"] = "ສ."
    @days[:gregorian][:abbreviated]["sun"] = "ອາ."
    @days[:gregorian][:abbreviated]["thu"] = "ພຫ."
    @days[:gregorian][:abbreviated]["tue"] = "ອ."
    @days[:gregorian][:abbreviated]["wed"] = "ພ."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ວັນສຸກ"
    @days[:gregorian][:wide]["mon"] = "ວັນຈັນ"
    @days[:gregorian][:wide]["sat"] = "ວັນເສົາ"
    @days[:gregorian][:wide]["sun"] = "ວັນອາທິດ"
    @days[:gregorian][:wide]["thu"] = "ວັນພະຫັດ"
    @days[:gregorian][:wide]["tue"] = "ວັນອັງຄານ"
    @days[:gregorian][:wide]["wed"] = "ວັນພຸດ"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ກ່ອນທ່ຽງ"
    @pm = {}
    @pm["gregorian"] = "ຫລັງທ່ຽງ"
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ປີກ່ອນຄິດສະການທີ່"
    @era_names[:gregorian]["1"] = "ຄິດສະການທີ່"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "ພ.ສ."
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "ປີກ່ອນຄິດສະການທີ່"
    @era_abbrs[:gregorian]["1"] = "ຄ.ສ."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:buddhist]["full"] = "EEEE'ທີ່ 'd MMMM G yyyy"
    ...
    @dateformats[:gregorian]["full"] = "EEEE'ທີ  'd MMMM G yyyy"
    ...
    @timeformats[:buddhist]["full"] = "H' ໂມງ 'm'ນາທີ 'ss' ວິນາທີ'"
    @timeformats[:buddhist]["long"] = "H' ໂມງ 'm'ນາທີ'"
    ...
    @timeformats[:gregorian]["full"] = "H'ໂມງ 'm'ນາທີ 'ss' ວິນາທີ"
    @timeformats[:gregorian]["long"] = "H' ໂມງ 'm'ນາທີ'"
