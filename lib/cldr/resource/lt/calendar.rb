...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Sau"
    @months[:gregorian][:abbreviated]["10"] = "Spl"
    @months[:gregorian][:abbreviated]["11"] = "Lap"
    @months[:gregorian][:abbreviated]["12"] = "Grd"
    @months[:gregorian][:abbreviated]["2"] = "Vas"
    @months[:gregorian][:abbreviated]["3"] = "Kov"
    @months[:gregorian][:abbreviated]["4"] = "Bal"
    @months[:gregorian][:abbreviated]["5"] = "Geg"
    @months[:gregorian][:abbreviated]["6"] = "Bir"
    @months[:gregorian][:abbreviated]["7"] = "Lie"
    @months[:gregorian][:abbreviated]["8"] = "Rgp"
    @months[:gregorian][:abbreviated]["9"] = "Rgs"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "S"
    @months[:gregorian][:narrow]["10"] = "S"
    @months[:gregorian][:narrow]["11"] = "L"
    @months[:gregorian][:narrow]["12"] = "G"
    @months[:gregorian][:narrow]["2"] = "V"
    @months[:gregorian][:narrow]["3"] = "K"
    @months[:gregorian][:narrow]["4"] = "B"
    @months[:gregorian][:narrow]["5"] = "G"
    @months[:gregorian][:narrow]["6"] = "B"
    @months[:gregorian][:narrow]["7"] = "L"
    @months[:gregorian][:narrow]["8"] = "R"
    @months[:gregorian][:narrow]["9"] = "R"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Sausis"
    @months[:gregorian][:wide]["10"] = "Spalis"
    @months[:gregorian][:wide]["11"] = "Lapkritis"
    @months[:gregorian][:wide]["12"] = "Gruodis"
    @months[:gregorian][:wide]["2"] = "Vasaris"
    @months[:gregorian][:wide]["3"] = "Kovas"
    @months[:gregorian][:wide]["4"] = "Balandis"
    @months[:gregorian][:wide]["5"] = "Gegužė"
    @months[:gregorian][:wide]["6"] = "Birželis"
    @months[:gregorian][:wide]["7"] = "Liepa"
    @months[:gregorian][:wide]["8"] = "Rugpjūtis"
    @months[:gregorian][:wide]["9"] = "Rugsėjis"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Pn"
    @days[:gregorian][:abbreviated]["mon"] = "Pr"
    @days[:gregorian][:abbreviated]["sat"] = "Št"
    @days[:gregorian][:abbreviated]["sun"] = "Sk"
    @days[:gregorian][:abbreviated]["thu"] = "Kt"
    @days[:gregorian][:abbreviated]["tue"] = "An"
    @days[:gregorian][:abbreviated]["wed"] = "Tr"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "P"
    @days[:gregorian][:narrow]["mon"] = "P"
    @days[:gregorian][:narrow]["sat"] = "Š"
    @days[:gregorian][:narrow]["sun"] = "S"
    @days[:gregorian][:narrow]["thu"] = "K"
    @days[:gregorian][:narrow]["tue"] = "A"
    @days[:gregorian][:narrow]["wed"] = "T"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "penktadienis"
    @days[:gregorian][:wide]["mon"] = "pirmadienis"
    @days[:gregorian][:wide]["sat"] = "šeštadienis"
    @days[:gregorian][:wide]["sun"] = "sekmadienis"
    @days[:gregorian][:wide]["thu"] = "ketvirtadienis"
    @days[:gregorian][:wide]["tue"] = "antradienis"
    @days[:gregorian][:wide]["wed"] = "trečiadienis"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "pr. Kr."
    @era_abbrs[:gregorian]["1"] = "po Kr."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "yyyy 'm.' MMMM d 'd.',EEEE"
    @dateformats[:gregorian]["long"] = "yyyy 'm.' MMMM d 'd.'"
