...
#
  ...
  def init_data
    ...
    @after_insertbetween = " "
    @currencies = {}
    @currencies["BRL"] = "Brazilijos realas"
    @currencies["CNY"] = "Ženminbi juanis"
    @currencies["EUR"] = "Euras"
    @currencies["GBP"] = "Svaras sterlingų"
    @currencies["INR"] = "Indijos rupija"
    @currencies["ITL"] = "ITL"
    @currencies["JPY"] = "Jena"
    @currencies["LTL"] = "Litas"
    @currencies["RUB"] = "Rusijos rublis"
    @currencies["USD"] = "JAV doleris"
    @symbols = {}
    @symbols["EUR"] = "€"
    @symbols["GBP"] = "£"
