...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["6"] = "Jūn"
    @months[:gregorian][:abbreviated]["7"] = "Jūl"
    ...
    @months[:gregorian][:wide]["1"] = "janvāris"
    @months[:gregorian][:wide]["10"] = "oktobris"
    @months[:gregorian][:wide]["11"] = "novembris"
    @months[:gregorian][:wide]["12"] = "decembris"
    @months[:gregorian][:wide]["2"] = "februāris"
    @months[:gregorian][:wide]["3"] = "marts"
    @months[:gregorian][:wide]["4"] = "aprīlis"
    @months[:gregorian][:wide]["5"] = "maijs"
    @months[:gregorian][:wide]["6"] = "jūnijs"
    @months[:gregorian][:wide]["7"] = "jūlijs"
    @months[:gregorian][:wide]["8"] = "augusts"
    @months[:gregorian][:wide]["9"] = "septembris"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Pk"
    @days[:gregorian][:abbreviated]["mon"] = "P"
    @days[:gregorian][:abbreviated]["sat"] = "S"
    @days[:gregorian][:abbreviated]["sun"] = "Sv"
    @days[:gregorian][:abbreviated]["thu"] = "C"
    @days[:gregorian][:abbreviated]["tue"] = "O"
    @days[:gregorian][:abbreviated]["wed"] = "T"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "piektdiena"
    @days[:gregorian][:wide]["mon"] = "pirmdiena"
    @days[:gregorian][:wide]["sat"] = "sestdiena"
    @days[:gregorian][:wide]["sun"] = "svētdiena"
    @days[:gregorian][:wide]["thu"] = "ceturtdiena"
    @days[:gregorian][:wide]["tue"] = "otrdiena"
    @days[:gregorian][:wide]["wed"] = "trešdiena"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "pirms mūsu ēras"
    @era_names[:gregorian]["1"] = "mūsu ērā"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "pmē"
    @era_abbrs[:gregorian]["1"] = "mē"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, yyyy'. gada 'd. MMMM"
    @dateformats[:gregorian]["long"] = "yyyy'. gada 'd. MMMM"
    @dateformats[:gregorian]["medium"] = "yyyy.d.M"
    @dateformats[:gregorian]["short"] = "yy.d.M"
