...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["11"] = "ноем."
    @months[:gregorian][:abbreviated]["12"] = "декем."
    ...
    @months[:gregorian][:narrow]["9"] = "се"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "јануари"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "петок"
    @days[:gregorian][:wide]["mon"] = "понеделник"
    @days[:gregorian][:wide]["sat"] = "сабота"
    @days[:gregorian][:wide]["sun"] = "недела"
    @days[:gregorian][:wide]["thu"] = "четврток"
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "пр.н.е."
    @era_abbrs[:gregorian]["1"] = "ае."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["medium"] = "dd.M.yyyy"
    @dateformats[:gregorian]["short"] = "dd.M.yy"
