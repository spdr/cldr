...
# CLDR version: 1.3
#
# Original file name: common/main/mn_MN.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "хул"
    @months[:gregorian][:abbreviated]["10"] = "тах"
    @months[:gregorian][:abbreviated]["11"] = "нох"
    @months[:gregorian][:abbreviated]["12"] = "гах"
    @months[:gregorian][:abbreviated]["2"] = "үхэ"
    @months[:gregorian][:abbreviated]["3"] = "бар"
    @months[:gregorian][:abbreviated]["4"] = "туу"
    @months[:gregorian][:abbreviated]["5"] = "луу"
    @months[:gregorian][:abbreviated]["6"] = "мог"
    @months[:gregorian][:abbreviated]["7"] = "мор"
    @months[:gregorian][:abbreviated]["8"] = "хон"
    @months[:gregorian][:abbreviated]["9"] = "бич"
    ...
    @months[:gregorian][:wide]["1"] = "Хулгана"
    @months[:gregorian][:wide]["10"] = "Тахиа"
    @months[:gregorian][:wide]["11"] = "Нохой"
    @months[:gregorian][:wide]["12"] = "Гахай"
    @months[:gregorian][:wide]["2"] = "Үхэр"
    @months[:gregorian][:wide]["3"] = "Бар"
    @months[:gregorian][:wide]["4"] = "Туулай"
    @months[:gregorian][:wide]["5"] = "Луу"
    @months[:gregorian][:wide]["6"] = "Могой"
    @months[:gregorian][:wide]["7"] = "Морь"
    @months[:gregorian][:wide]["8"] = "Хонь"
    @months[:gregorian][:wide]["9"] = "Бич"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Ба"
    @days[:gregorian][:abbreviated]["mon"] = "Да"
    @days[:gregorian][:abbreviated]["sat"] = "Бя"
    @days[:gregorian][:abbreviated]["sun"] = "Ня"
    @days[:gregorian][:abbreviated]["thu"] = "Пү"
    @days[:gregorian][:abbreviated]["tue"] = "Мя"
    @days[:gregorian][:abbreviated]["wed"] = "Лх"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "баасан"
    @days[:gregorian][:wide]["mon"] = "даваа"
    @days[:gregorian][:wide]["sat"] = "бямба"
    @days[:gregorian][:wide]["sun"] = "ням"
    @days[:gregorian][:wide]["thu"] = "пүрэв"
    @days[:gregorian][:wide]["tue"] = "мягмар"
    @days[:gregorian][:wide]["wed"] = "лхагва"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "манай эриний өмнөх"
    @era_names[:gregorian]["1"] = "манай эриний"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "м.э.ө"
    @era_abbrs[:gregorian]["1"] = "м.э."
    @era_abbrs[:hebrew] = {}
