...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["12"] = "Dis"
    ...
    @months[:gregorian][:abbreviated]["8"] = "Ogos"
    ...
    @days[:gregorian][:abbreviated]["sun"] = "Ahd"
    @days[:gregorian][:abbreviated]["thu"] = "Kha"
    @days[:gregorian][:abbreviated]["tue"] = "Sel"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jumaat"
    @days[:gregorian][:wide]["mon"] = "Isnin"
    @days[:gregorian][:wide]["sat"] = "Sabtu"
    @days[:gregorian][:wide]["sun"] = "Ahad"
    @days[:gregorian][:wide]["thu"] = "Khamis"
    @days[:gregorian][:wide]["tue"] = "Selasa"
    @days[:gregorian][:wide]["wed"] = "Rabu"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "S.M."
    @era_abbrs[:gregorian]["1"] = "T.M."
    @era_abbrs[:hebrew] = {}
    ...
    @timeformats[:gregorian]["full"] = "h:mm:ss aa"
