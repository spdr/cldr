...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["12"] = "Diċ"
    @months[:gregorian][:abbreviated]["2"] = "Fra"
    @months[:gregorian][:abbreviated]["3"] = "Mar"
    @months[:gregorian][:abbreviated]["4"] = "Apr"
    @months[:gregorian][:abbreviated]["5"] = "Mej"
    @months[:gregorian][:abbreviated]["6"] = "Ġun"
    @months[:gregorian][:abbreviated]["7"] = "Lul"
    @months[:gregorian][:abbreviated]["8"] = "Awi"
    ...
    @months[:gregorian][:wide]["1"] = "Jannar"
    @months[:gregorian][:wide]["10"] = "Ottubru"
    @months[:gregorian][:wide]["11"] = "Novembru"
    @months[:gregorian][:wide]["12"] = "Diċembru"
    @months[:gregorian][:wide]["2"] = "Frar"
    @months[:gregorian][:wide]["3"] = "Marzu"
    @months[:gregorian][:wide]["4"] = "April"
    @months[:gregorian][:wide]["5"] = "Mejju"
    @months[:gregorian][:wide]["6"] = "Ġunju"
    @months[:gregorian][:wide]["7"] = "Lulju"
    @months[:gregorian][:wide]["8"] = "Awissu"
    @months[:gregorian][:wide]["9"] = "Settembru"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Ġim"
    @days[:gregorian][:abbreviated]["mon"] = "Tne"
    @days[:gregorian][:abbreviated]["sat"] = "Sib"
    @days[:gregorian][:abbreviated]["sun"] = "Ħad"
    @days[:gregorian][:abbreviated]["thu"] = "Ħam"
    @days[:gregorian][:abbreviated]["tue"] = "Tli"
    @days[:gregorian][:abbreviated]["wed"] = "Erb"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Il-Ġimgħa"
    @days[:gregorian][:wide]["mon"] = "It-Tnejn"
    @days[:gregorian][:wide]["sat"] = "Is-Sibt"
    @days[:gregorian][:wide]["sun"] = "Il-Ħadd"
    @days[:gregorian][:wide]["thu"] = "Il-Ħamis"
    @days[:gregorian][:wide]["tue"] = "It-Tlieta"
    @days[:gregorian][:wide]["wed"] = "L-Erbgħa"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "QK"
    @era_abbrs[:gregorian]["1"] = "WK"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, d 'ta’' MMMM yyyy"
    @dateformats[:gregorian]["long"] = "d 'ta’' MMMM yyyy"
