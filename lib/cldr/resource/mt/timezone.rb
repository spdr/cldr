...
#
  ...
  def init_data
    ...
    @exemplarcities = {}
    @exemplarcities["Europe/Malta"] = "Valletta"
    @long_generics = {}
    @long_standards = {}
    @long_standards["Europe/Malta"] = "Ħin Ċentrali Ewropew"
    @long_daylights = {}
    @long_daylights["Europe/Malta"] = "Ħin Ċentrali Ewropew tas-Sajf"
    @short_generics = {}
    @short_standards = {}
    @short_standards["Europe/Malta"] = "CET"
    @short_daylights = {}
    @short_daylights["Europe/Malta"] = "CEST"
  end
