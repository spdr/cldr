...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["4"] = "april"
    @months[:gregorian][:abbreviated]["5"] = "mai"
    @months[:gregorian][:abbreviated]["6"] = "juni"
    @months[:gregorian][:abbreviated]["7"] = "juli"
    ...
    @days[:gregorian][:abbreviated]["sat"] = "lø."
    @days[:gregorian][:abbreviated]["sun"] = "sø."
    @days[:gregorian][:abbreviated]["thu"] = "to."
    @days[:gregorian][:abbreviated]["tue"] = "ti."
    @days[:gregorian][:abbreviated]["wed"] = "on."
