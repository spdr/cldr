...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["3"] = "mrt"
    @months[:gregorian][:abbreviated]["4"] = "apr"
    @months[:gregorian][:abbreviated]["5"] = "mei"
    ...
    @months[:gregorian][:wide]["1"] = "januari"
    @months[:gregorian][:wide]["10"] = "oktober"
    @months[:gregorian][:wide]["11"] = "november"
    @months[:gregorian][:wide]["12"] = "december"
    @months[:gregorian][:wide]["2"] = "februari"
    @months[:gregorian][:wide]["3"] = "maart"
    @months[:gregorian][:wide]["4"] = "april"
    @months[:gregorian][:wide]["5"] = "mei"
    @months[:gregorian][:wide]["6"] = "juni"
    @months[:gregorian][:wide]["7"] = "juli"
    @months[:gregorian][:wide]["8"] = "augustus"
    @months[:gregorian][:wide]["9"] = "september"
    @months[:hebrew] = {}
    @months[:hebrew][:abbreviated] = {}
    @months[:hebrew][:abbreviated]["1"] = "Tisjrie"
    @months[:hebrew][:abbreviated]["10"] = "Sivan"
    @months[:hebrew][:abbreviated]["11"] = "Tammoez"
    @months[:hebrew][:abbreviated]["12"] = "Av"
    @months[:hebrew][:abbreviated]["13"] = "Elloel"
    @months[:hebrew][:abbreviated]["2"] = "Chesjwan"
    @months[:hebrew][:abbreviated]["3"] = "Kislev"
    @months[:hebrew][:abbreviated]["4"] = "Tevet"
    @months[:hebrew][:abbreviated]["5"] = "Sjevat"
    @months[:hebrew][:abbreviated]["6"] = "Adar"
    @months[:hebrew][:abbreviated]["7"] = "Adar B"
    @months[:hebrew][:abbreviated]["8"] = "Nisan"
    @months[:hebrew][:abbreviated]["9"] = "Ijar"
    @months[:hebrew][:wide] = {}
    @months[:hebrew][:wide]["1"] = "Tisjrie"
    @months[:hebrew][:wide]["10"] = "Sivan"
    @months[:hebrew][:wide]["11"] = "Tammoez"
    @months[:hebrew][:wide]["12"] = "Av"
    @months[:hebrew][:wide]["13"] = "Elloel"
    @months[:hebrew][:wide]["2"] = "Chesjwan"
    @months[:hebrew][:wide]["3"] = "Kislev"
    @months[:hebrew][:wide]["4"] = "Tevet"
    @months[:hebrew][:wide]["5"] = "Sjevat"
    @months[:hebrew][:wide]["6"] = "Adar"
    @months[:hebrew][:wide]["7"] = "Adar B"
    @months[:hebrew][:wide]["8"] = "Nisan"
    @months[:hebrew][:wide]["9"] = "Ijar"
    @months[:islamic_civil] = {}
    @months[:islamic_civil][:abbreviated] = {}
    @months[:islamic_civil][:abbreviated]["1"] = "Moeharram"
    @months[:islamic_civil][:abbreviated]["10"] = "Sjawal"
    @months[:islamic_civil][:abbreviated]["11"] = "Doe al kaʻaba"
    @months[:islamic_civil][:abbreviated]["12"] = "Doe al hizja"
    @months[:islamic_civil][:abbreviated]["2"] = "Safar"
    @months[:islamic_civil][:abbreviated]["3"] = "Rabiʻa al awal"
    @months[:islamic_civil][:abbreviated]["4"] = "Rabiʻa al thani"
    @months[:islamic_civil][:abbreviated]["5"] = "Joemadʻal awal"
    @months[:islamic_civil][:abbreviated]["6"] = "Joemadʻal thani"
    @months[:islamic_civil][:abbreviated]["7"] = "Rajab"
    @months[:islamic_civil][:abbreviated]["8"] = "Sjaʻaban"
    @months[:islamic_civil][:abbreviated]["9"] = "Ramadan"
    @months[:islamic_civil][:wide] = {}
    @months[:islamic_civil][:wide]["1"] = "Moeharram"
    @months[:islamic_civil][:wide]["10"] = "Sjawal"
    @months[:islamic_civil][:wide]["11"] = "Doe al kaʻaba"
    @months[:islamic_civil][:wide]["12"] = "Doe al hizja"
    @months[:islamic_civil][:wide]["2"] = "Safar"
    @months[:islamic_civil][:wide]["3"] = "Rabiʻa al awal"
    @months[:islamic_civil][:wide]["4"] = "Rabiʻa al thani"
    @months[:islamic_civil][:wide]["5"] = "Joemadʻal awal"
    @months[:islamic_civil][:wide]["6"] = "Joemadʻal thani"
    @months[:islamic_civil][:wide]["7"] = "Rajab"
    @months[:islamic_civil][:wide]["8"] = "Sjaʻaban"
    @months[:islamic_civil][:wide]["9"] = "Ramadan"
    @months[:islamic] = {}
    @months[:islamic][:abbreviated] = {}
    @months[:islamic][:abbreviated]["1"] = "Moeharram"
    @months[:islamic][:abbreviated]["10"] = "Sjawal"
    @months[:islamic][:abbreviated]["11"] = "Doe al kaʻaba"
    @months[:islamic][:abbreviated]["12"] = "Doe al hizja"
    @months[:islamic][:abbreviated]["2"] = "Safar"
    @months[:islamic][:abbreviated]["3"] = "Rabiʻa al awal"
    @months[:islamic][:abbreviated]["4"] = "Rabiʻa al thani"
    @months[:islamic][:abbreviated]["5"] = "Joemadʻal awal"
    @months[:islamic][:abbreviated]["6"] = "Joemadʻal thani"
    @months[:islamic][:abbreviated]["7"] = "Rajab"
    @months[:islamic][:abbreviated]["8"] = "Sjaʻaban"
    @months[:islamic][:abbreviated]["9"] = "Ramadan"
    @months[:islamic][:wide] = {}
    @months[:islamic][:wide]["1"] = "Moeharram"
    @months[:islamic][:wide]["10"] = "Sjawal"
    @months[:islamic][:wide]["11"] = "Doe al kaʻaba"
    @months[:islamic][:wide]["12"] = "Doe al hizja"
    @months[:islamic][:wide]["2"] = "Safar"
    @months[:islamic][:wide]["3"] = "Rabiʻa al awal"
    @months[:islamic][:wide]["4"] = "Rabiʻa al thani"
    @months[:islamic][:wide]["5"] = "Joemadʻal awal"
    @months[:islamic][:wide]["6"] = "Joemadʻal thani"
    @months[:islamic][:wide]["7"] = "Rajab"
    @months[:islamic][:wide]["8"] = "Sjaʻaban"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "vr"
    @days[:gregorian][:abbreviated]["mon"] = "ma"
    @days[:gregorian][:abbreviated]["sat"] = "za"
    @days[:gregorian][:abbreviated]["sun"] = "zo"
    @days[:gregorian][:abbreviated]["thu"] = "do"
    @days[:gregorian][:abbreviated]["tue"] = "di"
    @days[:gregorian][:abbreviated]["wed"] = "wo"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "V"
    @days[:gregorian][:narrow]["mon"] = "M"
    @days[:gregorian][:narrow]["sat"] = "Z"
    @days[:gregorian][:narrow]["sun"] = "Z"
    @days[:gregorian][:narrow]["thu"] = "D"
    @days[:gregorian][:narrow]["tue"] = "D"
    @days[:gregorian][:narrow]["wed"] = "W"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "vrijdag"
    @days[:gregorian][:wide]["mon"] = "maandag"
    @days[:gregorian][:wide]["sat"] = "zaterdag"
    @days[:gregorian][:wide]["sun"] = "zondag"
    @days[:gregorian][:wide]["thu"] = "donderdag"
    @days[:gregorian][:wide]["tue"] = "dinsdag"
    @days[:gregorian][:wide]["wed"] = "woensdag"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "v. Chr."
    @era_abbrs[:gregorian]["1"] = "n. Chr."
    @era_abbrs[:hebrew] = {}
    @era_abbrs[:hebrew]["0"] = "AM"
    @era_abbrs[:islamic_civil] = {}
    @era_abbrs[:islamic_civil]["0"] = "Saʻna Hizjria"
    @era_abbrs[:islamic] = {}
    @era_abbrs[:islamic]["0"] = "Saʻna Hizjria"
    @era_abbrs[:japanese] = {}
    ...
    @dateformats[:gregorian]["medium"] = "d-MMM-yyyy"
    ...
    @timeformats[:gregorian]["full"] = "H:mm:ss' uur' z"
