...
#
  ...
  def init_data
    ...
    @days[:gregorian][:wide]["sat"] = "laurdag"
    @days[:gregorian][:wide]["sun"] = "sundag"
    @days[:gregorian][:wide]["thu"] = "torsdag"
    @days[:gregorian][:wide]["tue"] = "tysdag"
