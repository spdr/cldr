...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Ama"
    @months[:gregorian][:abbreviated]["10"] = "Onk"
    @months[:gregorian][:abbreviated]["11"] = "Sad"
    @months[:gregorian][:abbreviated]["12"] = "Mud"
    @months[:gregorian][:abbreviated]["2"] = "Gur"
    @months[:gregorian][:abbreviated]["3"] = "Bit"
    @months[:gregorian][:abbreviated]["4"] = "Elb"
    @months[:gregorian][:abbreviated]["5"] = "Cam"
    @months[:gregorian][:abbreviated]["6"] = "Wax"
    @months[:gregorian][:abbreviated]["7"] = "Ado"
    @months[:gregorian][:abbreviated]["8"] = "Hag"
    @months[:gregorian][:abbreviated]["9"] = "Ful"
    ...
    @months[:gregorian][:wide]["1"] = "Amajjii"
    @months[:gregorian][:wide]["10"] = "Onkololeessa"
    @months[:gregorian][:wide]["11"] = "Sadaasa"
    @months[:gregorian][:wide]["12"] = "Muddee"
    @months[:gregorian][:wide]["2"] = "Guraandhala"
    @months[:gregorian][:wide]["3"] = "Bitooteessa"
    @months[:gregorian][:wide]["4"] = "Elba"
    @months[:gregorian][:wide]["5"] = "Caamsa"
    @months[:gregorian][:wide]["6"] = "Waxabajjii"
    @months[:gregorian][:wide]["7"] = "Adooleessa"
    @months[:gregorian][:wide]["8"] = "Hagayya"
    @months[:gregorian][:wide]["9"] = "Fuulbana"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["mon"] = "Wix"
    @days[:gregorian][:abbreviated]["sat"] = "San"
    @days[:gregorian][:abbreviated]["sun"] = "Dil"
    @days[:gregorian][:abbreviated]["thu"] = "Kam"
    @days[:gregorian][:abbreviated]["tue"] = "Qib"
    @days[:gregorian][:abbreviated]["wed"] = "Rob"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "F"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jimaata"
    @days[:gregorian][:wide]["mon"] = "Wiixata"
    @days[:gregorian][:wide]["sat"] = "Sanbata"
    @days[:gregorian][:wide]["sun"] = "Dilbata"
    @days[:gregorian][:wide]["thu"] = "Kamiisa"
    @days[:gregorian][:wide]["tue"] = "Qibxata"
    @days[:gregorian][:wide]["wed"] = "Roobii"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "KD"
    @era_abbrs[:gregorian]["1"] = "KB"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, MMMM d, yyyy"
