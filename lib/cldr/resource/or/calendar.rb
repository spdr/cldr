...
# CLDR version: 1.3
#
# Original file name: common/main/or.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "1"
    @months[:gregorian][:abbreviated]["10"] = "10"
    @months[:gregorian][:abbreviated]["11"] = "11"
    @months[:gregorian][:abbreviated]["12"] = "12"
    @months[:gregorian][:abbreviated]["2"] = "2"
    @months[:gregorian][:abbreviated]["3"] = "3"
    @months[:gregorian][:abbreviated]["4"] = "4"
    @months[:gregorian][:abbreviated]["5"] = "5"
    @months[:gregorian][:abbreviated]["6"] = "6"
    @months[:gregorian][:abbreviated]["7"] = "7"
    @months[:gregorian][:abbreviated]["8"] = "8"
    @months[:gregorian][:abbreviated]["9"] = "9"
    ...
    @months[:gregorian][:wide]["1"] = "ଜାନୁଆରୀ"
    @months[:gregorian][:wide]["10"] = "ଅକ୍ଟୋବର"
    @months[:gregorian][:wide]["11"] = "ନଭେମ୍ବର"
    @months[:gregorian][:wide]["12"] = "ଡିସେମ୍ବର"
    @months[:gregorian][:wide]["2"] = "ଫେବ୍ରୁୟାରୀ"
    @months[:gregorian][:wide]["3"] = "ମାର୍ଚ୍ଚ"
    @months[:gregorian][:wide]["4"] = "ଅପ୍ରେଲ"
    @months[:gregorian][:wide]["5"] = "ମେ"
    @months[:gregorian][:wide]["6"] = "ଜୁନ"
    @months[:gregorian][:wide]["7"] = "ଜୁଲାଇ"
    @months[:gregorian][:wide]["8"] = "ଅଗଷ୍ଟ"
    @months[:gregorian][:wide]["9"] = "ସେପ୍ଟେମ୍ବର"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ଶୁକ୍ର"
    @days[:gregorian][:abbreviated]["mon"] = "ସୋମ"
    @days[:gregorian][:abbreviated]["sat"] = "ଶନି"
    @days[:gregorian][:abbreviated]["sun"] = "ରବି"
    @days[:gregorian][:abbreviated]["thu"] = "ଗୁରୁ"
    @days[:gregorian][:abbreviated]["tue"] = "ମଙ୍ଗଳ"
    @days[:gregorian][:abbreviated]["wed"] = "ବୁଧ"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ଶୁକ୍ରବାର"
    @days[:gregorian][:wide]["mon"] = "ସୋମବାର"
    @days[:gregorian][:wide]["sat"] = "ଶନିବାର"
    @days[:gregorian][:wide]["sun"] = "ରବିବାର"
    @days[:gregorian][:wide]["thu"] = "ଗୁରୁବାର"
    @days[:gregorian][:wide]["tue"] = "ମଙ୍ଗଳବାର"
    @days[:gregorian][:wide]["wed"] = "ବୁଧବାର"
    @dayformat_defaults = {}
