...
# CLDR version: 1.3
#
# Original file name: common/main/pa.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ਜਨਵਰੀ"
    @months[:gregorian][:abbreviated]["10"] = "ਅਕਤੂਬਰ"
    @months[:gregorian][:abbreviated]["11"] = "ਨਵੰਬਰ"
    @months[:gregorian][:abbreviated]["12"] = "ਦਸੰਬਰ"
    @months[:gregorian][:abbreviated]["2"] = "ਫ਼ਰਵਰੀ"
    @months[:gregorian][:abbreviated]["3"] = "ਮਾਰਚ"
    @months[:gregorian][:abbreviated]["4"] = "ਅਪ੍ਰੈਲ"
    @months[:gregorian][:abbreviated]["5"] = "ਮਈ"
    @months[:gregorian][:abbreviated]["6"] = "ਜੂਨ"
    @months[:gregorian][:abbreviated]["7"] = "ਜੁਲਾਈ"
    @months[:gregorian][:abbreviated]["8"] = "ਅਗਸਤ"
    @months[:gregorian][:abbreviated]["9"] = "ਸਤੰਬਰ"
    ...
    @months[:gregorian][:wide]["1"] = "ਜਨਵਰੀ"
    @months[:gregorian][:wide]["10"] = "ਅਕਤੂਬਰ"
    @months[:gregorian][:wide]["11"] = "ਨਵੰਬਰ"
    @months[:gregorian][:wide]["12"] = "ਦਸੰਬਰ"
    @months[:gregorian][:wide]["2"] = "ਫ਼ਰਵਰੀ"
    @months[:gregorian][:wide]["3"] = "ਮਾਰਚ"
    @months[:gregorian][:wide]["4"] = "ਅਪ੍ਰੈਲ"
    @months[:gregorian][:wide]["5"] = "ਮਈ"
    @months[:gregorian][:wide]["6"] = "ਜੂਨ"
    @months[:gregorian][:wide]["7"] = "ਜੁਲਾਈ"
    @months[:gregorian][:wide]["8"] = "ਅਗਸਤ"
    @months[:gregorian][:wide]["9"] = "ਸਤੰਬਰ"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ਸ਼ੁਕਰ."
    @days[:gregorian][:abbreviated]["mon"] = "ਸੋਮ."
    @days[:gregorian][:abbreviated]["sat"] = "ਸ਼ਨੀ."
    @days[:gregorian][:abbreviated]["sun"] = "ਐਤ."
    @days[:gregorian][:abbreviated]["thu"] = "ਵੀਰ."
    @days[:gregorian][:abbreviated]["tue"] = "ਮੰਗਲ."
    @days[:gregorian][:abbreviated]["wed"] = "ਬੁਧ."
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ਸ਼ੁੱਕਰਵਾਰ"
    @days[:gregorian][:wide]["mon"] = "ਸੋਮਵਾਰ"
    @days[:gregorian][:wide]["sat"] = "ਸ਼ਨੀਚਰਵਾਰ"
    @days[:gregorian][:wide]["sun"] = "ਐਤਵਾਰ"
    @days[:gregorian][:wide]["thu"] = "ਵੀਰਵਾਰ"
    @days[:gregorian][:wide]["tue"] = "ਮੰਗਲਵਾਰ"
    @days[:gregorian][:wide]["wed"] = "ਬੁਧਵਾਰ"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ਈਸਾਪੂਰ੍ਵ."
    @era_names[:gregorian]["1"] = "ਸਨ."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
