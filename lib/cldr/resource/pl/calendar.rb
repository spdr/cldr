...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "st"
    @months[:gregorian][:abbreviated]["10"] = "paź"
    @months[:gregorian][:abbreviated]["11"] = "lis"
    @months[:gregorian][:abbreviated]["12"] = "gr"
    @months[:gregorian][:abbreviated]["2"] = "lut"
    @months[:gregorian][:abbreviated]["3"] = "mrz"
    @months[:gregorian][:abbreviated]["4"] = "kw"
    @months[:gregorian][:abbreviated]["5"] = "maj"
    @months[:gregorian][:abbreviated]["6"] = "cz"
    @months[:gregorian][:abbreviated]["7"] = "lip"
    @months[:gregorian][:abbreviated]["8"] = "sier"
    @months[:gregorian][:abbreviated]["9"] = "wrz"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "s"
    @months[:gregorian][:narrow]["10"] = "p"
    @months[:gregorian][:narrow]["11"] = "l"
    @months[:gregorian][:narrow]["12"] = "g"
    @months[:gregorian][:narrow]["2"] = "l"
    @months[:gregorian][:narrow]["3"] = "m"
    @months[:gregorian][:narrow]["4"] = "k"
    @months[:gregorian][:narrow]["5"] = "m"
    @months[:gregorian][:narrow]["6"] = "c"
    @months[:gregorian][:narrow]["7"] = "l"
    @months[:gregorian][:narrow]["8"] = "s"
    @months[:gregorian][:narrow]["9"] = "w"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "styczeń"
    @months[:gregorian][:wide]["10"] = "październik"
    @months[:gregorian][:wide]["11"] = "listopad"
    @months[:gregorian][:wide]["12"] = "grudzień"
    @months[:gregorian][:wide]["2"] = "luty"
    @months[:gregorian][:wide]["3"] = "marzec"
    @months[:gregorian][:wide]["4"] = "kwiecień"
    @months[:gregorian][:wide]["5"] = "maj"
    @months[:gregorian][:wide]["6"] = "czerwiec"
    @months[:gregorian][:wide]["7"] = "lipiec"
    @months[:gregorian][:wide]["8"] = "sierpień"
    @months[:gregorian][:wide]["9"] = "wrzesień"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "pt."
    @days[:gregorian][:abbreviated]["mon"] = "pon."
    @days[:gregorian][:abbreviated]["sat"] = "sob."
    @days[:gregorian][:abbreviated]["sun"] = "niedz."
    @days[:gregorian][:abbreviated]["thu"] = "czw."
    @days[:gregorian][:abbreviated]["tue"] = "wt."
    @days[:gregorian][:abbreviated]["wed"] = "śr."
    ...
    @days[:gregorian][:narrow]["tue"] = "W"
    @days[:gregorian][:narrow]["wed"] = "Ś"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "piątek"
    @days[:gregorian][:wide]["mon"] = "poniedziałek"
    @days[:gregorian][:wide]["sat"] = "sobota"
    @days[:gregorian][:wide]["sun"] = "niedziela"
    @days[:gregorian][:wide]["thu"] = "czwartek"
    @days[:gregorian][:wide]["tue"] = "wtorek"
    @days[:gregorian][:wide]["wed"] = "środa"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "p.n.e."
    @era_abbrs[:gregorian]["1"] = "n.e."
    @era_abbrs[:hebrew] = {}
