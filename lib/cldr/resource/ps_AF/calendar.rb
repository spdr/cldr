...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["8"] = "اګس"
    ...
    @dateformats[:gregorian]["full"] = "EEEE د yyyy د MMMM d"
    @dateformats[:gregorian]["long"] = "د yyyy د MMMM d"
