...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["10"] = "out"
    @months[:gregorian][:abbreviated]["11"] = "nov"
    @months[:gregorian][:abbreviated]["12"] = "dez"
    @months[:gregorian][:abbreviated]["2"] = "fev"
    ...
    @months[:gregorian][:abbreviated]["9"] = "set"
    ...
    @months[:gregorian][:wide]["1"] = "janeiro"
    @months[:gregorian][:wide]["10"] = "outubro"
    @months[:gregorian][:wide]["11"] = "novembro"
    @months[:gregorian][:wide]["12"] = "dezembro"
    @months[:gregorian][:wide]["2"] = "fevereiro"
    @months[:gregorian][:wide]["3"] = "março"
    @months[:gregorian][:wide]["4"] = "abril"
    @months[:gregorian][:wide]["5"] = "maio"
    @months[:gregorian][:wide]["6"] = "junho"
    @months[:gregorian][:wide]["7"] = "julho"
    @months[:gregorian][:wide]["8"] = "agosto"
    @months[:gregorian][:wide]["9"] = "setembro"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "sex"
    @days[:gregorian][:abbreviated]["mon"] = "seg"
    @days[:gregorian][:abbreviated]["sat"] = "sáb"
    @days[:gregorian][:abbreviated]["sun"] = "dom"
    @days[:gregorian][:abbreviated]["thu"] = "qui"
    @days[:gregorian][:abbreviated]["tue"] = "ter"
    @days[:gregorian][:abbreviated]["wed"] = "qua"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "S"
    @days[:gregorian][:narrow]["mon"] = "S"
    @days[:gregorian][:narrow]["sat"] = "S"
    @days[:gregorian][:narrow]["sun"] = "D"
    @days[:gregorian][:narrow]["thu"] = "Q"
    @days[:gregorian][:narrow]["tue"] = "T"
    @days[:gregorian][:narrow]["wed"] = "Q"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "sexta-feira"
    @days[:gregorian][:wide]["mon"] = "segunda-feira"
    @days[:gregorian][:wide]["sat"] = "sábado"
    @days[:gregorian][:wide]["sun"] = "domingo"
    @days[:gregorian][:wide]["thu"] = "quinta-feira"
    @days[:gregorian][:wide]["tue"] = "terça-feira"
    @days[:gregorian][:wide]["wed"] = "quarta-feira"
    @dayformat_defaults = {}
    ...
    @timeformats[:gregorian]["full"] = "HH'H'mm'm'ss's' z"
