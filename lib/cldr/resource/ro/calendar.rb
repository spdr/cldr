...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Ian"
    ...
    @months[:gregorian][:abbreviated]["6"] = "Iun"
    @months[:gregorian][:abbreviated]["7"] = "Iul"
    ...
    @months[:gregorian][:wide]["1"] = "ianuarie"
    @months[:gregorian][:wide]["10"] = "octombrie"
    @months[:gregorian][:wide]["11"] = "noiembrie"
    @months[:gregorian][:wide]["12"] = "decembrie"
    @months[:gregorian][:wide]["2"] = "februarie"
    @months[:gregorian][:wide]["3"] = "martie"
    @months[:gregorian][:wide]["4"] = "aprilie"
    @months[:gregorian][:wide]["5"] = "mai"
    @months[:gregorian][:wide]["6"] = "iunie"
    @months[:gregorian][:wide]["7"] = "iulie"
    @months[:gregorian][:wide]["8"] = "august"
    @months[:gregorian][:wide]["9"] = "septembrie"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "V"
    @days[:gregorian][:abbreviated]["mon"] = "L"
    @days[:gregorian][:abbreviated]["sat"] = "S"
    @days[:gregorian][:abbreviated]["sun"] = "D"
    @days[:gregorian][:abbreviated]["thu"] = "J"
    @days[:gregorian][:abbreviated]["tue"] = "Ma"
    @days[:gregorian][:abbreviated]["wed"] = "Mi"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "vineri"
    @days[:gregorian][:wide]["mon"] = "luni"
    @days[:gregorian][:wide]["sat"] = "sîmbătă"
    @days[:gregorian][:wide]["sun"] = "duminică"
    @days[:gregorian][:wide]["thu"] = "joi"
    @days[:gregorian][:wide]["tue"] = "marţi"
    @days[:gregorian][:wide]["wed"] = "miercuri"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "d.C."
    @era_abbrs[:gregorian]["1"] = "î.d.C."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "d MMMM yyyy"
