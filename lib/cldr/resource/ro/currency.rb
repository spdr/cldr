...
#
  ...
  def init_data
    ...
    @after_insertbetween = " "
    @currencies = {}
    @currencies["BRL"] = "Real brazilian"
    @currencies["CNY"] = "Yuan Renminbi chinezesc"
    @currencies["EUR"] = "EUR"
    @currencies["GBP"] = "Liră sterlină britanică"
    @currencies["INR"] = "Rupie indiană"
    @currencies["ITL"] = "ITL"
    @currencies["JPY"] = "Yen japonez"
    @currencies["RUB"] = "Rublă rusească"
    @currencies["TRY"] = "Noua liră turcească"
    @currencies["USD"] = "Dolar SUA"
    @symbols = {}
    @symbols["EUR"] = "€"
    @symbols["GBP"] = "£"
