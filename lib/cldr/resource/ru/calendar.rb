...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "янв."
    @months[:gregorian][:abbreviated]["10"] = "окт."
    @months[:gregorian][:abbreviated]["11"] = "нояб."
    @months[:gregorian][:abbreviated]["12"] = "дек."
    @months[:gregorian][:abbreviated]["2"] = "февр."
    @months[:gregorian][:abbreviated]["3"] = "март"
    @months[:gregorian][:abbreviated]["4"] = "апр."
    @months[:gregorian][:abbreviated]["5"] = "май"
    @months[:gregorian][:abbreviated]["6"] = "июнь"
    @months[:gregorian][:abbreviated]["7"] = "июль"
    @months[:gregorian][:abbreviated]["8"] = "авг."
    @months[:gregorian][:abbreviated]["9"] = "сент."
    ...
    @months[:gregorian][:wide]["1"] = "Январь"
    @months[:gregorian][:wide]["10"] = "Октябрь"
    @months[:gregorian][:wide]["11"] = "Ноябрь"
    @months[:gregorian][:wide]["12"] = "Декабрь"
    @months[:gregorian][:wide]["2"] = "Февраль"
    @months[:gregorian][:wide]["3"] = "Март"
    @months[:gregorian][:wide]["4"] = "Апрель"
    @months[:gregorian][:wide]["5"] = "Май"
    @months[:gregorian][:wide]["6"] = "Июнь"
    @months[:gregorian][:wide]["7"] = "Июль"
    @months[:gregorian][:wide]["8"] = "Август"
    @months[:gregorian][:wide]["9"] = "Сентябрь"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Пт"
    @days[:gregorian][:abbreviated]["mon"] = "Пн"
    @days[:gregorian][:abbreviated]["sat"] = "Сб"
    @days[:gregorian][:abbreviated]["sun"] = "Вс"
    @days[:gregorian][:abbreviated]["thu"] = "Чт"
    @days[:gregorian][:abbreviated]["tue"] = "Вт"
    @days[:gregorian][:abbreviated]["wed"] = "Ср"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "П"
    @days[:gregorian][:narrow]["mon"] = "П"
    @days[:gregorian][:narrow]["sat"] = "С"
    @days[:gregorian][:narrow]["sun"] = "В"
    @days[:gregorian][:narrow]["thu"] = "Ч"
    @days[:gregorian][:narrow]["tue"] = "В"
    @days[:gregorian][:narrow]["wed"] = "С"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "пятница"
    @days[:gregorian][:wide]["mon"] = "понедельник"
    @days[:gregorian][:wide]["sat"] = "суббота"
    @days[:gregorian][:wide]["sun"] = "воскресенье"
    @days[:gregorian][:wide]["thu"] = "четверг"
    @days[:gregorian][:wide]["tue"] = "вторник"
    @days[:gregorian][:wide]["wed"] = "среда"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "до н.э."
    @era_abbrs[:gregorian]["1"] = "н.э."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "d MMMM yyyy 'г.'"
    @dateformats[:gregorian]["long"] = "d MMMM yyyy 'г.'"
