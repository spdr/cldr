...
# CLDR version: 1.3
#
# Original file name: common/main/sh_BA.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["10"] = "oktobar"
    @months[:gregorian][:wide]["11"] = "novembar"
    @months[:gregorian][:wide]["12"] = "decembar"
    ...
    @months[:gregorian][:wide]["9"] = "septembar"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:wide]["mon"] = "ponedeljak"
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "Pre Hrista"
    @era_names[:gregorian]["1"] = "Posle Hrista"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    ...
    @timeformats[:gregorian]["full"] = "HH 'časova', mm 'minuta', ss 'sekundi'"
