...
# CLDR version: 1.3
#
# Original file name: common/main/sid.xml
...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Arb"
    @days[:gregorian][:abbreviated]["mon"] = "San"
    @days[:gregorian][:abbreviated]["sat"] = "Qid"
    @days[:gregorian][:abbreviated]["sun"] = "Sam"
    @days[:gregorian][:abbreviated]["thu"] = "Ham"
    @days[:gregorian][:abbreviated]["tue"] = "Mak"
    @days[:gregorian][:abbreviated]["wed"] = "Row"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "A"
    @days[:gregorian][:narrow]["mon"] = "S"
    @days[:gregorian][:narrow]["sat"] = "Q"
    @days[:gregorian][:narrow]["sun"] = "S"
    @days[:gregorian][:narrow]["thu"] = "H"
    @days[:gregorian][:narrow]["tue"] = "M"
    @days[:gregorian][:narrow]["wed"] = "R"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Arbe"
    @days[:gregorian][:wide]["mon"] = "Sanyo"
    @days[:gregorian][:wide]["sat"] = "Qidaame"
    @days[:gregorian][:wide]["sun"] = "Sambata"
    @days[:gregorian][:wide]["thu"] = "Hamuse"
    @days[:gregorian][:wide]["tue"] = "Maakisanyo"
    @days[:gregorian][:wide]["wed"] = "Roowe"
    @dayformat_defaults = {}
    ...
    @am["gregorian"] = "soodo"
    @pm = {}
    @pm["gregorian"] = "hawwaro"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "YIA"
    @era_abbrs[:gregorian]["1"] = "YIG"
    @era_abbrs[:hebrew] = {}
