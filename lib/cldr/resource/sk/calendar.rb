...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["5"] = "máj"
    @months[:gregorian][:wide]["6"] = "jún"
    @months[:gregorian][:wide]["7"] = "júl"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Pi"
    @days[:gregorian][:abbreviated]["mon"] = "Po"
    @days[:gregorian][:abbreviated]["sat"] = "So"
    @days[:gregorian][:abbreviated]["sun"] = "Ne"
    @days[:gregorian][:abbreviated]["thu"] = "Št"
    @days[:gregorian][:abbreviated]["tue"] = "Ut"
    ...
    @days[:gregorian][:narrow]["thu"] = "Š"
    @days[:gregorian][:narrow]["tue"] = "U"
    @days[:gregorian][:narrow]["wed"] = "S"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Piatok"
    @days[:gregorian][:wide]["mon"] = "Pondelok"
    @days[:gregorian][:wide]["sat"] = "Sobota"
    @days[:gregorian][:wide]["sun"] = "Nedeľa"
    @days[:gregorian][:wide]["thu"] = "Štvrtok"
    @days[:gregorian][:wide]["tue"] = "Utorok"
    @days[:gregorian][:wide]["wed"] = "Streda"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "pred n.l."
    @era_abbrs[:gregorian]["1"] = "n.l."
    @era_abbrs[:hebrew] = {}
