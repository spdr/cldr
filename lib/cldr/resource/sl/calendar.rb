...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["3"] = "marec"
    @months[:gregorian][:wide]["4"] = "april"
    @months[:gregorian][:wide]["5"] = "maj"
    @months[:gregorian][:wide]["6"] = "junij"
    @months[:gregorian][:wide]["7"] = "julij"
    ...
    @days[:gregorian][:abbreviated]["tue"] = "tor"
    @days[:gregorian][:abbreviated]["wed"] = "sre"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "petek"
    @days[:gregorian][:wide]["mon"] = "ponedeljek"
    @days[:gregorian][:wide]["sat"] = "sobota"
    @days[:gregorian][:wide]["sun"] = "nedelja"
    @days[:gregorian][:wide]["thu"] = "četrtek"
    @days[:gregorian][:wide]["tue"] = "torek"
    @days[:gregorian][:wide]["wed"] = "sreda"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "pred našim štetjem"
    @era_names[:gregorian]["1"] = "naše štetje"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "pr.n.š."
    @era_abbrs[:gregorian]["1"] = "n.š."
    @era_abbrs[:hebrew] = {}
