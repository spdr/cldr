...
# CLDR version: 1.3
#
# Original file name: common/main/so_DJ.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Kob"
    @months[:gregorian][:abbreviated]["10"] = "Tob"
    @months[:gregorian][:abbreviated]["11"] = "KIT"
    @months[:gregorian][:abbreviated]["12"] = "LIT"
    @months[:gregorian][:abbreviated]["2"] = "Lab"
    @months[:gregorian][:abbreviated]["3"] = "Sad"
    @months[:gregorian][:abbreviated]["4"] = "Afr"
    @months[:gregorian][:abbreviated]["5"] = "Sha"
    @months[:gregorian][:abbreviated]["6"] = "Lix"
    @months[:gregorian][:abbreviated]["7"] = "Tod"
    @months[:gregorian][:abbreviated]["8"] = "Sid"
    @months[:gregorian][:abbreviated]["9"] = "Sag"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "K"
    @months[:gregorian][:narrow]["10"] = "T"
    @months[:gregorian][:narrow]["11"] = "K"
    @months[:gregorian][:narrow]["12"] = "L"
    @months[:gregorian][:narrow]["2"] = "L"
    @months[:gregorian][:narrow]["3"] = "S"
    @months[:gregorian][:narrow]["4"] = "A"
    @months[:gregorian][:narrow]["5"] = "S"
    @months[:gregorian][:narrow]["6"] = "L"
    @months[:gregorian][:narrow]["7"] = "T"
    @months[:gregorian][:narrow]["8"] = "S"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Bisha Koobaad"
    @months[:gregorian][:wide]["10"] = "Bisha Tobnaad"
    @months[:gregorian][:wide]["11"] = "Bisha Kow iyo Tobnaad"
    @months[:gregorian][:wide]["12"] = "Bisha Laba iyo Tobnaad"
    @months[:gregorian][:wide]["2"] = "Bisha Labaad"
    @months[:gregorian][:wide]["3"] = "Bisha Saddexaad"
    @months[:gregorian][:wide]["4"] = "Bisha Afraad"
    @months[:gregorian][:wide]["5"] = "Bisha Shanaad"
    @months[:gregorian][:wide]["6"] = "Bisha Lixaad"
    @months[:gregorian][:wide]["7"] = "Bisha Todobaad"
    @months[:gregorian][:wide]["8"] = "Bisha Sideedaad"
    @months[:gregorian][:wide]["9"] = "Bisha Sagaalaad"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Jim"
    @days[:gregorian][:abbreviated]["mon"] = "Isn"
    @days[:gregorian][:abbreviated]["sat"] = "Sab"
    @days[:gregorian][:abbreviated]["sun"] = "Axa"
    @days[:gregorian][:abbreviated]["thu"] = "Kha"
    @days[:gregorian][:abbreviated]["tue"] = "Sal"
    @days[:gregorian][:abbreviated]["wed"] = "Arb"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "J"
    @days[:gregorian][:narrow]["mon"] = "I"
    @days[:gregorian][:narrow]["sat"] = "S"
    @days[:gregorian][:narrow]["sun"] = "A"
    @days[:gregorian][:narrow]["thu"] = "K"
    @days[:gregorian][:narrow]["tue"] = "S"
    @days[:gregorian][:narrow]["wed"] = "A"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Jimco"
    @days[:gregorian][:wide]["mon"] = "Isniin"
    @days[:gregorian][:wide]["sat"] = "Sabti"
    @days[:gregorian][:wide]["sun"] = "Axad"
    @days[:gregorian][:wide]["thu"] = "Khamiis"
    @days[:gregorian][:wide]["tue"] = "Salaaso"
    @days[:gregorian][:wide]["wed"] = "Arbaco"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "Ciise ka hor"
    @era_abbrs[:gregorian]["1"] = "Ciise ka dib"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, MMMM dd, yyyy"
    @dateformats[:gregorian]["long"] = "dd MMMM yyyy"
    @dateformats[:gregorian]["medium"] = "dd-MMM-yyyy"
    ...
    @timeformats[:gregorian]["full"] = "h:mm:ss a"
