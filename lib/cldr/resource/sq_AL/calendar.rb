...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["10"] = "Tet"
    @months[:gregorian][:abbreviated]["11"] = "Nën"
    @months[:gregorian][:abbreviated]["12"] = "Dhj"
    @months[:gregorian][:abbreviated]["2"] = "Shk"
    @months[:gregorian][:abbreviated]["3"] = "Mar"
    @months[:gregorian][:abbreviated]["4"] = "Pri"
    @months[:gregorian][:abbreviated]["5"] = "Maj"
    @months[:gregorian][:abbreviated]["6"] = "Qer"
    @months[:gregorian][:abbreviated]["7"] = "Kor"
    @months[:gregorian][:abbreviated]["8"] = "Gsh"
    @months[:gregorian][:abbreviated]["9"] = "Sht"
    ...
    @months[:gregorian][:narrow]["2"] = "S"
    @months[:gregorian][:narrow]["3"] = "M"
    @months[:gregorian][:narrow]["4"] = "P"
    @months[:gregorian][:narrow]["5"] = "M"
    @months[:gregorian][:narrow]["6"] = "Q"
    @months[:gregorian][:narrow]["7"] = "K"
    @months[:gregorian][:narrow]["8"] = "G"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "janar"
    @months[:gregorian][:wide]["10"] = "tetor"
    @months[:gregorian][:wide]["11"] = "nëntor"
    @months[:gregorian][:wide]["12"] = "dhjetor"
    @months[:gregorian][:wide]["2"] = "shkurt"
    @months[:gregorian][:wide]["3"] = "mars"
    @months[:gregorian][:wide]["4"] = "prill"
    @months[:gregorian][:wide]["5"] = "maj"
    @months[:gregorian][:wide]["6"] = "qershor"
    @months[:gregorian][:wide]["7"] = "korrik"
    @months[:gregorian][:wide]["8"] = "gusht"
    @months[:gregorian][:wide]["9"] = "shtator"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Pre"
    @days[:gregorian][:abbreviated]["mon"] = "Hën"
    @days[:gregorian][:abbreviated]["sat"] = "Sht"
    @days[:gregorian][:abbreviated]["sun"] = "Die"
    @days[:gregorian][:abbreviated]["thu"] = "Enj"
    @days[:gregorian][:abbreviated]["tue"] = "Mar"
    @days[:gregorian][:abbreviated]["wed"] = "Mër"
    ...
    @days[:gregorian][:narrow]["thu"] = "E"
    @days[:gregorian][:narrow]["tue"] = "M"
    @days[:gregorian][:narrow]["wed"] = "M"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "e premte"
    @days[:gregorian][:wide]["mon"] = "e hënë"
    @days[:gregorian][:wide]["sat"] = "e shtunë"
    @days[:gregorian][:wide]["sun"] = "e diel"
    @days[:gregorian][:wide]["thu"] = "e enjte"
    @days[:gregorian][:wide]["tue"] = "e martë"
    @days[:gregorian][:wide]["wed"] = "e mërkurë"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "p.e.r."
    @era_abbrs[:gregorian]["1"] = "n.e.r."
    @era_abbrs[:hebrew] = {}
