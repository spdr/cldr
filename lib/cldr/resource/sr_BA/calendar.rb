...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Јан"
    @months[:gregorian][:abbreviated]["10"] = "Окт"
    @months[:gregorian][:abbreviated]["11"] = "Нов"
    @months[:gregorian][:abbreviated]["12"] = "Дец"
    @months[:gregorian][:abbreviated]["2"] = "Феб"
    @months[:gregorian][:abbreviated]["3"] = "Мар"
    @months[:gregorian][:abbreviated]["4"] = "Апр"
    @months[:gregorian][:abbreviated]["5"] = "Мај"
    @months[:gregorian][:abbreviated]["6"] = "Јун"
    @months[:gregorian][:abbreviated]["7"] = "Јул"
    @months[:gregorian][:abbreviated]["8"] = "Авг"
    @months[:gregorian][:abbreviated]["9"] = "Сеп"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ј"
    ...
    @months[:gregorian][:narrow]["6"] = "ј"
    @months[:gregorian][:narrow]["7"] = "ј"
    @months[:gregorian][:narrow]["8"] = "а"
    @months[:gregorian][:narrow]["9"] = "с"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "јануар"
    @months[:gregorian][:wide]["10"] = "октобар"
    @months[:gregorian][:wide]["11"] = "новембар"
    @months[:gregorian][:wide]["12"] = "децембар"
    @months[:gregorian][:wide]["2"] = "фебруар"
    @months[:gregorian][:wide]["3"] = "март"
    @months[:gregorian][:wide]["4"] = "април"
    @months[:gregorian][:wide]["5"] = "мај"
    @months[:gregorian][:wide]["6"] = "јуни"
    @months[:gregorian][:wide]["7"] = "јули"
    @months[:gregorian][:wide]["8"] = "август"
    @months[:gregorian][:wide]["9"] = "септембар"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "пет"
    @days[:gregorian][:abbreviated]["mon"] = "пон"
    @days[:gregorian][:abbreviated]["sat"] = "суб"
    @days[:gregorian][:abbreviated]["sun"] = "нед"
    @days[:gregorian][:abbreviated]["thu"] = "чет"
    @days[:gregorian][:abbreviated]["tue"] = "уто"
    @days[:gregorian][:abbreviated]["wed"] = "сри"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "п"
    @days[:gregorian][:narrow]["mon"] = "п"
    @days[:gregorian][:narrow]["sat"] = "с"
    @days[:gregorian][:narrow]["sun"] = "н"
    @days[:gregorian][:narrow]["thu"] = "ч"
    @days[:gregorian][:narrow]["tue"] = "у"
    @days[:gregorian][:narrow]["wed"] = "с"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "петак"
    @days[:gregorian][:wide]["mon"] = "понедељак"
    @days[:gregorian][:wide]["sat"] = "субота"
    @days[:gregorian][:wide]["sun"] = "недеља"
    @days[:gregorian][:wide]["thu"] = "четвртак"
    @days[:gregorian][:wide]["tue"] = "уторак"
    @days[:gregorian][:wide]["wed"] = "сриједа"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "Пре Христа"
    @era_names[:gregorian]["1"] = "После Христа"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "п. н. е."
    @era_abbrs[:gregorian]["1"] = "н. е"
    @era_abbrs[:hebrew] = {}
    ...
    @timeformats[:gregorian]["full"] = "HH 'часова', mm 'минута', ss' секунди'"
