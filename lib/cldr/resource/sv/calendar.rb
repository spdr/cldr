...
#
  ...
  def init_data
    ...
    @months[:gregorian][:wide]["8"] = "augusti"
    ...
    @days[:gregorian][:abbreviated]["mon"] = "mån"
    @days[:gregorian][:abbreviated]["sat"] = "lör"
    @days[:gregorian][:abbreviated]["sun"] = "sön"
    @days[:gregorian][:abbreviated]["thu"] = "tors"
    @days[:gregorian][:abbreviated]["tue"] = "tis"
    ...
    @days[:gregorian][:wide]["mon"] = "måndag"
    @days[:gregorian][:wide]["sat"] = "lördag"
    @days[:gregorian][:wide]["sun"] = "söndag"
    @days[:gregorian][:wide]["thu"] = "torsdag"
    @days[:gregorian][:wide]["tue"] = "tisdag"
    ...
    @dateformats[:gregorian]["long"] = "EEEE d MMM yyyy"
    ...
    @timeformats[:gregorian]["full"] = "'kl. 'HH.mm.ss z"
