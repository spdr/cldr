...
# CLDR version: 1.3
#
# Original file name: common/main/sw_KE.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["3"] = "Mac"
    ...
    @months[:gregorian][:wide]["10"] = "Oktoba"
    @months[:gregorian][:wide]["11"] = "Novemba"
    @months[:gregorian][:wide]["12"] = "Desemba"
    @months[:gregorian][:wide]["2"] = "Februari"
    @months[:gregorian][:wide]["3"] = "Machi"
    @months[:gregorian][:wide]["4"] = "Aprili"
    @months[:gregorian][:wide]["5"] = "Mei"
    @months[:gregorian][:wide]["6"] = "Juni"
    @months[:gregorian][:wide]["7"] = "Julai"
    @months[:gregorian][:wide]["8"] = "Agosti"
    @months[:gregorian][:wide]["9"] = "Septemba"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Ijm"
    @days[:gregorian][:abbreviated]["mon"] = "Jtt"
    @days[:gregorian][:abbreviated]["sat"] = "Jms"
    @days[:gregorian][:abbreviated]["sun"] = "Jpl"
    @days[:gregorian][:abbreviated]["thu"] = "Alh"
    @days[:gregorian][:abbreviated]["tue"] = "Jnn"
    @days[:gregorian][:abbreviated]["wed"] = "Jtn"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Ijumaa"
    @days[:gregorian][:wide]["mon"] = "Jumatatu"
    @days[:gregorian][:wide]["sat"] = "Jumamosi"
    @days[:gregorian][:wide]["sun"] = "Jumapili"
    @days[:gregorian][:wide]["thu"] = "Alhamisi"
    @days[:gregorian][:wide]["tue"] = "Jumanne"
    @days[:gregorian][:wide]["wed"] = "Jumatano"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "Kabla ya Kristo"
    @era_names[:gregorian]["1"] = "Baada ya Kristo"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "KK"
    @era_abbrs[:gregorian]["1"] = "BK"
    @era_abbrs[:hebrew] = {}
