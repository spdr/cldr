...
#
  ...
  def init_data
    ...
    @exemplarcities = {}
    @exemplarcities["Africa/Nairobi"] = "Nairobi"
    @long_generics = {}
    @long_standards = {}
    @long_standards["Africa/Nairobi"] = "Saa za Africa Mashariki"
    @long_daylights = {}
    @long_daylights["Africa/Nairobi"] = "Saa za Africa Mashariki"
    @short_generics = {}
    @short_standards = {}
    @short_standards["Africa/Nairobi"] = "EAT"
    @short_daylights = {}
    @short_daylights["Africa/Nairobi"] = "EAT"
  end
