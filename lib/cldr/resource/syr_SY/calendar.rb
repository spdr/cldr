...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "܏ܟܢ ܏ܒ"
    @months[:gregorian][:abbreviated]["10"] = "܏ܬܫ ܏ܐ"
    @months[:gregorian][:abbreviated]["11"] = "܏ܬܫ ܏ܒ"
    @months[:gregorian][:abbreviated]["12"] = "܏ܟܢ ܏ܐ"
    @months[:gregorian][:abbreviated]["2"] = "ܫܒܛ"
    @months[:gregorian][:abbreviated]["3"] = "ܐܕܪ"
    @months[:gregorian][:abbreviated]["4"] = "ܢܝܣܢ"
    @months[:gregorian][:abbreviated]["5"] = "ܐܝܪ"
    @months[:gregorian][:abbreviated]["6"] = "ܚܙܝܪܢ"
    @months[:gregorian][:abbreviated]["7"] = "ܬܡܘܙ"
    @months[:gregorian][:abbreviated]["8"] = "ܐܒ"
    @months[:gregorian][:abbreviated]["9"] = "ܐܝܠܘܠ"
    ...
    @months[:gregorian][:wide]["1"] = "1"
    @months[:gregorian][:wide]["10"] = "10"
    @months[:gregorian][:wide]["11"] = "11"
    @months[:gregorian][:wide]["12"] = "12"
    @months[:gregorian][:wide]["2"] = "2"
    @months[:gregorian][:wide]["3"] = "3"
    @months[:gregorian][:wide]["4"] = "4"
    @months[:gregorian][:wide]["5"] = "5"
    @months[:gregorian][:wide]["6"] = "6"
    @months[:gregorian][:wide]["7"] = "7"
    @months[:gregorian][:wide]["8"] = "8"
    @months[:gregorian][:wide]["9"] = "9"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "6"
    @days[:gregorian][:abbreviated]["mon"] = "2"
    @days[:gregorian][:abbreviated]["sat"] = "7"
    @days[:gregorian][:abbreviated]["sun"] = "1"
    @days[:gregorian][:abbreviated]["thu"] = "5"
    @days[:gregorian][:abbreviated]["tue"] = "3"
    @days[:gregorian][:abbreviated]["wed"] = "4"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "6"
    @days[:gregorian][:wide]["mon"] = "2"
    @days[:gregorian][:wide]["sat"] = "7"
    @days[:gregorian][:wide]["sun"] = "1"
    @days[:gregorian][:wide]["thu"] = "5"
    @days[:gregorian][:wide]["tue"] = "3"
    @days[:gregorian][:wide]["wed"] = "4"
    @dayformat_defaults = {}
