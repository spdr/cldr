...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ஜன."
    @months[:gregorian][:abbreviated]["10"] = "அக்."
    @months[:gregorian][:abbreviated]["11"] = "நவ."
    @months[:gregorian][:abbreviated]["12"] = "டிச."
    @months[:gregorian][:abbreviated]["2"] = "பிப்."
    @months[:gregorian][:abbreviated]["3"] = "மார்."
    @months[:gregorian][:abbreviated]["4"] = "ஏப்."
    @months[:gregorian][:abbreviated]["5"] = "மே"
    @months[:gregorian][:abbreviated]["6"] = "ஜூன்"
    @months[:gregorian][:abbreviated]["7"] = "ஜூலை"
    @months[:gregorian][:abbreviated]["8"] = "ஆக."
    @months[:gregorian][:abbreviated]["9"] = "செப்."
    ...
    @months[:gregorian][:wide]["1"] = "ஜனவரி"
    @months[:gregorian][:wide]["10"] = "அக்டோபர்"
    @months[:gregorian][:wide]["11"] = "நவம்பர்"
    @months[:gregorian][:wide]["12"] = "டிசம்பர்"
    @months[:gregorian][:wide]["2"] = "பிப்ரவரி"
    @months[:gregorian][:wide]["3"] = "மார்ச்"
    @months[:gregorian][:wide]["4"] = "ஏப்ரல்"
    @months[:gregorian][:wide]["5"] = "மே"
    @months[:gregorian][:wide]["6"] = "ஜூன்"
    @months[:gregorian][:wide]["7"] = "ஜூலை"
    @months[:gregorian][:wide]["8"] = "ஆகஸ்ட்"
    @months[:gregorian][:wide]["9"] = "செப்டம்பர்"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "வெ"
    @days[:gregorian][:abbreviated]["mon"] = "தி"
    @days[:gregorian][:abbreviated]["sat"] = "ச"
    @days[:gregorian][:abbreviated]["sun"] = "ஞா"
    @days[:gregorian][:abbreviated]["thu"] = "வி"
    @days[:gregorian][:abbreviated]["tue"] = "செ"
    @days[:gregorian][:abbreviated]["wed"] = "பு"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "வெள்ளி"
    @days[:gregorian][:wide]["mon"] = "திங்கள்"
    @days[:gregorian][:wide]["sat"] = "சனி"
    @days[:gregorian][:wide]["sun"] = "ஞாயிறு"
    @days[:gregorian][:wide]["thu"] = "வியாழன்"
    @days[:gregorian][:wide]["tue"] = "செவ்வாய்"
    @days[:gregorian][:wide]["wed"] = "புதன்"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "வர்ஷು."
    @era_names[:gregorian]["1"] = "ஸந்."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "கிமு"
    @era_abbrs[:gregorian]["1"] = "கிபி"
    @era_abbrs[:hebrew] = {}
