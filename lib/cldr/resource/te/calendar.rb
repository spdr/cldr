...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "జనవరి"
    @months[:gregorian][:abbreviated]["10"] = "అక్టోబర్"
    @months[:gregorian][:abbreviated]["11"] = "నవంబర్"
    @months[:gregorian][:abbreviated]["12"] = "డిసెంబర్"
    @months[:gregorian][:abbreviated]["2"] = "ఫిబ్రవరి"
    @months[:gregorian][:abbreviated]["3"] = "మార్చి"
    @months[:gregorian][:abbreviated]["4"] = "ఏప్రిల్"
    @months[:gregorian][:abbreviated]["5"] = "మే"
    @months[:gregorian][:abbreviated]["6"] = "జూన్"
    @months[:gregorian][:abbreviated]["7"] = "జూలై"
    @months[:gregorian][:abbreviated]["8"] = "ఆగస్టు"
    @months[:gregorian][:abbreviated]["9"] = "సెప్టెంబర్"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "జ"
    @months[:gregorian][:narrow]["10"] = "అ"
    @months[:gregorian][:narrow]["11"] = "న"
    @months[:gregorian][:narrow]["12"] = "డి"
    @months[:gregorian][:narrow]["2"] = "ఫి"
    @months[:gregorian][:narrow]["3"] = "మ"
    @months[:gregorian][:narrow]["4"] = "ఎ"
    @months[:gregorian][:narrow]["5"] = "మె"
    @months[:gregorian][:narrow]["6"] = "జు"
    @months[:gregorian][:narrow]["7"] = "జు"
    @months[:gregorian][:narrow]["8"] = "ఆ"
    @months[:gregorian][:narrow]["9"] = "సె"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "జనవరి"
    @months[:gregorian][:wide]["10"] = "అక్టోబర్"
    @months[:gregorian][:wide]["11"] = "నవంబర్"
    @months[:gregorian][:wide]["12"] = "డిసెంబర్"
    @months[:gregorian][:wide]["2"] = "ఫిబ్రవరి"
    @months[:gregorian][:wide]["3"] = "మార్చి"
    @months[:gregorian][:wide]["4"] = "ఏప్రిల్"
    @months[:gregorian][:wide]["5"] = "మే"
    @months[:gregorian][:wide]["6"] = "జూన్"
    @months[:gregorian][:wide]["7"] = "జూలై"
    @months[:gregorian][:wide]["8"] = "ఆగస్టు"
    @months[:gregorian][:wide]["9"] = "సెప్టెంబర్"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "శుక్ర"
    @days[:gregorian][:abbreviated]["mon"] = "సోమ"
    @days[:gregorian][:abbreviated]["sat"] = "శని"
    @days[:gregorian][:abbreviated]["sun"] = "ఆది"
    @days[:gregorian][:abbreviated]["thu"] = "గురు"
    @days[:gregorian][:abbreviated]["tue"] = "మంగళ"
    @days[:gregorian][:abbreviated]["wed"] = "బుధ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "శు"
    @days[:gregorian][:narrow]["mon"] = "2"
    @days[:gregorian][:narrow]["sat"] = "శ"
    @days[:gregorian][:narrow]["sun"] = "ఆ"
    @days[:gregorian][:narrow]["thu"] = "గు"
    @days[:gregorian][:narrow]["tue"] = "సొ"
    @days[:gregorian][:narrow]["wed"] = "భు"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "శుక్రవారం"
    @days[:gregorian][:wide]["mon"] = "సోమవారం"
    @days[:gregorian][:wide]["sat"] = "శనివారం"
    @days[:gregorian][:wide]["sun"] = "ఆదివారం"
    @days[:gregorian][:wide]["thu"] = "గురువారం"
    @days[:gregorian][:wide]["tue"] = "మంగళవారం"
    @days[:gregorian][:wide]["wed"] = "బుధవారం"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "పూర్వాహ్నం"
    @pm = {}
    @pm["gregorian"] = "అపరాహ్నం"
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ఈసాపూర్వ."
    @era_names[:gregorian]["1"] = "సన్."
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
