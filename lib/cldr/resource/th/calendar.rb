...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ม.ค."
    @months[:gregorian][:abbreviated]["10"] = "ต.ค."
    @months[:gregorian][:abbreviated]["11"] = "พ.ย."
    @months[:gregorian][:abbreviated]["12"] = "ธ.ค."
    @months[:gregorian][:abbreviated]["2"] = "ก.พ."
    @months[:gregorian][:abbreviated]["3"] = "มี.ค."
    @months[:gregorian][:abbreviated]["4"] = "เม.ย."
    @months[:gregorian][:abbreviated]["5"] = "พ.ค."
    @months[:gregorian][:abbreviated]["6"] = "มิ.ย."
    @months[:gregorian][:abbreviated]["7"] = "ก.ค."
    @months[:gregorian][:abbreviated]["8"] = "ส.ค."
    @months[:gregorian][:abbreviated]["9"] = "ก.ย."
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ม.ค."
    @months[:gregorian][:narrow]["10"] = "ต.ค."
    @months[:gregorian][:narrow]["11"] = "พ.ย."
    @months[:gregorian][:narrow]["12"] = "ธ.ค."
    @months[:gregorian][:narrow]["2"] = "ก.พ."
    @months[:gregorian][:narrow]["3"] = "มี.ค."
    @months[:gregorian][:narrow]["4"] = "เม.ย."
    @months[:gregorian][:narrow]["5"] = "พ.ค."
    @months[:gregorian][:narrow]["6"] = "มิ.ย."
    @months[:gregorian][:narrow]["7"] = "ก.ค."
    @months[:gregorian][:narrow]["8"] = "ส.ค."
    @months[:gregorian][:narrow]["9"] = "ก.ย."
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "มกราคม"
    @months[:gregorian][:wide]["10"] = "ตุลาคม"
    @months[:gregorian][:wide]["11"] = "พฤศจิกายน"
    @months[:gregorian][:wide]["12"] = "ธันวาคม"
    @months[:gregorian][:wide]["2"] = "กุมภาพันธ์"
    @months[:gregorian][:wide]["3"] = "มีนาคม"
    @months[:gregorian][:wide]["4"] = "เมษายน"
    @months[:gregorian][:wide]["5"] = "พฤษภาคม"
    @months[:gregorian][:wide]["6"] = "มิถุนายน"
    @months[:gregorian][:wide]["7"] = "กรกฎาคม"
    @months[:gregorian][:wide]["8"] = "สิงหาคม"
    @months[:gregorian][:wide]["9"] = "กันยายน"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ศ."
    @days[:gregorian][:abbreviated]["mon"] = "จ."
    @days[:gregorian][:abbreviated]["sat"] = "ส."
    @days[:gregorian][:abbreviated]["sun"] = "อา."
    @days[:gregorian][:abbreviated]["thu"] = "พฤ."
    @days[:gregorian][:abbreviated]["tue"] = "อ."
    @days[:gregorian][:abbreviated]["wed"] = "พ."
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ศ"
    @days[:gregorian][:narrow]["mon"] = "จ"
    @days[:gregorian][:narrow]["sat"] = "ส"
    @days[:gregorian][:narrow]["sun"] = "อ"
    @days[:gregorian][:narrow]["thu"] = "พ"
    @days[:gregorian][:narrow]["tue"] = "อ"
    @days[:gregorian][:narrow]["wed"] = "พ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "วันศุกร์"
    @days[:gregorian][:wide]["mon"] = "วันจันทร์"
    @days[:gregorian][:wide]["sat"] = "วันเสาร์"
    @days[:gregorian][:wide]["sun"] = "วันอาทิตย์"
    @days[:gregorian][:wide]["thu"] = "วันพฤหัสบดี"
    @days[:gregorian][:wide]["tue"] = "วันอังคาร"
    @days[:gregorian][:wide]["wed"] = "วันพุธ"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ก่อนเที่ยง"
    @pm = {}
    @pm["gregorian"] = "หลังเที่ยง"
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "ปีก่อนคริสตกาลที่"
    @era_names[:gregorian]["1"] = "คริสตศักราช"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "พ.ศ."
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "ปีก่อนคริสต์กาลที่"
    @era_abbrs[:gregorian]["1"] = "ค.ศ."
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:buddhist]["full"] = "EEEE'ที่ 'd MMMM G yyyy"
    @dateformats[:buddhist]["long"] = "d MMMM yyyy"
    @dateformats[:buddhist]["medium"] = "d MMM yyyy"
    @dateformats[:buddhist]["short"] = "d/M/yyyy"
    @dateformats[:chinese] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE'ที่ 'd MMMM G yyyy"
    ...
    @timeformats[:buddhist]["full"] = "H' นาฬิกา 'm' นาที 'ss' วินาที'"
    @timeformats[:buddhist]["long"] = "H' นาฬิกา 'm' นาที'"
    @timeformats[:buddhist]["medium"] = "H:mm:ss"
    ...
    @timeformats[:gregorian]["full"] = "H' นาฬิกา 'm' นาที 'ss' วินาที'"
    @timeformats[:gregorian]["long"] = "H' นาฬิกา 'm' นาที'"
