...
# CLDR version: 1.3
#
# Original file name: common/main/ti_ER.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ጥሪ"
    @months[:gregorian][:abbreviated]["10"] = "ጥቅም"
    @months[:gregorian][:abbreviated]["11"] = "ሕዳር"
    @months[:gregorian][:abbreviated]["12"] = "ታሕሳ"
    @months[:gregorian][:abbreviated]["2"] = "ለካቲ"
    @months[:gregorian][:abbreviated]["3"] = "መጋቢ"
    @months[:gregorian][:abbreviated]["4"] = "ሚያዝ"
    @months[:gregorian][:abbreviated]["5"] = "ግንቦ"
    @months[:gregorian][:abbreviated]["6"] = "ሰነ"
    @months[:gregorian][:abbreviated]["7"] = "ሓምለ"
    @months[:gregorian][:abbreviated]["8"] = "ነሓሰ"
    @months[:gregorian][:abbreviated]["9"] = "መስከ"
    ...
    @months[:gregorian][:wide]["1"] = "ጥሪ"
    @months[:gregorian][:wide]["10"] = "ጥቅምቲ"
    @months[:gregorian][:wide]["11"] = "ሕዳር"
    @months[:gregorian][:wide]["12"] = "ታሕሳስ"
    @months[:gregorian][:wide]["2"] = "ለካቲት"
    @months[:gregorian][:wide]["3"] = "መጋቢት"
    @months[:gregorian][:wide]["4"] = "ሚያዝያ"
    @months[:gregorian][:wide]["5"] = "ግንቦት"
    @months[:gregorian][:wide]["6"] = "ሰነ"
    @months[:gregorian][:wide]["7"] = "ሓምለ"
    @months[:gregorian][:wide]["8"] = "ነሓሰ"
    @months[:gregorian][:wide]["9"] = "መስከረም"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["thu"] = "ሓሙስ"
    @days[:gregorian][:abbreviated]["tue"] = "ሰሉስ"
    ...
    @days[:gregorian][:wide]["thu"] = "ሓሙስ"
    @days[:gregorian][:wide]["tue"] = "ሰሉስ"
