...
# CLDR version: 1.3
#
# Original file name: common/main/ti_ET.xml
...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ዓርቢ"
    @days[:gregorian][:abbreviated]["mon"] = "ሰኑይ"
    @days[:gregorian][:abbreviated]["sat"] = "ቀዳም"
    @days[:gregorian][:abbreviated]["sun"] = "ሰንበ"
    @days[:gregorian][:abbreviated]["thu"] = "ኃሙስ"
    @days[:gregorian][:abbreviated]["tue"] = "ሠሉስ"
    @days[:gregorian][:abbreviated]["wed"] = "ረቡዕ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ዓ"
    @days[:gregorian][:narrow]["mon"] = "ሰ"
    @days[:gregorian][:narrow]["sat"] = "ቀ"
    @days[:gregorian][:narrow]["sun"] = "ሰ"
    @days[:gregorian][:narrow]["thu"] = "ኃ"
    @days[:gregorian][:narrow]["tue"] = "ሠ"
    @days[:gregorian][:narrow]["wed"] = "ረ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ዓርቢ"
    @days[:gregorian][:wide]["mon"] = "ሰኑይ"
    @days[:gregorian][:wide]["sat"] = "ቀዳም"
    @days[:gregorian][:wide]["sun"] = "ሰንበት"
    @days[:gregorian][:wide]["thu"] = "ኃሙስ"
    @days[:gregorian][:wide]["tue"] = "ሠሉስ"
    @days[:gregorian][:wide]["wed"] = "ረቡዕ"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ንጉሆ ሰዓተ"
    @pm = {}
    @pm["gregorian"] = "ድሕር ሰዓት"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE፣ dd MMMM መዓልቲ yyyy G"
