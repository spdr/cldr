...
# CLDR version: 1.3
#
# Original file name: common/main/tig_ER.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "ጃንዩ"
    @months[:gregorian][:abbreviated]["10"] = "ኦክተ"
    @months[:gregorian][:abbreviated]["11"] = "ኖቬም"
    @months[:gregorian][:abbreviated]["12"] = "ዲሴም"
    @months[:gregorian][:abbreviated]["2"] = "ፌብሩ"
    @months[:gregorian][:abbreviated]["3"] = "ማርች"
    @months[:gregorian][:abbreviated]["4"] = "ኤፕረ"
    @months[:gregorian][:abbreviated]["5"] = "ሜይ"
    @months[:gregorian][:abbreviated]["6"] = "ጁን"
    @months[:gregorian][:abbreviated]["7"] = "ጁላይ"
    @months[:gregorian][:abbreviated]["8"] = "ኦገስ"
    @months[:gregorian][:abbreviated]["9"] = "ሴፕቴ"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "ጃ"
    @months[:gregorian][:narrow]["10"] = "ኦ"
    @months[:gregorian][:narrow]["11"] = "ኖ"
    @months[:gregorian][:narrow]["12"] = "ዲ"
    @months[:gregorian][:narrow]["2"] = "ፌ"
    @months[:gregorian][:narrow]["3"] = "ማ"
    @months[:gregorian][:narrow]["4"] = "ኤ"
    @months[:gregorian][:narrow]["5"] = "ሜ"
    @months[:gregorian][:narrow]["6"] = "ጁ"
    @months[:gregorian][:narrow]["7"] = "ጁ"
    @months[:gregorian][:narrow]["8"] = "ኦ"
    @months[:gregorian][:narrow]["9"] = "ሴ"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "ጃንዩወሪ"
    @months[:gregorian][:wide]["10"] = "ኦክተውበር"
    @months[:gregorian][:wide]["11"] = "ኖቬምበር"
    @months[:gregorian][:wide]["12"] = "ዲሴምበር"
    @months[:gregorian][:wide]["2"] = "ፌብሩወሪ"
    @months[:gregorian][:wide]["3"] = "ማርች"
    @months[:gregorian][:wide]["4"] = "ኤፕረል"
    @months[:gregorian][:wide]["5"] = "ሜይ"
    @months[:gregorian][:wide]["6"] = "ጁን"
    @months[:gregorian][:wide]["7"] = "ጁላይ"
    @months[:gregorian][:wide]["8"] = "ኦገስት"
    @months[:gregorian][:wide]["9"] = "ሴፕቴምበር"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "ጅምዓ"
    @days[:gregorian][:abbreviated]["mon"] = "ሰኖ"
    @days[:gregorian][:abbreviated]["sat"] = "ሰ/ን"
    @days[:gregorian][:abbreviated]["sun"] = "ሰ/ዓ"
    @days[:gregorian][:abbreviated]["thu"] = "ከሚሽ"
    @days[:gregorian][:abbreviated]["tue"] = "ታላሸ"
    @days[:gregorian][:abbreviated]["wed"] = "ኣረር"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "ጅ"
    @days[:gregorian][:narrow]["mon"] = "ሰ"
    @days[:gregorian][:narrow]["sat"] = "ሰ"
    @days[:gregorian][:narrow]["sun"] = "ሰ"
    @days[:gregorian][:narrow]["thu"] = "ከ"
    @days[:gregorian][:narrow]["tue"] = "ታ"
    @days[:gregorian][:narrow]["wed"] = "ኣ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "ጅምዓት"
    @days[:gregorian][:wide]["mon"] = "ሰኖ"
    @days[:gregorian][:wide]["sat"] = "ሰንበት ንኢሽ"
    @days[:gregorian][:wide]["sun"] = "ሰንበት ዓባይ"
    @days[:gregorian][:wide]["thu"] = "ከሚሽ"
    @days[:gregorian][:wide]["tue"] = "ታላሸኖ"
    @days[:gregorian][:wide]["wed"] = "ኣረርባዓ"
    @dayformat_defaults = {}
    ...
    @mindays["gregorian"] = "1"
    @am = {}
    @am["gregorian"] = "ቀደም ሰርምዕል"
    @pm = {}
    @pm["gregorian"] = "ሓቆ ስርምዕል"
    @era_names = {}
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "ዓ/ዓ"
    @era_abbrs[:gregorian]["1"] = "ዓ/ም"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE፡ dd MMMM ዮም yyyy G"
