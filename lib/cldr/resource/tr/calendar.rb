...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Oca"
    @months[:gregorian][:abbreviated]["10"] = "Eki"
    @months[:gregorian][:abbreviated]["11"] = "Kas"
    @months[:gregorian][:abbreviated]["12"] = "Ara"
    @months[:gregorian][:abbreviated]["2"] = "Şub"
    @months[:gregorian][:abbreviated]["3"] = "Mar"
    @months[:gregorian][:abbreviated]["4"] = "Nis"
    @months[:gregorian][:abbreviated]["5"] = "May"
    @months[:gregorian][:abbreviated]["6"] = "Haz"
    @months[:gregorian][:abbreviated]["7"] = "Tem"
    @months[:gregorian][:abbreviated]["8"] = "Ağu"
    @months[:gregorian][:abbreviated]["9"] = "Eyl"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "O"
    @months[:gregorian][:narrow]["10"] = "E"
    @months[:gregorian][:narrow]["11"] = "K"
    @months[:gregorian][:narrow]["12"] = "A"
    @months[:gregorian][:narrow]["2"] = "Ş"
    @months[:gregorian][:narrow]["3"] = "M"
    @months[:gregorian][:narrow]["4"] = "N"
    @months[:gregorian][:narrow]["5"] = "M"
    @months[:gregorian][:narrow]["6"] = "H"
    @months[:gregorian][:narrow]["7"] = "T"
    @months[:gregorian][:narrow]["8"] = "A"
    @months[:gregorian][:narrow]["9"] = "E"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Ocak"
    @months[:gregorian][:wide]["10"] = "Ekim"
    @months[:gregorian][:wide]["11"] = "Kasım"
    @months[:gregorian][:wide]["12"] = "Aralık"
    @months[:gregorian][:wide]["2"] = "Şubat"
    @months[:gregorian][:wide]["3"] = "Mart"
    @months[:gregorian][:wide]["4"] = "Nisan"
    @months[:gregorian][:wide]["5"] = "Mayıs"
    @months[:gregorian][:wide]["6"] = "Haziran"
    @months[:gregorian][:wide]["7"] = "Temmuz"
    @months[:gregorian][:wide]["8"] = "Ağustos"
    @months[:gregorian][:wide]["9"] = "Eylül"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Cum"
    @days[:gregorian][:abbreviated]["mon"] = "Pzt"
    @days[:gregorian][:abbreviated]["sat"] = "Cmt"
    @days[:gregorian][:abbreviated]["sun"] = "Paz"
    @days[:gregorian][:abbreviated]["thu"] = "Per"
    @days[:gregorian][:abbreviated]["tue"] = "Sal"
    @days[:gregorian][:abbreviated]["wed"] = "Çar"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "C"
    @days[:gregorian][:narrow]["mon"] = "P"
    @days[:gregorian][:narrow]["sat"] = "C"
    @days[:gregorian][:narrow]["sun"] = "P"
    @days[:gregorian][:narrow]["thu"] = "P"
    @days[:gregorian][:narrow]["tue"] = "S"
    @days[:gregorian][:narrow]["wed"] = "Ç"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Cuma"
    @days[:gregorian][:wide]["mon"] = "Pazartesi"
    @days[:gregorian][:wide]["sat"] = "Cumartesi"
    @days[:gregorian][:wide]["sun"] = "Pazar"
    @days[:gregorian][:wide]["thu"] = "Perşembe"
    @days[:gregorian][:wide]["tue"] = "Salı"
    @days[:gregorian][:wide]["wed"] = "Çarşamba"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "MÖ"
    @era_abbrs[:gregorian]["1"] = "MS"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["long"] = "dd MMMM yyyy EEEE"
