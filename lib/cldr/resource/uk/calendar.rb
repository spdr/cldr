...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Січ"
    @months[:gregorian][:abbreviated]["10"] = "Жов"
    @months[:gregorian][:abbreviated]["11"] = "Лис"
    @months[:gregorian][:abbreviated]["12"] = "Гру"
    @months[:gregorian][:abbreviated]["2"] = "Лют"
    @months[:gregorian][:abbreviated]["3"] = "Бер"
    @months[:gregorian][:abbreviated]["4"] = "Кві"
    @months[:gregorian][:abbreviated]["5"] = "Тра"
    @months[:gregorian][:abbreviated]["6"] = "Чер"
    @months[:gregorian][:abbreviated]["7"] = "Лип"
    @months[:gregorian][:abbreviated]["8"] = "Сер"
    @months[:gregorian][:abbreviated]["9"] = "Вер"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "С"
    @months[:gregorian][:narrow]["10"] = "Ж"
    @months[:gregorian][:narrow]["11"] = "Л"
    @months[:gregorian][:narrow]["12"] = "Г"
    @months[:gregorian][:narrow]["2"] = "Л"
    @months[:gregorian][:narrow]["3"] = "Б"
    @months[:gregorian][:narrow]["4"] = "К"
    @months[:gregorian][:narrow]["5"] = "Т"
    @months[:gregorian][:narrow]["6"] = "Ч"
    @months[:gregorian][:narrow]["7"] = "Л"
    @months[:gregorian][:narrow]["8"] = "С"
    @months[:gregorian][:narrow]["9"] = "В"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Січень"
    @months[:gregorian][:wide]["10"] = "Жовтень"
    @months[:gregorian][:wide]["11"] = "Листопад"
    @months[:gregorian][:wide]["12"] = "Грудень"
    @months[:gregorian][:wide]["2"] = "Лютий"
    @months[:gregorian][:wide]["3"] = "Березень"
    @months[:gregorian][:wide]["4"] = "Квітень"
    @months[:gregorian][:wide]["5"] = "Травень"
    @months[:gregorian][:wide]["6"] = "Червень"
    @months[:gregorian][:wide]["7"] = "Липень"
    @months[:gregorian][:wide]["8"] = "Серпень"
    @months[:gregorian][:wide]["9"] = "Вересень"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Пʼятниця"
    @days[:gregorian][:wide]["mon"] = "Понеділок"
    @days[:gregorian][:wide]["sat"] = "Субота"
    @days[:gregorian][:wide]["sun"] = "Неділя"
    @days[:gregorian][:wide]["thu"] = "Четвер"
    @days[:gregorian][:wide]["tue"] = "Вівторок"
    @days[:gregorian][:wide]["wed"] = "Середа"
    @dayformat_defaults = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, d MMMM yyyy 'р.'"
