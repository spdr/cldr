...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "جنو"
    @months[:gregorian][:abbreviated]["10"] = "اکت"
    @months[:gregorian][:abbreviated]["11"] = "نوم"
    @months[:gregorian][:abbreviated]["12"] = "دسم"
    @months[:gregorian][:abbreviated]["2"] = "فبر"
    @months[:gregorian][:abbreviated]["3"] = "مار"
    @months[:gregorian][:abbreviated]["4"] = "اپر"
    @months[:gregorian][:abbreviated]["5"] = "مـی"
    @months[:gregorian][:abbreviated]["6"] = "جون"
    @months[:gregorian][:abbreviated]["7"] = "جول"
    @months[:gregorian][:abbreviated]["8"] = "اگس"
    @months[:gregorian][:abbreviated]["9"] = "سپت"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "Я"
    @months[:gregorian][:narrow]["10"] = "О"
    @months[:gregorian][:narrow]["11"] = "Н"
    @months[:gregorian][:narrow]["12"] = "Д"
    @months[:gregorian][:narrow]["2"] = "Ф"
    @months[:gregorian][:narrow]["3"] = "М"
    @months[:gregorian][:narrow]["4"] = "А"
    @months[:gregorian][:narrow]["5"] = "М"
    @months[:gregorian][:narrow]["6"] = "И"
    @months[:gregorian][:narrow]["7"] = "И"
    @months[:gregorian][:narrow]["8"] = "А"
    @months[:gregorian][:narrow]["9"] = "С"
    ...
    @days[:gregorian][:abbreviated]["mon"] = "د."
    @days[:gregorian][:abbreviated]["sat"] = "ش."
    @days[:gregorian][:abbreviated]["sun"] = "ی."
    @days[:gregorian][:abbreviated]["thu"] = "پ."
    @days[:gregorian][:abbreviated]["tue"] = "س."
    @days[:gregorian][:abbreviated]["wed"] = "چ."
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "Ж"
    @days[:gregorian][:narrow]["mon"] = "Д"
    @days[:gregorian][:narrow]["sat"] = "Ш"
    @days[:gregorian][:narrow]["sun"] = "Я"
    @days[:gregorian][:narrow]["thu"] = "П"
    @days[:gregorian][:narrow]["tue"] = "С"
    @days[:gregorian][:narrow]["wed"] = "Ч"
    @days[:gregorian][:wide] = {}
    ...
    @dateformats[:gregorian]["full"] = "yyyy نچی ییل d نچی MMMM EEEE کونی"
    @dateformats[:gregorian]["long"] = "d نچی MMMM yyyy"
