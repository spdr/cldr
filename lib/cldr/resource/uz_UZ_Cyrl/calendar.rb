...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["11"] = "Ноя"
    ...
    @months[:gregorian][:abbreviated]["6"] = "Июн"
    @months[:gregorian][:abbreviated]["7"] = "Июл"
    @months[:gregorian][:abbreviated]["8"] = "Авг"
    @months[:gregorian][:abbreviated]["9"] = "Сен"
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Жум"
    @days[:gregorian][:abbreviated]["mon"] = "Душ"
    @days[:gregorian][:abbreviated]["sat"] = "Шан"
    @days[:gregorian][:abbreviated]["sun"] = "Якш"
    @days[:gregorian][:abbreviated]["thu"] = "Пай"
    @days[:gregorian][:abbreviated]["tue"] = "Сеш"
    @days[:gregorian][:abbreviated]["wed"] = "Чор"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Жума"
    @days[:gregorian][:wide]["mon"] = "Душанба"
    @days[:gregorian][:wide]["sat"] = "Шанба"
    @days[:gregorian][:wide]["sun"] = "Якшанба"
    @days[:gregorian][:wide]["thu"] = "Пайшанба"
    @days[:gregorian][:wide]["tue"] = "Сешанба"
    @days[:gregorian][:wide]["wed"] = "Чоршанба"
    @dayformat_defaults = {}
