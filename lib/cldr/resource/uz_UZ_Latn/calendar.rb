...
# CLDR version: 1.3
#
# Original file name: common/main/uz_Latn_UZ.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "Yanv"
    @months[:gregorian][:abbreviated]["10"] = "Okt"
    @months[:gregorian][:abbreviated]["11"] = "Noya"
    @months[:gregorian][:abbreviated]["12"] = "Dek"
    ...
    @months[:gregorian][:abbreviated]["6"] = "Iyun"
    @months[:gregorian][:abbreviated]["7"] = "Iyul"
    @months[:gregorian][:abbreviated]["8"] = "Avg"
    @months[:gregorian][:abbreviated]["9"] = "Sen"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "Y"
    ...
    @months[:gregorian][:narrow]["6"] = "I"
    @months[:gregorian][:narrow]["7"] = "I"
    @months[:gregorian][:narrow]["8"] = "A"
    @months[:gregorian][:narrow]["9"] = "S"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "Yanvar"
    @months[:gregorian][:wide]["10"] = "Oktyabr"
    @months[:gregorian][:wide]["11"] = "Noyabr"
    @months[:gregorian][:wide]["12"] = "Dekabr"
    @months[:gregorian][:wide]["2"] = "Fevral"
    @months[:gregorian][:wide]["3"] = "Mart"
    @months[:gregorian][:wide]["4"] = "Aprel"
    @months[:gregorian][:wide]["5"] = "May"
    @months[:gregorian][:wide]["6"] = "Iyun"
    @months[:gregorian][:wide]["7"] = "Iyul"
    @months[:gregorian][:wide]["8"] = "Avgust"
    @months[:gregorian][:wide]["9"] = "Sentyabr"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["mon"] = "Dush"
    @days[:gregorian][:abbreviated]["sat"] = "Shan"
    @days[:gregorian][:abbreviated]["sun"] = "Yaksh"
    @days[:gregorian][:abbreviated]["thu"] = "Pay"
    @days[:gregorian][:abbreviated]["tue"] = "Sesh"
    @days[:gregorian][:abbreviated]["wed"] = "Chor"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "J"
    @days[:gregorian][:narrow]["mon"] = "D"
    @days[:gregorian][:narrow]["sat"] = "Sh"
    @days[:gregorian][:narrow]["sun"] = "Y"
    @days[:gregorian][:narrow]["thu"] = "P"
    @days[:gregorian][:narrow]["tue"] = "S"
    @days[:gregorian][:narrow]["wed"] = "C"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Juma"
    @days[:gregorian][:wide]["mon"] = "Dushanba"
    @days[:gregorian][:wide]["sat"] = "Shanba"
    @days[:gregorian][:wide]["sun"] = "Yakshanba"
    @days[:gregorian][:wide]["thu"] = "Payshanba"
    @days[:gregorian][:wide]["tue"] = "Seshanba"
    @days[:gregorian][:wide]["wed"] = "Chorshanba"
    @dayformat_defaults = {}
