...
#
  ...
  def init_data
    ...
    @after_insertbetween = " "
    @currencies = {}
    @currencies["BRL"] = "Brazil reali"
    @currencies["CNY"] = "Xitoy yuani"
    @currencies["EUR"] = "Evro"
    @currencies["GBP"] = "Ingliz funt sterlingi"
    @currencies["INR"] = "Hind rupiyasi"
    @currencies["ITL"] = "ITL"
    @currencies["JPY"] = "Yapon yenasi"
    @currencies["RUB"] = "Rus rubli"
    @currencies["USD"] = "AQSH dollari"
    @currencies["UZS"] = "Oʿzbekiston soʿm"
    @symbols = {}
    @symbols["EUR"] = "€"
    @symbols["GBP"] = "£"
