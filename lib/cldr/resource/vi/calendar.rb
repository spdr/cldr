...
# CLDR version: 1.3
#
# Original file name: common/main/vi.xml
...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "thg 1"
    @months[:gregorian][:abbreviated]["10"] = "thg 10"
    @months[:gregorian][:abbreviated]["11"] = "thg 11"
    @months[:gregorian][:abbreviated]["12"] = "thg 12"
    @months[:gregorian][:abbreviated]["2"] = "thg 2"
    @months[:gregorian][:abbreviated]["3"] = "thg 3"
    @months[:gregorian][:abbreviated]["4"] = "thg 4"
    @months[:gregorian][:abbreviated]["5"] = "thg 5"
    @months[:gregorian][:abbreviated]["6"] = "thg 6"
    @months[:gregorian][:abbreviated]["7"] = "thg 7"
    @months[:gregorian][:abbreviated]["8"] = "thg 8"
    @months[:gregorian][:abbreviated]["9"] = "thg 9"
    ...
    @months[:gregorian][:wide]["1"] = "tháng một"
    @months[:gregorian][:wide]["10"] = "tháng mười"
    @months[:gregorian][:wide]["11"] = "tháng mười một"
    @months[:gregorian][:wide]["12"] = "tháng mười hai"
    @months[:gregorian][:wide]["2"] = "tháng hai"
    @months[:gregorian][:wide]["3"] = "tháng ba"
    @months[:gregorian][:wide]["4"] = "tháng tư"
    @months[:gregorian][:wide]["5"] = "tháng năm"
    @months[:gregorian][:wide]["6"] = "tháng sáu"
    @months[:gregorian][:wide]["7"] = "tháng bảy"
    @months[:gregorian][:wide]["8"] = "tháng tám"
    @months[:gregorian][:wide]["9"] = "tháng chín"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "Th 6"
    @days[:gregorian][:abbreviated]["mon"] = "Th 2"
    @days[:gregorian][:abbreviated]["sat"] = "Th 7"
    @days[:gregorian][:abbreviated]["sun"] = "CN"
    @days[:gregorian][:abbreviated]["thu"] = "Th 5"
    @days[:gregorian][:abbreviated]["tue"] = "Th 3"
    @days[:gregorian][:abbreviated]["wed"] = "Th 4"
    ...
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "Thứ sáu"
    @days[:gregorian][:wide]["mon"] = "Thứ hai"
    @days[:gregorian][:wide]["sat"] = "Thứ bảy"
    @days[:gregorian][:wide]["sun"] = "Chủ nhật"
    @days[:gregorian][:wide]["thu"] = "Thứ năm"
    @days[:gregorian][:wide]["tue"] = "Thứ ba"
    @days[:gregorian][:wide]["wed"] = "Thứ tư"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "tr. CN"
    @era_abbrs[:gregorian]["1"] = "sau CN"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE, 'ngày' dd MMMM 'năm' yyyy"
    @dateformats[:gregorian]["long"] = "'Ngày' dd 'tháng' M 'năm' yyyy"
