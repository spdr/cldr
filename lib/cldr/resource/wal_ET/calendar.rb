...
#
  ...
  def init_data
    ...
    @days[:gregorian][:abbreviated]["fri"] = "አርባ"
    @days[:gregorian][:abbreviated]["mon"] = "ሳይኖ"
    @days[:gregorian][:abbreviated]["sat"] = "ቄራ"
    @days[:gregorian][:abbreviated]["sun"] = "ወጋ"
    @days[:gregorian][:abbreviated]["thu"] = "ሃሙሳ"
    @days[:gregorian][:abbreviated]["tue"] = "ማቆሳ"
    @days[:gregorian][:abbreviated]["wed"] = "አሩዋ"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "አ"
    @days[:gregorian][:narrow]["mon"] = "ሳ"
    @days[:gregorian][:narrow]["sat"] = "ቄ"
    @days[:gregorian][:narrow]["sun"] = "ወ"
    @days[:gregorian][:narrow]["thu"] = "ሃ"
    @days[:gregorian][:narrow]["tue"] = "ማ"
    @days[:gregorian][:narrow]["wed"] = "አ"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "አርባ"
    @days[:gregorian][:wide]["mon"] = "ሳይኖ"
    @days[:gregorian][:wide]["sat"] = "ቄራ"
    @days[:gregorian][:wide]["sun"] = "ወጋ"
    @days[:gregorian][:wide]["thu"] = "ሃሙሳ"
    @days[:gregorian][:wide]["tue"] = "ማቆሳኛ"
    @days[:gregorian][:wide]["wed"] = "አሩዋ"
    @dayformat_defaults = {}
    ...
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "አዳ ዎዴ"
    @era_abbrs[:gregorian]["1"] = "ግሮተታ ላይታ"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "EEEE፥ dd MMMM ጋላሳ yyyy G"
