...
#
  ...
  def init_data
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "公元前"
    @era_names[:gregorian]["1"] = "公元"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    ...
    @dateformats[:gregorian]["short"] = "yy-M-d"
    ...
    @timeformats[:gregorian]["full"] = "ahh'时'mm'分'ss'秒' z"
    @timeformats[:gregorian]["long"] = "ahh'时'mm'分'ss'秒'"
