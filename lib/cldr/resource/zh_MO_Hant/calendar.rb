...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "1月"
    @months[:gregorian][:abbreviated]["10"] = "10月"
    @months[:gregorian][:abbreviated]["11"] = "11月"
    @months[:gregorian][:abbreviated]["12"] = "12月"
    @months[:gregorian][:abbreviated]["2"] = "2月"
    @months[:gregorian][:abbreviated]["3"] = "3月"
    @months[:gregorian][:abbreviated]["4"] = "4月"
    @months[:gregorian][:abbreviated]["5"] = "5月"
    @months[:gregorian][:abbreviated]["6"] = "6月"
    @months[:gregorian][:abbreviated]["7"] = "7月"
    @months[:gregorian][:abbreviated]["8"] = "8月"
    @months[:gregorian][:abbreviated]["9"] = "9月"
    @months[:gregorian][:narrow] = {}
    @months[:gregorian][:narrow]["1"] = "1月"
    @months[:gregorian][:narrow]["10"] = "10月"
    @months[:gregorian][:narrow]["11"] = "11月"
    @months[:gregorian][:narrow]["12"] = "12月"
    @months[:gregorian][:narrow]["2"] = "2月"
    @months[:gregorian][:narrow]["3"] = "3月"
    @months[:gregorian][:narrow]["4"] = "4月"
    @months[:gregorian][:narrow]["5"] = "5月"
    @months[:gregorian][:narrow]["6"] = "6月"
    @months[:gregorian][:narrow]["7"] = "7月"
    @months[:gregorian][:narrow]["8"] = "8月"
    @months[:gregorian][:narrow]["9"] = "9月"
    @months[:gregorian][:wide] = {}
    @months[:gregorian][:wide]["1"] = "一月"
    @months[:gregorian][:wide]["10"] = "十月"
    @months[:gregorian][:wide]["11"] = "十一月"
    @months[:gregorian][:wide]["12"] = "十二月"
    @months[:gregorian][:wide]["2"] = "二月"
    @months[:gregorian][:wide]["3"] = "三月"
    @months[:gregorian][:wide]["4"] = "四月"
    @months[:gregorian][:wide]["5"] = "五月"
    @months[:gregorian][:wide]["6"] = "六月"
    @months[:gregorian][:wide]["7"] = "七月"
    @months[:gregorian][:wide]["8"] = "八月"
    @months[:gregorian][:wide]["9"] = "九月"
    @months[:hebrew] = {}
    ...
    @days[:gregorian][:abbreviated]["fri"] = "周五"
    @days[:gregorian][:abbreviated]["mon"] = "周一"
    @days[:gregorian][:abbreviated]["sat"] = "周六"
    @days[:gregorian][:abbreviated]["sun"] = "周日"
    @days[:gregorian][:abbreviated]["thu"] = "周四"
    @days[:gregorian][:abbreviated]["tue"] = "周二"
    @days[:gregorian][:abbreviated]["wed"] = "周三"
    @days[:gregorian][:narrow] = {}
    @days[:gregorian][:narrow]["fri"] = "五"
    @days[:gregorian][:narrow]["mon"] = "一"
    @days[:gregorian][:narrow]["sat"] = "六"
    @days[:gregorian][:narrow]["sun"] = "日"
    @days[:gregorian][:narrow]["thu"] = "四"
    @days[:gregorian][:narrow]["tue"] = "二"
    @days[:gregorian][:narrow]["wed"] = "三"
    @days[:gregorian][:wide] = {}
    @days[:gregorian][:wide]["fri"] = "星期五"
    @days[:gregorian][:wide]["mon"] = "星期一"
    @days[:gregorian][:wide]["sat"] = "星期六"
    @days[:gregorian][:wide]["sun"] = "星期日"
    @days[:gregorian][:wide]["thu"] = "星期四"
    @days[:gregorian][:wide]["tue"] = "星期二"
    @days[:gregorian][:wide]["wed"] = "星期三"
    @dayformat_defaults = {}
    ...
    @era_names = {}
    @era_names[:gregorian] = {}
    @era_names[:gregorian]["0"] = "西元前"
    @era_names[:gregorian]["1"] = "西元"
    @era_abbrs = {}
    @era_abbrs[:buddhist] = {}
    @era_abbrs[:buddhist]["0"] = "BE"
    @era_abbrs[:gregorian] = {}
    @era_abbrs[:gregorian]["0"] = "公元前"
    @era_abbrs[:gregorian]["1"] = "公元"
    @era_abbrs[:hebrew] = {}
    ...
    @dateformats[:gregorian]["full"] = "yyyy'年'MM'月'dd'日' EEEE"
    @dateformats[:gregorian]["long"] = "yyyy'年'MM'月'dd'日'"
    @dateformats[:gregorian]["medium"] = "yyyy'年'M'月'd'日'"
    @dateformats[:gregorian]["short"] = "yy'年'M'月'd'日'"
    ...
    @timeformats[:gregorian]["full"] = "ahh'時'mm'分'ss'秒' z"
    @timeformats[:gregorian]["long"] = "ahh'時'mm'分'ss'秒'"
    @timeformats[:gregorian]["medium"] = "ahh:mm:ss"
    @timeformats[:gregorian]["short"] = "ah:mm"
