...
#
  ...
  def init_data
    ...
    @months[:gregorian][:abbreviated]["1"] = "一月"
    @months[:gregorian][:abbreviated]["10"] = "十月"
    @months[:gregorian][:abbreviated]["11"] = "十一月"
    @months[:gregorian][:abbreviated]["12"] = "十二月"
    @months[:gregorian][:abbreviated]["2"] = "二月"
    @months[:gregorian][:abbreviated]["3"] = "三月"
    @months[:gregorian][:abbreviated]["4"] = "四月"
    @months[:gregorian][:abbreviated]["5"] = "五月"
    @months[:gregorian][:abbreviated]["6"] = "六月"
    @months[:gregorian][:abbreviated]["7"] = "七月"
    @months[:gregorian][:abbreviated]["8"] = "八月"
    @months[:gregorian][:abbreviated]["9"] = "九月"
    ...
    @dateformats[:gregorian]["short"] = "yyyy/M/d"
    ...
    @timeformats[:gregorian]["medium"] = "a h:mm:ss"
    @timeformats[:gregorian]["short"] = "a h:mm"
